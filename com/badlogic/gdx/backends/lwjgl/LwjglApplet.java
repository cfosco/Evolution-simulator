...
extends Applet {
    ...
    extends LwjglApplication {
        ...
        public LwjglAppletApplication(LwjglApplet lwjglApplet, ApplicationListener listener, Canvas canvas) {
            this.this$0 = lwjglApplet;
            super(listener, canvas);
        }

        public LwjglAppletApplication(LwjglApplet lwjglApplet, ApplicationListener listener, Canvas canvas, LwjglApplicationConfiguration config) {
            this.this$0 = lwjglApplet;
