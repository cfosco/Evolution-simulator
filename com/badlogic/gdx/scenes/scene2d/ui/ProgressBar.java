...
implements Disableable {
    ...
    public void draw(Batch batch, float parentAlpha) {
        ...
        Drawable knob = disabled && style.disabledKnob != null ? style.disabledKnob : style.knob;
    ...
    public float getPrefWidth() {
        if (this.vertical) {
            Drawable knob = this.disabled && this.style.disabledKnob != null ? this.style.disabledKnob : this.style.knob;
