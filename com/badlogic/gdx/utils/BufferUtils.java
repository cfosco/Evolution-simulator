...
public final class BufferUtils {
    ...
    public static void copy(short[] src, int srcOffset, Buffer dst, int numElements) {
        BufferUtils.copyJni(src, srcOffset << 1, dst, BufferUtils.positionInBytes(dst), numElements << 1);
    ...
    public static void copy(int[] src, int srcOffset, int numElements, Buffer dst) {
        BufferUtils.copyJni(src, srcOffset << 2, dst, BufferUtils.positionInBytes(dst), numElements << 2);
    }

    public static void copy(long[] src, int srcOffset, int numElements, Buffer dst) {
        BufferUtils.copyJni(src, srcOffset << 3, dst, BufferUtils.positionInBytes(dst), numElements << 3);
    }
