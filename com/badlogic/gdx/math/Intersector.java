...
public final class Intersector {
    ...
    public static boolean intersectRayBounds(Ray ray, BoundingBox box, Vector3 intersection) {
        ...
        if (Intersector.v0.x > 0.0f && Intersector.v0.y > 0.0f && Intersector.v0.z > 0.0f && Intersector.v1.x < 0.0f && Intersector.v1.y < 0.0f && Intersector.v1.z < 0.0f) {
            return true;
        }
        float lowest = 0.0f;
        boolean hit = false;
    ...
    public static boolean intersectRayBoundsFast(Ray ray, BoundingBox box) {
        return Intersector.intersectRayBoundsFast(ray, box.getCenter(), box.getDimensions());
    }
