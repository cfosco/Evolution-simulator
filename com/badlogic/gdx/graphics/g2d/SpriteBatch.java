...
implements Batch {
    ...
    public SpriteBatch(int size, ShaderProgram defaultShader) {
        ...
        this.mesh = new Mesh(Mesh.VertexDataType.VertexArray, false, size * 4, size * 6, new VertexAttribute(1, 2, "a_position"), new VertexAttribute(4, 4, "a_color"), new VertexAttribute(16, 2, "a_texCoord0"));
