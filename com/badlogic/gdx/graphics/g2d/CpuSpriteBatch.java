...
extends SpriteBatch {
    ...
    public void draw(Texture texture, float x, float y, int srcX, int srcY, int srcWidth, int srcHeight) {
        if (!this.adjustNeeded) {
            ...
            this.drawAdjusted(texture, x, y, 0.0f, 0.0f, texture.getWidth(), texture.getHeight(), 1.0f, 1.0f, 0.0f, srcX, srcY, srcWidth, srcHeight, false, false);
        }
    }
    ...
    public void draw(Texture texture, float x, float y, float width, float height, float u, float v, float u2, float v2) {
        if (!this.adjustNeeded) {
            ...
            this.drawAdjustedUV(texture, x, y, 0.0f, 0.0f, texture.getWidth(), texture.getHeight(), 1.0f, 1.0f, 0.0f, u, v, u2, v2, false, false);
        }
    }
