...
implements Batch {
    ...
    public PolygonSpriteBatch(int size, ShaderProgram defaultShader) {
        ...
        this.mesh = new Mesh(Mesh.VertexDataType.VertexArray, false, size, size * 3, new VertexAttribute(1, 2, "a_position"), new VertexAttribute(4, 4, "a_color"), new VertexAttribute(16, 2, "a_texCoord0"));
