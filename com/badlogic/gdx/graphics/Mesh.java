...
implements Disposable {
    ...
    public static Mesh create(boolean isStatic, Mesh base, Matrix4[] transformations) {
        ...
        for (int i = 0; i < transformations.length; ++i) {
            ...
            Mesh.transform(transformations[i], vertices, vertexSize, offset, numComponents, numVertices * i, numVertices);
            if (i <= 0) continue;
    ...
    public static Mesh create(boolean isStatic, Mesh[] meshes) {
        return Mesh.create(isStatic, meshes, null);
    }
    ...
    public static Mesh create(boolean isStatic, Mesh[] meshes, Matrix4[] transformations) {
        ...
        if (transformations != null) {
            Mesh.transform(transformations[0], vertices, vertexSize, offset, numComponents, 0, vcount);
        }
        int voffset = vcount;
        ...
        for (int i = 1; i < meshes.length; ++i) {
            ...
            if (transformations != null) {
                Mesh.transform(transformations[i], vertices, vertexSize, offset, numComponents, voffset, vcount);
            }
