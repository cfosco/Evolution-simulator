...
final class OSXHIDDevice {
    ...
    private final OSXHIDElement createElementFromElementProperties(Map element_properties) {
        ...
        int min = (int)OSXHIDDevice.getLongFromProperties(element_properties, "Min", 0);
        int max = (int)OSXHIDDevice.getLongFromProperties(element_properties, "Max", 65536);
    ...
    private static final boolean getBooleanFromProperties(Map properties, String key, boolean default_value) {
        return OSXHIDDevice.getLongFromProperties(properties, key, default_value ? 1 : 0) != 0;
    }
    ...
    static {
        Class class_ = OSXHIDDevice.class;
        log = Logger.getLogger(class_.getName());
    }
}
