...
final class RawDevice {
    ...
    public final void setBufferSize(int size) {
        Class class_ = RawKeyboardEvent.class;
        this.keyboard_events = new DataQueue(size, class_);
        Class class_2 = RawMouseEvent.class;
        this.mouse_events = new DataQueue(size, class_2);
