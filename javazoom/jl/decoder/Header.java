        ...
        try {
            ...
            if (xing.equals(new String(tmp))) {
                ...
                if ((flags[3] & 1) != 0) {
                    ...
                    this.h_vbr_frames = tmp[0] << 24 & -16777216 | tmp[1] << 16 & 16711680 | tmp[2] << 8 & 65280 | tmp[3] & 255;
                    length += 4;
                }
                if ((flags[3] & 2) != 0) {
                    System.arraycopy(firstframe, offset + length, tmp, 0, tmp.length);
                    this.h_vbr_bytes = tmp[0] << 24 & -16777216 | tmp[1] << 16 & 16711680 | tmp[2] << 8 & 65280 | tmp[3] & 255;
                    length += 4;
                }
                if ((flags[3] & 4) != 0) {
                ...
                if ((flags[3] & 8) != 0) {
                    System.arraycopy(firstframe, offset + length, tmp, 0, tmp.length);
                    this.h_vbr_scale = tmp[0] << 24 & -16777216 | tmp[1] << 16 & 16711680 | tmp[2] << 8 & 65280 | tmp[3] & 255;
                    length += 4;
                }
            }
        }
