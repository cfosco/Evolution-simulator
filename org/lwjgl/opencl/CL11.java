...
public final class CL11 {
    ...
    public static CLMem clCreateSubBuffer(CLMem buffer, long flags, int buffer_create_type, ByteBuffer buffer_create_info, IntBuffer errcode_ret) {
        ...
        CLMem __result = CLMem.create(CL11.nclCreateSubBuffer(buffer.getPointer(), flags, buffer_create_type, MemoryUtil.getAddress(buffer_create_info), MemoryUtil.getAddressSafe(errcode_ret), function_pointer), (CLContext)buffer.getParent());
        return __result;
    }
    ...
    public static int clSetMemObjectDestructorCallback(CLMem memobj, CLMemObjectDestructorCallback pfn_notify) {
        ...
        int __result = 0;
        try {
            int n = __result = CL11.nclSetMemObjectDestructorCallback(memobj.getPointer(), pfn_notify.getPointer(), user_data, function_pointer);
            return n;
        }
        finally {
    ...
    public static int clEnqueueCopyBufferRect(CLCommandQueue command_queue, CLMem src_buffer, CLMem dst_buffer, PointerBuffer src_origin, PointerBuffer dst_origin, PointerBuffer region, long src_row_pitch, long src_slice_pitch, long dst_row_pitch, long dst_slice_pitch, PointerBuffer event_wait_list, PointerBuffer event) {
        ...
        if ((__result = CL11.nclEnqueueCopyBufferRect(command_queue.getPointer(), src_buffer.getPointer(), dst_buffer.getPointer(), MemoryUtil.getAddress(src_origin), MemoryUtil.getAddress(dst_origin), MemoryUtil.getAddress(region), src_row_pitch, src_slice_pitch, dst_row_pitch, dst_slice_pitch, event_wait_list == null ? 0 : event_wait_list.remaining(), MemoryUtil.getAddressSafe(event_wait_list), MemoryUtil.getAddressSafe(event), function_pointer)) == 0) {
            command_queue.registerCLEvent(event);
        }
        return __result;
    }
    ...
    public static CLEvent clCreateUserEvent(CLContext context, IntBuffer errcode_ret) {
        ...
        CLEvent __result = new CLEvent(CL11.nclCreateUserEvent(context.getPointer(), MemoryUtil.getAddressSafe(errcode_ret), function_pointer), context);
        return __result;
    }
    ...
    public static int clSetUserEventStatus(CLEvent event, int execution_status) {
        ...
        BufferChecks.checkFunctionAddress(function_pointer);
        int __result = CL11.nclSetUserEventStatus(event.getPointer(), execution_status, function_pointer);
        return __result;
    }
    ...
    public static int clSetEventCallback(CLEvent event, int command_exec_callback_type, CLEventCallback pfn_notify) {
        ...
        int __result = 0;
        try {
            int n = __result = CL11.nclSetEventCallback(event.getPointer(), command_exec_callback_type, pfn_notify.getPointer(), user_data, function_pointer);
            return n;
        }
        finally {
            CallbackUtil.checkCallback(__result, user_data);
