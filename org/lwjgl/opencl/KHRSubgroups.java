...
public final class KHRSubgroups {
    ...
    public static int clGetKernelSubGroupInfoKHR(CLKernel kernel, CLDevice device, int param_name, ByteBuffer input_value, ByteBuffer param_value, PointerBuffer param_value_size_ret) {
        ...
        int __result = KHRSubgroups.nclGetKernelSubGroupInfoKHR(kernel.getPointer(), device == null ? 0 : device.getPointer(), param_name, input_value == null ? 0 : input_value.remaining(), MemoryUtil.getAddressSafe(input_value), param_value == null ? 0 : param_value.remaining(), MemoryUtil.getAddressSafe(param_value), MemoryUtil.getAddressSafe(param_value_size_ret), function_pointer);
        return __result;
    }
