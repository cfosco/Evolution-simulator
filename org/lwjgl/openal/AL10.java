...
public final class AL10 {
    ...
    public static void alGetInteger(int pname, IntBuffer data) {
        ...
        AL10.nalGetIntegerv(pname, MemoryUtil.getAddress(data));
    }
    ...
    public static void alGetFloat(int pname, FloatBuffer data) {
        BufferChecks.checkBuffer(data, 1);
        AL10.nalGetFloatv(pname, MemoryUtil.getAddress(data));
    }
    ...
    public static void alListener(int pname, FloatBuffer value) {
        ...
        AL10.nalListenerfv(pname, MemoryUtil.getAddress(value));
    }
    ...
    public static void alGetListener(int pname, FloatBuffer floatdata) {
        ...
        AL10.nalGetListenerfv(pname, MemoryUtil.getAddress(floatdata));
    }
    ...
    public static void alGenSources(IntBuffer sources) {
        ...
        AL10.nalGenSources(sources.remaining(), MemoryUtil.getAddress(sources));
    }
    ...
    public static void alDeleteSources(IntBuffer sources) {
        BufferChecks.checkDirect(sources);
        AL10.nalDeleteSources(sources.remaining(), MemoryUtil.getAddress(sources));
    }
    ...
    public static void alSource(int source, int pname, FloatBuffer value) {
        BufferChecks.checkBuffer(value, 1);
        AL10.nalSourcefv(source, pname, MemoryUtil.getAddress(value));
    }
    ...
    public static void alGetSource(int source, int pname, FloatBuffer floatdata) {
        BufferChecks.checkBuffer(floatdata, 1);
        AL10.nalGetSourcefv(source, pname, MemoryUtil.getAddress(floatdata));
    }
    ...
    public static void alSourcePlay(IntBuffer sources) {
        BufferChecks.checkDirect(sources);
        AL10.nalSourcePlayv(sources.remaining(), MemoryUtil.getAddress(sources));
    }
    ...
    public static void alSourcePause(IntBuffer sources) {
        BufferChecks.checkDirect(sources);
        AL10.nalSourcePausev(sources.remaining(), MemoryUtil.getAddress(sources));
    }
    ...
    public static void alSourceStop(IntBuffer sources) {
        BufferChecks.checkDirect(sources);
        AL10.nalSourceStopv(sources.remaining(), MemoryUtil.getAddress(sources));
    }
    ...
    public static void alSourceRewind(IntBuffer sources) {
        BufferChecks.checkDirect(sources);
        AL10.nalSourceRewindv(sources.remaining(), MemoryUtil.getAddress(sources));
    }
    ...
    public static void alGenBuffers(IntBuffer buffers) {
        ...
        AL10.nalGenBuffers(buffers.remaining(), MemoryUtil.getAddress(buffers));
    }
    ...
    public static void alDeleteBuffers(IntBuffer buffers) {
        BufferChecks.checkDirect(buffers);
        AL10.nalDeleteBuffers(buffers.remaining(), MemoryUtil.getAddress(buffers));
    }
    ...
    public static void alBufferData(int buffer, int format, ByteBuffer data, int freq) {
        ...
        AL10.nalBufferData(buffer, format, MemoryUtil.getAddress(data), data.remaining(), freq);
    }

    public static void alBufferData(int buffer, int format, IntBuffer data, int freq) {
        BufferChecks.checkDirect(data);
        AL10.nalBufferData(buffer, format, MemoryUtil.getAddress(data), data.remaining() << 2, freq);
    }

    public static void alBufferData(int buffer, int format, ShortBuffer data, int freq) {
        BufferChecks.checkDirect(data);
        AL10.nalBufferData(buffer, format, MemoryUtil.getAddress(data), data.remaining() << 1, freq);
    }
    ...
    public static void alSourceQueueBuffers(int source, IntBuffer buffers) {
        BufferChecks.checkDirect(buffers);
        AL10.nalSourceQueueBuffers(source, buffers.remaining(), MemoryUtil.getAddress(buffers));
    }
    ...
    public static void alSourceUnqueueBuffers(int source, IntBuffer buffers) {
        BufferChecks.checkDirect(buffers);
        AL10.nalSourceUnqueueBuffers(source, buffers.remaining(), MemoryUtil.getAddress(buffers));
    }
