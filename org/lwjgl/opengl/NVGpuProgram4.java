...
public final class NVGpuProgram4 {
    ...
    public static void glProgramLocalParameterI4iNV(int target, int index, int x, int y, int z, int w) {
        ...
        NVGpuProgram4.nglProgramLocalParameterI4iNV(target, index, x, y, z, w, function_pointer);
    }
    ...
    public static void glProgramLocalParameterI4NV(int target, int index, IntBuffer params) {
        ...
        NVGpuProgram4.nglProgramLocalParameterI4ivNV(target, index, MemoryUtil.getAddress(params), function_pointer);
    }
    ...
    public static void glProgramLocalParametersI4NV(int target, int index, IntBuffer params) {
        ...
        NVGpuProgram4.nglProgramLocalParametersI4ivNV(target, index, params.remaining() >> 2, MemoryUtil.getAddress(params), function_pointer);
    }
    ...
    public static void glProgramLocalParameterI4uiNV(int target, int index, int x, int y, int z, int w) {
        ...
        BufferChecks.checkFunctionAddress(function_pointer);
        NVGpuProgram4.nglProgramLocalParameterI4uiNV(target, index, x, y, z, w, function_pointer);
    }
    ...
    public static void glProgramLocalParameterI4uNV(int target, int index, IntBuffer params) {
        ...
        BufferChecks.checkFunctionAddress(function_pointer);
        BufferChecks.checkBuffer(params, 4);
        NVGpuProgram4.nglProgramLocalParameterI4uivNV(target, index, MemoryUtil.getAddress(params), function_pointer);
    }
    ...
    public static void glProgramLocalParametersI4uNV(int target, int index, IntBuffer params) {
        ...
        BufferChecks.checkFunctionAddress(function_pointer);
        BufferChecks.checkDirect(params);
        NVGpuProgram4.nglProgramLocalParametersI4uivNV(target, index, params.remaining() >> 2, MemoryUtil.getAddress(params), function_pointer);
    }
    ...
    public static void glProgramEnvParameterI4iNV(int target, int index, int x, int y, int z, int w) {
        ...
        BufferChecks.checkFunctionAddress(function_pointer);
        NVGpuProgram4.nglProgramEnvParameterI4iNV(target, index, x, y, z, w, function_pointer);
    }
    ...
    public static void glProgramEnvParameterI4NV(int target, int index, IntBuffer params) {
        ...
        BufferChecks.checkFunctionAddress(function_pointer);
        BufferChecks.checkBuffer(params, 4);
        NVGpuProgram4.nglProgramEnvParameterI4ivNV(target, index, MemoryUtil.getAddress(params), function_pointer);
    }
    ...
    public static void glProgramEnvParametersI4NV(int target, int index, IntBuffer params) {
        ...
        BufferChecks.checkFunctionAddress(function_pointer);
        BufferChecks.checkDirect(params);
        NVGpuProgram4.nglProgramEnvParametersI4ivNV(target, index, params.remaining() >> 2, MemoryUtil.getAddress(params), function_pointer);
    }
    ...
    public static void glProgramEnvParameterI4uiNV(int target, int index, int x, int y, int z, int w) {
        ...
        BufferChecks.checkFunctionAddress(function_pointer);
        NVGpuProgram4.nglProgramEnvParameterI4uiNV(target, index, x, y, z, w, function_pointer);
    }
    ...
    public static void glProgramEnvParameterI4uNV(int target, int index, IntBuffer params) {
        ...
        BufferChecks.checkFunctionAddress(function_pointer);
        BufferChecks.checkBuffer(params, 4);
        NVGpuProgram4.nglProgramEnvParameterI4uivNV(target, index, MemoryUtil.getAddress(params), function_pointer);
    }
    ...
    public static void glProgramEnvParametersI4uNV(int target, int index, IntBuffer params) {
        ...
        BufferChecks.checkFunctionAddress(function_pointer);
        BufferChecks.checkDirect(params);
        NVGpuProgram4.nglProgramEnvParametersI4uivNV(target, index, params.remaining() >> 2, MemoryUtil.getAddress(params), function_pointer);
    }
    ...
    public static void glGetProgramLocalParameterINV(int target, int index, IntBuffer params) {
        ...
        BufferChecks.checkFunctionAddress(function_pointer);
        BufferChecks.checkBuffer(params, 4);
        NVGpuProgram4.nglGetProgramLocalParameterIivNV(target, index, MemoryUtil.getAddress(params), function_pointer);
    }
    ...
    public static void glGetProgramLocalParameterIuNV(int target, int index, IntBuffer params) {
        ...
        BufferChecks.checkFunctionAddress(function_pointer);
        BufferChecks.checkBuffer(params, 4);
        NVGpuProgram4.nglGetProgramLocalParameterIuivNV(target, index, MemoryUtil.getAddress(params), function_pointer);
    }
    ...
    public static void glGetProgramEnvParameterINV(int target, int index, IntBuffer params) {
        ...
        BufferChecks.checkFunctionAddress(function_pointer);
        BufferChecks.checkBuffer(params, 4);
        NVGpuProgram4.nglGetProgramEnvParameterIivNV(target, index, MemoryUtil.getAddress(params), function_pointer);
    }
    ...
    public static void glGetProgramEnvParameterIuNV(int target, int index, IntBuffer params) {
        ...
        BufferChecks.checkFunctionAddress(function_pointer);
        BufferChecks.checkBuffer(params, 4);
        NVGpuProgram4.nglGetProgramEnvParameterIuivNV(target, index, MemoryUtil.getAddress(params), function_pointer);
    }
