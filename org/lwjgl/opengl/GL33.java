...
public final class GL33 {
    ...
    public static void glBindFragDataLocationIndexed(int program, int colorNumber, int index, ByteBuffer name) {
        ...
        GL33.nglBindFragDataLocationIndexed(program, colorNumber, index, MemoryUtil.getAddress(name), function_pointer);
    }
    ...
    public static void glBindFragDataLocationIndexed(int program, int colorNumber, int index, CharSequence name) {
        ...
        long function_pointer = caps.glBindFragDataLocationIndexed;
        BufferChecks.checkFunctionAddress(function_pointer);
        GL33.nglBindFragDataLocationIndexed(program, colorNumber, index, APIUtil.getBufferNT(caps, name), function_pointer);
    }
    ...
    public static int glGetFragDataIndex(int program, ByteBuffer name) {
        ...
        BufferChecks.checkDirect(name);
        BufferChecks.checkNullTerminated(name);
        int __result = GL33.nglGetFragDataIndex(program, MemoryUtil.getAddress(name), function_pointer);
        return __result;
    }
    ...
    public static int glGetFragDataIndex(int program, CharSequence name) {
        ...
        long function_pointer = caps.glGetFragDataIndex;
        BufferChecks.checkFunctionAddress(function_pointer);
        int __result = GL33.nglGetFragDataIndex(program, APIUtil.getBufferNT(caps, name), function_pointer);
        return __result;
    }
    ...
    public static void glGenSamplers(IntBuffer samplers) {
        ...
        GL33.nglGenSamplers(samplers.remaining(), MemoryUtil.getAddress(samplers), function_pointer);
    }
    ...
    public static int glGenSamplers() {
        ...
        GL33.nglGenSamplers(1, MemoryUtil.getAddress(samplers), function_pointer);
    ...
    public static void glDeleteSamplers(IntBuffer samplers) {
        ...
        BufferChecks.checkFunctionAddress(function_pointer);
        BufferChecks.checkDirect(samplers);
        GL33.nglDeleteSamplers(samplers.remaining(), MemoryUtil.getAddress(samplers), function_pointer);
    }
    ...
    public static void glDeleteSamplers(int sampler) {
        ...
        long function_pointer = caps.glDeleteSamplers;
        BufferChecks.checkFunctionAddress(function_pointer);
        GL33.nglDeleteSamplers(1, APIUtil.getInt(caps, sampler), function_pointer);
    }
    ...
    public static void glSamplerParameter(int sampler, int pname, IntBuffer params) {
        ...
        GL33.nglSamplerParameteriv(sampler, pname, MemoryUtil.getAddress(params), function_pointer);
    }
    ...
    public static void glSamplerParameter(int sampler, int pname, FloatBuffer params) {
        ...
        BufferChecks.checkFunctionAddress(function_pointer);
        BufferChecks.checkBuffer(params, 4);
        GL33.nglSamplerParameterfv(sampler, pname, MemoryUtil.getAddress(params), function_pointer);
    }
    ...
    public static void glSamplerParameterI(int sampler, int pname, IntBuffer params) {
        ...
        BufferChecks.checkFunctionAddress(function_pointer);
        BufferChecks.checkBuffer(params, 4);
        GL33.nglSamplerParameterIiv(sampler, pname, MemoryUtil.getAddress(params), function_pointer);
    }
    ...
    public static void glSamplerParameterIu(int sampler, int pname, IntBuffer params) {
        ...
        BufferChecks.checkFunctionAddress(function_pointer);
        BufferChecks.checkBuffer(params, 4);
        GL33.nglSamplerParameterIuiv(sampler, pname, MemoryUtil.getAddress(params), function_pointer);
    }
    ...
    public static void glGetSamplerParameter(int sampler, int pname, IntBuffer params) {
        ...
        BufferChecks.checkFunctionAddress(function_pointer);
        BufferChecks.checkBuffer(params, 4);
        GL33.nglGetSamplerParameteriv(sampler, pname, MemoryUtil.getAddress(params), function_pointer);
    }
    ...
    public static void glGetSamplerParameter(int sampler, int pname, FloatBuffer params) {
        ...
        BufferChecks.checkFunctionAddress(function_pointer);
        BufferChecks.checkBuffer(params, 4);
        GL33.nglGetSamplerParameterfv(sampler, pname, MemoryUtil.getAddress(params), function_pointer);
    }
    ...
    public static void glGetSamplerParameterI(int sampler, int pname, IntBuffer params) {
        ...
        BufferChecks.checkFunctionAddress(function_pointer);
        BufferChecks.checkBuffer(params, 4);
        GL33.nglGetSamplerParameterIiv(sampler, pname, MemoryUtil.getAddress(params), function_pointer);
    }
    ...
    public static void glGetSamplerParameterIu(int sampler, int pname, IntBuffer params) {
        ...
        BufferChecks.checkFunctionAddress(function_pointer);
        BufferChecks.checkBuffer(params, 4);
        GL33.nglGetSamplerParameterIuiv(sampler, pname, MemoryUtil.getAddress(params), function_pointer);
    }
    ...
    public static void glQueryCounter(int id, int target) {
        ...
        BufferChecks.checkFunctionAddress(function_pointer);
        GL33.nglQueryCounter(id, target, function_pointer);
    }
    ...
    public static void glGetQueryObject(int id, int pname, LongBuffer params) {
        ...
        GL33.nglGetQueryObjecti64v(id, pname, MemoryUtil.getAddress(params), function_pointer);
    }
    ...
    public static void glGetQueryObjectu(int id, int pname, LongBuffer params) {
        ...
        BufferChecks.checkFunctionAddress(function_pointer);
        BufferChecks.checkBuffer(params, 1);
        GL33.nglGetQueryObjectui64v(id, pname, MemoryUtil.getAddress(params), function_pointer);
    }
    ...
    public static void glVertexP2u(int type, IntBuffer value) {
        ...
        GL33.nglVertexP2uiv(type, MemoryUtil.getAddress(value), function_pointer);
    }
    ...
    public static void glVertexP3u(int type, IntBuffer value) {
        ...
        GL33.nglVertexP3uiv(type, MemoryUtil.getAddress(value), function_pointer);
    }
    ...
    public static void glVertexP4u(int type, IntBuffer value) {
        ...
        GL33.nglVertexP4uiv(type, MemoryUtil.getAddress(value), function_pointer);
    }
    ...
    public static void glTexCoordP1u(int type, IntBuffer coords) {
        ...
        GL33.nglTexCoordP1uiv(type, MemoryUtil.getAddress(coords), function_pointer);
    }
    ...
    public static void glTexCoordP2u(int type, IntBuffer coords) {
        ...
        GL33.nglTexCoordP2uiv(type, MemoryUtil.getAddress(coords), function_pointer);
    }
    ...
    public static void glTexCoordP3u(int type, IntBuffer coords) {
        ...
        GL33.nglTexCoordP3uiv(type, MemoryUtil.getAddress(coords), function_pointer);
    }
    ...
    public static void glTexCoordP4u(int type, IntBuffer coords) {
        ...
        GL33.nglTexCoordP4uiv(type, MemoryUtil.getAddress(coords), function_pointer);
    }
    ...
    public static void glMultiTexCoordP1u(int texture, int type, IntBuffer coords) {
        ...
        BufferChecks.checkFunctionAddress(function_pointer);
        BufferChecks.checkBuffer(coords, 1);
        GL33.nglMultiTexCoordP1uiv(texture, type, MemoryUtil.getAddress(coords), function_pointer);
    }
    ...
    public static void glMultiTexCoordP2u(int texture, int type, IntBuffer coords) {
        ...
        BufferChecks.checkFunctionAddress(function_pointer);
        BufferChecks.checkBuffer(coords, 2);
        GL33.nglMultiTexCoordP2uiv(texture, type, MemoryUtil.getAddress(coords), function_pointer);
    }
    ...
    public static void glMultiTexCoordP3u(int texture, int type, IntBuffer coords) {
        ...
        BufferChecks.checkFunctionAddress(function_pointer);
        BufferChecks.checkBuffer(coords, 3);
        GL33.nglMultiTexCoordP3uiv(texture, type, MemoryUtil.getAddress(coords), function_pointer);
    }
    ...
    public static void glMultiTexCoordP4u(int texture, int type, IntBuffer coords) {
        ...
        BufferChecks.checkFunctionAddress(function_pointer);
        BufferChecks.checkBuffer(coords, 4);
        GL33.nglMultiTexCoordP4uiv(texture, type, MemoryUtil.getAddress(coords), function_pointer);
    }
    ...
    public static void glNormalP3u(int type, IntBuffer coords) {
        ...
        BufferChecks.checkFunctionAddress(function_pointer);
        BufferChecks.checkBuffer(coords, 3);
        GL33.nglNormalP3uiv(type, MemoryUtil.getAddress(coords), function_pointer);
    }
    ...
    public static void glColorP3u(int type, IntBuffer color) {
        ...
        GL33.nglColorP3uiv(type, MemoryUtil.getAddress(color), function_pointer);
    }
    ...
    public static void glColorP4u(int type, IntBuffer color) {
        ...
        GL33.nglColorP4uiv(type, MemoryUtil.getAddress(color), function_pointer);
    }
    ...
    public static void glSecondaryColorP3u(int type, IntBuffer color) {
        ...
        BufferChecks.checkFunctionAddress(function_pointer);
        BufferChecks.checkBuffer(color, 3);
        GL33.nglSecondaryColorP3uiv(type, MemoryUtil.getAddress(color), function_pointer);
    }
    ...
    public static void glVertexAttribP1u(int index, int type, boolean normalized, IntBuffer value) {
        ...
        GL33.nglVertexAttribP1uiv(index, type, normalized, MemoryUtil.getAddress(value), function_pointer);
    }
    ...
    public static void glVertexAttribP2u(int index, int type, boolean normalized, IntBuffer value) {
        ...
        BufferChecks.checkFunctionAddress(function_pointer);
        BufferChecks.checkBuffer(value, 2);
        GL33.nglVertexAttribP2uiv(index, type, normalized, MemoryUtil.getAddress(value), function_pointer);
    }
    ...
    public static void glVertexAttribP3u(int index, int type, boolean normalized, IntBuffer value) {
        ...
        BufferChecks.checkFunctionAddress(function_pointer);
        BufferChecks.checkBuffer(value, 3);
        GL33.nglVertexAttribP3uiv(index, type, normalized, MemoryUtil.getAddress(value), function_pointer);
    }
    ...
    public static void glVertexAttribP4u(int index, int type, boolean normalized, IntBuffer value) {
        ...
        BufferChecks.checkFunctionAddress(function_pointer);
        BufferChecks.checkBuffer(value, 4);
        GL33.nglVertexAttribP4uiv(index, type, normalized, MemoryUtil.getAddress(value), function_pointer);
    }
