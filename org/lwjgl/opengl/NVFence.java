...
public final class NVFence {
    ...
    public static void glGenFencesNV(IntBuffer piFences) {
        ...
        NVFence.nglGenFencesNV(piFences.remaining(), MemoryUtil.getAddress(piFences), function_pointer);
    }
    ...
    public static int glGenFencesNV() {
        ...
        NVFence.nglGenFencesNV(1, MemoryUtil.getAddress(piFences), function_pointer);
    ...
    public static void glDeleteFencesNV(IntBuffer piFences) {
        ...
        BufferChecks.checkFunctionAddress(function_pointer);
        BufferChecks.checkDirect(piFences);
        NVFence.nglDeleteFencesNV(piFences.remaining(), MemoryUtil.getAddress(piFences), function_pointer);
    }
    ...
    public static void glDeleteFencesNV(int fence) {
        ...
        long function_pointer = caps.glDeleteFencesNV;
        BufferChecks.checkFunctionAddress(function_pointer);
        NVFence.nglDeleteFencesNV(1, APIUtil.getInt(caps, fence), function_pointer);
    }
    ...
    public static void glGetFenceivNV(int fence, int pname, IntBuffer piParams) {
        ...
        NVFence.nglGetFenceivNV(fence, pname, MemoryUtil.getAddress(piParams), function_pointer);
    }
