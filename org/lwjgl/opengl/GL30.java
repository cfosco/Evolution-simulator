...
public final class GL30 {
    ...
    public static void glClearBuffer(int buffer, int drawbuffer, FloatBuffer value) {
        ...
        GL30.nglClearBufferfv(buffer, drawbuffer, MemoryUtil.getAddress(value), function_pointer);
    }
    ...
    public static void glClearBuffer(int buffer, int drawbuffer, IntBuffer value) {
        ...
        BufferChecks.checkFunctionAddress(function_pointer);
        BufferChecks.checkBuffer(value, 4);
        GL30.nglClearBufferiv(buffer, drawbuffer, MemoryUtil.getAddress(value), function_pointer);
    }
    ...
    public static void glClearBufferu(int buffer, int drawbuffer, IntBuffer value) {
        ...
        BufferChecks.checkFunctionAddress(function_pointer);
        BufferChecks.checkBuffer(value, 4);
        GL30.nglClearBufferuiv(buffer, drawbuffer, MemoryUtil.getAddress(value), function_pointer);
    }
    ...
    public static void glVertexAttribI1i(int index, int x) {
        ...
        BufferChecks.checkFunctionAddress(function_pointer);
        GL30.nglVertexAttribI1i(index, x, function_pointer);
    }
    ...
    public static void glVertexAttribI2i(int index, int x, int y) {
        ...
        BufferChecks.checkFunctionAddress(function_pointer);
        GL30.nglVertexAttribI2i(index, x, y, function_pointer);
    }
    ...
    public static void glVertexAttribI3i(int index, int x, int y, int z) {
        ...
        BufferChecks.checkFunctionAddress(function_pointer);
        GL30.nglVertexAttribI3i(index, x, y, z, function_pointer);
    }
    ...
    public static void glVertexAttribI4i(int index, int x, int y, int z, int w) {
        ...
        BufferChecks.checkFunctionAddress(function_pointer);
        GL30.nglVertexAttribI4i(index, x, y, z, w, function_pointer);
    }
    ...
    public static void glVertexAttribI1ui(int index, int x) {
        ...
        BufferChecks.checkFunctionAddress(function_pointer);
        GL30.nglVertexAttribI1ui(index, x, function_pointer);
    }
    ...
    public static void glVertexAttribI2ui(int index, int x, int y) {
        ...
        BufferChecks.checkFunctionAddress(function_pointer);
        GL30.nglVertexAttribI2ui(index, x, y, function_pointer);
    }
    ...
    public static void glVertexAttribI3ui(int index, int x, int y, int z) {
        ...
        BufferChecks.checkFunctionAddress(function_pointer);
        GL30.nglVertexAttribI3ui(index, x, y, z, function_pointer);
    }
    ...
    public static void glVertexAttribI4ui(int index, int x, int y, int z, int w) {
        ...
        BufferChecks.checkFunctionAddress(function_pointer);
        GL30.nglVertexAttribI4ui(index, x, y, z, w, function_pointer);
    }
    ...
    public static void glVertexAttribI1(int index, IntBuffer v) {
        ...
        GL30.nglVertexAttribI1iv(index, MemoryUtil.getAddress(v), function_pointer);
    }
    ...
    public static void glVertexAttribI2(int index, IntBuffer v) {
        ...
        GL30.nglVertexAttribI2iv(index, MemoryUtil.getAddress(v), function_pointer);
    }
    ...
    public static void glVertexAttribI3(int index, IntBuffer v) {
        ...
        GL30.nglVertexAttribI3iv(index, MemoryUtil.getAddress(v), function_pointer);
    }
    ...
    public static void glVertexAttribI4(int index, IntBuffer v) {
        ...
        GL30.nglVertexAttribI4iv(index, MemoryUtil.getAddress(v), function_pointer);
    }
    ...
    public static void glVertexAttribI1u(int index, IntBuffer v) {
        ...
        BufferChecks.checkFunctionAddress(function_pointer);
        BufferChecks.checkBuffer(v, 1);
        GL30.nglVertexAttribI1uiv(index, MemoryUtil.getAddress(v), function_pointer);
    }
    ...
    public static void glVertexAttribI2u(int index, IntBuffer v) {
        ...
        BufferChecks.checkFunctionAddress(function_pointer);
        BufferChecks.checkBuffer(v, 2);
        GL30.nglVertexAttribI2uiv(index, MemoryUtil.getAddress(v), function_pointer);
    }
    ...
    public static void glVertexAttribI3u(int index, IntBuffer v) {
        ...
        BufferChecks.checkFunctionAddress(function_pointer);
        BufferChecks.checkBuffer(v, 3);
        GL30.nglVertexAttribI3uiv(index, MemoryUtil.getAddress(v), function_pointer);
    }
    ...
    public static void glVertexAttribI4u(int index, IntBuffer v) {
        ...
        BufferChecks.checkFunctionAddress(function_pointer);
        BufferChecks.checkBuffer(v, 4);
        GL30.nglVertexAttribI4uiv(index, MemoryUtil.getAddress(v), function_pointer);
    }
    ...
    public static void glVertexAttribI4(int index, ByteBuffer v) {
        ...
        BufferChecks.checkFunctionAddress(function_pointer);
        BufferChecks.checkBuffer(v, 4);
        GL30.nglVertexAttribI4bv(index, MemoryUtil.getAddress(v), function_pointer);
    }
    ...
    public static void glVertexAttribI4(int index, ShortBuffer v) {
        ...
        BufferChecks.checkFunctionAddress(function_pointer);
        BufferChecks.checkBuffer(v, 4);
        GL30.nglVertexAttribI4sv(index, MemoryUtil.getAddress(v), function_pointer);
    }
    ...
    public static void glVertexAttribI4u(int index, ByteBuffer v) {
        ...
        BufferChecks.checkFunctionAddress(function_pointer);
        BufferChecks.checkBuffer(v, 4);
        GL30.nglVertexAttribI4ubv(index, MemoryUtil.getAddress(v), function_pointer);
    }
    ...
    public static void glVertexAttribI4u(int index, ShortBuffer v) {
        ...
        BufferChecks.checkFunctionAddress(function_pointer);
        BufferChecks.checkBuffer(v, 4);
        GL30.nglVertexAttribI4usv(index, MemoryUtil.getAddress(v), function_pointer);
    }
    ...
    public static void glVertexAttribIPointer(int index, int size, int type, int stride, ByteBuffer buffer) {
        ...
        GL30.nglVertexAttribIPointer(index, size, type, stride, MemoryUtil.getAddress(buffer), function_pointer);
    }
    ...
    public static void glGetVertexAttribI(int index, int pname, IntBuffer params) {
        ...
        GL30.nglGetVertexAttribIiv(index, pname, MemoryUtil.getAddress(params), function_pointer);
    }
    ...
    public static void glGetVertexAttribIu(int index, int pname, IntBuffer params) {
        ...
        BufferChecks.checkFunctionAddress(function_pointer);
        BufferChecks.checkBuffer(params, 4);
        GL30.nglGetVertexAttribIuiv(index, pname, MemoryUtil.getAddress(params), function_pointer);
    }
    ...
    public static void glUniform1u(int location, IntBuffer value) {
        ...
        GL30.nglUniform1uiv(location, value.remaining(), MemoryUtil.getAddress(value), function_pointer);
    }
    ...
    public static void glUniform2u(int location, IntBuffer value) {
        ...
        BufferChecks.checkFunctionAddress(function_pointer);
        BufferChecks.checkDirect(value);
        GL30.nglUniform2uiv(location, value.remaining() >> 1, MemoryUtil.getAddress(value), function_pointer);
    }
    ...
    public static void glUniform3u(int location, IntBuffer value) {
        ...
        BufferChecks.checkFunctionAddress(function_pointer);
        BufferChecks.checkDirect(value);
        GL30.nglUniform3uiv(location, value.remaining() / 3, MemoryUtil.getAddress(value), function_pointer);
    }
    ...
    public static void glUniform4u(int location, IntBuffer value) {
        ...
        BufferChecks.checkFunctionAddress(function_pointer);
        BufferChecks.checkDirect(value);
        GL30.nglUniform4uiv(location, value.remaining() >> 2, MemoryUtil.getAddress(value), function_pointer);
    }
    ...
    public static void glGetUniformu(int program, int location, IntBuffer params) {
        ...
        GL30.nglGetUniformuiv(program, location, MemoryUtil.getAddress(params), function_pointer);
    }
    ...
    public static void glBindFragDataLocation(int program, int colorNumber, ByteBuffer name) {
        ...
        GL30.nglBindFragDataLocation(program, colorNumber, MemoryUtil.getAddress(name), function_pointer);
    }
    ...
    public static void glBindFragDataLocation(int program, int colorNumber, CharSequence name) {
        ...
        long function_pointer = caps.glBindFragDataLocation;
        BufferChecks.checkFunctionAddress(function_pointer);
        GL30.nglBindFragDataLocation(program, colorNumber, APIUtil.getBufferNT(caps, name), function_pointer);
    }
    ...
    public static int glGetFragDataLocation(int program, ByteBuffer name) {
        ...
        BufferChecks.checkDirect(name);
        BufferChecks.checkNullTerminated(name);
        int __result = GL30.nglGetFragDataLocation(program, MemoryUtil.getAddress(name), function_pointer);
        return __result;
    }
    ...
    public static int glGetFragDataLocation(int program, CharSequence name) {
        ...
        long function_pointer = caps.glGetFragDataLocation;
        BufferChecks.checkFunctionAddress(function_pointer);
        int __result = GL30.nglGetFragDataLocation(program, APIUtil.getBufferNT(caps, name), function_pointer);
        return __result;
    }
    ...
    public static void glBeginConditionalRender(int id, int mode) {
        ...
        BufferChecks.checkFunctionAddress(function_pointer);
        GL30.nglBeginConditionalRender(id, mode, function_pointer);
    }
    ...
    public static void glDeleteRenderbuffers(IntBuffer renderbuffers) {
        ...
        GL30.nglDeleteRenderbuffers(renderbuffers.remaining(), MemoryUtil.getAddress(renderbuffers), function_pointer);
    }
    ...
    public static void glDeleteRenderbuffers(int renderbuffer) {
        ...
        long function_pointer = caps.glDeleteRenderbuffers;
        BufferChecks.checkFunctionAddress(function_pointer);
        GL30.nglDeleteRenderbuffers(1, APIUtil.getInt(caps, renderbuffer), function_pointer);
    }
    ...
    public static void glGenRenderbuffers(IntBuffer renderbuffers) {
        ...
        BufferChecks.checkFunctionAddress(function_pointer);
        BufferChecks.checkDirect(renderbuffers);
        GL30.nglGenRenderbuffers(renderbuffers.remaining(), MemoryUtil.getAddress(renderbuffers), function_pointer);
    }
    ...
    public static int glGenRenderbuffers() {
        ...
        GL30.nglGenRenderbuffers(1, MemoryUtil.getAddress(renderbuffers), function_pointer);
    ...
    public static void glGetRenderbufferParameter(int target, int pname, IntBuffer params) {
        ...
        BufferChecks.checkFunctionAddress(function_pointer);
        BufferChecks.checkBuffer(params, 4);
        GL30.nglGetRenderbufferParameteriv(target, pname, MemoryUtil.getAddress(params), function_pointer);
    }
    ...
    public static void glDeleteFramebuffers(IntBuffer framebuffers) {
        ...
        GL30.nglDeleteFramebuffers(framebuffers.remaining(), MemoryUtil.getAddress(framebuffers), function_pointer);
    }
    ...
    public static void glDeleteFramebuffers(int framebuffer) {
        ...
        long function_pointer = caps.glDeleteFramebuffers;
        BufferChecks.checkFunctionAddress(function_pointer);
        GL30.nglDeleteFramebuffers(1, APIUtil.getInt(caps, framebuffer), function_pointer);
    }
    ...
    public static void glGenFramebuffers(IntBuffer framebuffers) {
        ...
        BufferChecks.checkFunctionAddress(function_pointer);
        BufferChecks.checkDirect(framebuffers);
        GL30.nglGenFramebuffers(framebuffers.remaining(), MemoryUtil.getAddress(framebuffers), function_pointer);
    }
    ...
    public static void glGetFramebufferAttachmentParameter(int target, int attachment, int pname, IntBuffer params) {
        ...
        BufferChecks.checkFunctionAddress(function_pointer);
        BufferChecks.checkBuffer(params, 4);
        GL30.nglGetFramebufferAttachmentParameteriv(target, attachment, pname, MemoryUtil.getAddress(params), function_pointer);
    }
    ...
    public static void glTexParameterI(int target, int pname, IntBuffer params) {
        ...
        BufferChecks.checkFunctionAddress(function_pointer);
        BufferChecks.checkBuffer(params, 4);
        GL30.nglTexParameterIiv(target, pname, MemoryUtil.getAddress(params), function_pointer);
    }
    ...
    public static void glTexParameterIi(int target, int pname, int param) {
        ...
        long function_pointer = caps.glTexParameterIiv;
        BufferChecks.checkFunctionAddress(function_pointer);
        GL30.nglTexParameterIiv(target, pname, APIUtil.getInt(caps, param), function_pointer);
    }
    ...
    public static void glTexParameterIu(int target, int pname, IntBuffer params) {
        ...
        BufferChecks.checkFunctionAddress(function_pointer);
        BufferChecks.checkBuffer(params, 4);
        GL30.nglTexParameterIuiv(target, pname, MemoryUtil.getAddress(params), function_pointer);
    }
    ...
    public static void glTexParameterIui(int target, int pname, int param) {
        ...
        long function_pointer = caps.glTexParameterIuiv;
        BufferChecks.checkFunctionAddress(function_pointer);
        GL30.nglTexParameterIuiv(target, pname, APIUtil.getInt(caps, param), function_pointer);
    }
    ...
    public static void glGetTexParameterI(int target, int pname, IntBuffer params) {
        ...
        BufferChecks.checkFunctionAddress(function_pointer);
        BufferChecks.checkBuffer(params, 4);
        GL30.nglGetTexParameterIiv(target, pname, MemoryUtil.getAddress(params), function_pointer);
    }
    ...
    public static void glGetTexParameterIu(int target, int pname, IntBuffer params) {
        ...
        BufferChecks.checkFunctionAddress(function_pointer);
        BufferChecks.checkBuffer(params, 4);
        GL30.nglGetTexParameterIuiv(target, pname, MemoryUtil.getAddress(params), function_pointer);
    }
    ...
    public static void glColorMaski(int buf, boolean r, boolean g, boolean b, boolean a) {
        ...
        BufferChecks.checkFunctionAddress(function_pointer);
        GL30.nglColorMaski(buf, r, g, b, a, function_pointer);
    }
    ...
    public static void glGetBoolean(int value, int index, ByteBuffer data) {
        ...
        GL30.nglGetBooleani_v(value, index, MemoryUtil.getAddress(data), function_pointer);
    }
    ...
    public static void glGetInteger(int value, int index, IntBuffer data) {
        ...
        BufferChecks.checkFunctionAddress(function_pointer);
        BufferChecks.checkBuffer(data, 4);
        GL30.nglGetIntegeri_v(value, index, MemoryUtil.getAddress(data), function_pointer);
    }
    ...
    public static void glTransformFeedbackVaryings(int program, int count, ByteBuffer varyings, int bufferMode) {
        ...
        GL30.nglTransformFeedbackVaryings(program, count, MemoryUtil.getAddress(varyings), bufferMode, function_pointer);
    }
    ...
    public static void glTransformFeedbackVaryings(int program, CharSequence[] varyings, int bufferMode) {
        ...
        GL30.nglTransformFeedbackVaryings(program, varyings.length, APIUtil.getBufferNT(caps, varyings), bufferMode, function_pointer);
    }
    ...
    public static void glGetTransformFeedbackVarying(int program, int index, IntBuffer length, IntBuffer size, IntBuffer type, ByteBuffer name) {
        ...
        BufferChecks.checkDirect(name);
        GL30.nglGetTransformFeedbackVarying(program, index, name.remaining(), MemoryUtil.getAddressSafe(length), MemoryUtil.getAddress(size), MemoryUtil.getAddress(type), MemoryUtil.getAddress(name), function_pointer);
    }
    ...
    public static String glGetTransformFeedbackVarying(int program, int index, int bufSize, IntBuffer size, IntBuffer type) {
        ...
        GL30.nglGetTransformFeedbackVarying(program, index, bufSize, MemoryUtil.getAddress0(name_length), MemoryUtil.getAddress(size), MemoryUtil.getAddress(type), MemoryUtil.getAddress(name), function_pointer);
    ...
    public static void glDeleteVertexArrays(IntBuffer arrays) {
        ...
        GL30.nglDeleteVertexArrays(arrays.remaining(), MemoryUtil.getAddress(arrays), function_pointer);
    }
    ...
    public static void glDeleteVertexArrays(int array) {
        ...
        GL30.nglDeleteVertexArrays(1, APIUtil.getInt(caps, array), function_pointer);
    }
    ...
    public static void glGenVertexArrays(IntBuffer arrays) {
        ...
        BufferChecks.checkFunctionAddress(function_pointer);
        BufferChecks.checkDirect(arrays);
        GL30.nglGenVertexArrays(arrays.remaining(), MemoryUtil.getAddress(arrays), function_pointer);
    }
    ...
    public static int glGenVertexArrays() {
        ...
        GL30.nglGenVertexArrays(1, MemoryUtil.getAddress(arrays), function_pointer);
        return arrays.get(0);
    }
