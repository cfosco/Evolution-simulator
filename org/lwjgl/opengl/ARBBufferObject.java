...
public class ARBBufferObject {
    ...
    public static void glDeleteBuffersARB(IntBuffer buffers) {
        ...
        ARBBufferObject.nglDeleteBuffersARB(buffers.remaining(), MemoryUtil.getAddress(buffers), function_pointer);
    }
    ...
    public static void glDeleteBuffersARB(int buffer) {
        ...
        long function_pointer = caps.glDeleteBuffersARB;
        BufferChecks.checkFunctionAddress(function_pointer);
        ARBBufferObject.nglDeleteBuffersARB(1, APIUtil.getInt(caps, buffer), function_pointer);
    }
    ...
    public static void glGenBuffersARB(IntBuffer buffers) {
        ...
        BufferChecks.checkFunctionAddress(function_pointer);
        BufferChecks.checkDirect(buffers);
        ARBBufferObject.nglGenBuffersARB(buffers.remaining(), MemoryUtil.getAddress(buffers), function_pointer);
    }
    ...
    public static int glGenBuffersARB() {
        ...
        ARBBufferObject.nglGenBuffersARB(1, MemoryUtil.getAddress(buffers), function_pointer);
    ...
    public static void glBufferDataARB(int target, long data_size, int usage) {
        ...
        BufferChecks.checkFunctionAddress(function_pointer);
        ARBBufferObject.nglBufferDataARB(target, data_size, 0, usage, function_pointer);
    }
    ...
    public static void glBufferDataARB(int target, ByteBuffer data, int usage) {
        ...
        ARBBufferObject.nglBufferDataARB(target, data.remaining(), MemoryUtil.getAddress(data), usage, function_pointer);
    }
    ...
    public static void glBufferDataARB(int target, DoubleBuffer data, int usage) {
        ...
        BufferChecks.checkFunctionAddress(function_pointer);
        BufferChecks.checkDirect(data);
        ARBBufferObject.nglBufferDataARB(target, data.remaining() << 3, MemoryUtil.getAddress(data), usage, function_pointer);
    }
    ...
    public static void glBufferDataARB(int target, FloatBuffer data, int usage) {
        ...
        BufferChecks.checkFunctionAddress(function_pointer);
        BufferChecks.checkDirect(data);
        ARBBufferObject.nglBufferDataARB(target, data.remaining() << 2, MemoryUtil.getAddress(data), usage, function_pointer);
    }
    ...
    public static void glBufferDataARB(int target, ShortBuffer data, int usage) {
        ...
        BufferChecks.checkFunctionAddress(function_pointer);
        BufferChecks.checkDirect(data);
        ARBBufferObject.nglBufferDataARB(target, data.remaining() << 1, MemoryUtil.getAddress(data), usage, function_pointer);
    }
    ...
    public static void glBufferSubDataARB(int target, long offset, ByteBuffer data) {
        ...
        BufferChecks.checkFunctionAddress(function_pointer);
        BufferChecks.checkDirect(data);
        ARBBufferObject.nglBufferSubDataARB(target, offset, data.remaining(), MemoryUtil.getAddress(data), function_pointer);
    }
    ...
    public static void glBufferSubDataARB(int target, long offset, DoubleBuffer data) {
        ...
        BufferChecks.checkFunctionAddress(function_pointer);
        BufferChecks.checkDirect(data);
        ARBBufferObject.nglBufferSubDataARB(target, offset, data.remaining() << 3, MemoryUtil.getAddress(data), function_pointer);
    }
    ...
    public static void glBufferSubDataARB(int target, long offset, FloatBuffer data) {
        ...
        BufferChecks.checkFunctionAddress(function_pointer);
        BufferChecks.checkDirect(data);
        ARBBufferObject.nglBufferSubDataARB(target, offset, data.remaining() << 2, MemoryUtil.getAddress(data), function_pointer);
    }
    ...
    public static void glBufferSubDataARB(int target, long offset, ShortBuffer data) {
        ...
        BufferChecks.checkFunctionAddress(function_pointer);
        BufferChecks.checkDirect(data);
        ARBBufferObject.nglBufferSubDataARB(target, offset, data.remaining() << 1, MemoryUtil.getAddress(data), function_pointer);
    }
    ...
    public static void glGetBufferSubDataARB(int target, long offset, ByteBuffer data) {
        ...
        BufferChecks.checkFunctionAddress(function_pointer);
        BufferChecks.checkDirect(data);
        ARBBufferObject.nglGetBufferSubDataARB(target, offset, data.remaining(), MemoryUtil.getAddress(data), function_pointer);
    }
    ...
    public static void glGetBufferSubDataARB(int target, long offset, DoubleBuffer data) {
        ...
        BufferChecks.checkFunctionAddress(function_pointer);
        BufferChecks.checkDirect(data);
        ARBBufferObject.nglGetBufferSubDataARB(target, offset, data.remaining() << 3, MemoryUtil.getAddress(data), function_pointer);
    }
    ...
    public static void glGetBufferSubDataARB(int target, long offset, FloatBuffer data) {
        ...
        BufferChecks.checkFunctionAddress(function_pointer);
        BufferChecks.checkDirect(data);
        ARBBufferObject.nglGetBufferSubDataARB(target, offset, data.remaining() << 2, MemoryUtil.getAddress(data), function_pointer);
    }
    ...
    public static void glGetBufferSubDataARB(int target, long offset, ShortBuffer data) {
        ...
        BufferChecks.checkFunctionAddress(function_pointer);
        BufferChecks.checkDirect(data);
        ARBBufferObject.nglGetBufferSubDataARB(target, offset, data.remaining() << 1, MemoryUtil.getAddress(data), function_pointer);
    }
    ...
    public static ByteBuffer glMapBufferARB(int target, int access, ByteBuffer old_buffer) {
        ...
        ByteBuffer __result = ARBBufferObject.nglMapBufferARB(target, access, ARBBufferObject.glGetBufferParameteriARB(target, 34660), old_buffer, function_pointer);
    ...
    public static void glGetBufferParameterARB(int target, int pname, IntBuffer params) {
        ...
        ARBBufferObject.nglGetBufferParameterivARB(target, pname, MemoryUtil.getAddress(params), function_pointer);
    }
    ...
    public static ByteBuffer glGetBufferPointerARB(int target, int pname) {
        ...
        BufferChecks.checkFunctionAddress(function_pointer);
        ByteBuffer __result = ARBBufferObject.nglGetBufferPointervARB(target, pname, ARBBufferObject.glGetBufferParameteriARB(target, 34660), function_pointer);
        return LWJGLUtil.CHECKS && __result == null ? null : __result.order(ByteOrder.nativeOrder());
    }
