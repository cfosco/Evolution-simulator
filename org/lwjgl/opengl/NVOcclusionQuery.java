...
public final class NVOcclusionQuery {
    ...
    public static void glGenOcclusionQueriesNV(IntBuffer piIDs) {
        ...
        NVOcclusionQuery.nglGenOcclusionQueriesNV(piIDs.remaining(), MemoryUtil.getAddress(piIDs), function_pointer);
    }
    ...
    public static int glGenOcclusionQueriesNV() {
        ...
        NVOcclusionQuery.nglGenOcclusionQueriesNV(1, MemoryUtil.getAddress(piIDs), function_pointer);
        return piIDs.get(0);
    }
    ...
    public static void glDeleteOcclusionQueriesNV(IntBuffer piIDs) {
        ...
        BufferChecks.checkFunctionAddress(function_pointer);
        BufferChecks.checkDirect(piIDs);
        NVOcclusionQuery.nglDeleteOcclusionQueriesNV(piIDs.remaining(), MemoryUtil.getAddress(piIDs), function_pointer);
    }
    ...
    public static void glDeleteOcclusionQueriesNV(int piID) {
        ...
        long function_pointer = caps.glDeleteOcclusionQueriesNV;
        BufferChecks.checkFunctionAddress(function_pointer);
        NVOcclusionQuery.nglDeleteOcclusionQueriesNV(1, APIUtil.getInt(caps, piID), function_pointer);
    }
    ...
    public static boolean glIsOcclusionQueryNV(int id) {
        ...
        BufferChecks.checkFunctionAddress(function_pointer);
        boolean __result = NVOcclusionQuery.nglIsOcclusionQueryNV(id, function_pointer);
        return __result;
    }
    ...
    public static void glBeginOcclusionQueryNV(int id) {
        ...
        BufferChecks.checkFunctionAddress(function_pointer);
        NVOcclusionQuery.nglBeginOcclusionQueryNV(id, function_pointer);
    }
    ...
    public static void glGetOcclusionQueryuNV(int id, int pname, IntBuffer params) {
        ...
        NVOcclusionQuery.nglGetOcclusionQueryuivNV(id, pname, MemoryUtil.getAddress(params), function_pointer);
    }
    ...
    public static void glGetOcclusionQueryNV(int id, int pname, IntBuffer params) {
        ...
        BufferChecks.checkFunctionAddress(function_pointer);
        BufferChecks.checkBuffer(params, 1);
        NVOcclusionQuery.nglGetOcclusionQueryivNV(id, pname, MemoryUtil.getAddress(params), function_pointer);
    }
