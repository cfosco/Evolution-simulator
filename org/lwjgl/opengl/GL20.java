...
public final class GL20 {
    ...
    public static void glShaderSource(int shader, ByteBuffer string) {
        ...
        GL20.nglShaderSource(shader, 1, MemoryUtil.getAddress(string), string.remaining(), function_pointer);
    }
    ...
    public static void glShaderSource(int shader, CharSequence[] strings) {
        ...
        GL20.nglShaderSource3(shader, strings.length, APIUtil.getBuffer(caps, strings), APIUtil.getLengths(caps, strings), function_pointer);
    }
    ...
    public static void glUniform1(int location, FloatBuffer values) {
        ...
        GL20.nglUniform1fv(location, values.remaining(), MemoryUtil.getAddress(values), function_pointer);
    }
    ...
    public static void glUniform2(int location, FloatBuffer values) {
        ...
        BufferChecks.checkFunctionAddress(function_pointer);
        BufferChecks.checkDirect(values);
        GL20.nglUniform2fv(location, values.remaining() >> 1, MemoryUtil.getAddress(values), function_pointer);
    }
    ...
    public static void glUniform3(int location, FloatBuffer values) {
        ...
        BufferChecks.checkFunctionAddress(function_pointer);
        BufferChecks.checkDirect(values);
        GL20.nglUniform3fv(location, values.remaining() / 3, MemoryUtil.getAddress(values), function_pointer);
    }
    ...
    public static void glUniform4(int location, FloatBuffer values) {
        ...
        BufferChecks.checkFunctionAddress(function_pointer);
        BufferChecks.checkDirect(values);
        GL20.nglUniform4fv(location, values.remaining() >> 2, MemoryUtil.getAddress(values), function_pointer);
    }
    ...
    public static void glUniform1(int location, IntBuffer values) {
        ...
        BufferChecks.checkFunctionAddress(function_pointer);
        BufferChecks.checkDirect(values);
        GL20.nglUniform1iv(location, values.remaining(), MemoryUtil.getAddress(values), function_pointer);
    }
    ...
    public static void glUniform2(int location, IntBuffer values) {
        ...
        BufferChecks.checkFunctionAddress(function_pointer);
        BufferChecks.checkDirect(values);
        GL20.nglUniform2iv(location, values.remaining() >> 1, MemoryUtil.getAddress(values), function_pointer);
    }
    ...
    public static void glUniform3(int location, IntBuffer values) {
        ...
        BufferChecks.checkFunctionAddress(function_pointer);
        BufferChecks.checkDirect(values);
        GL20.nglUniform3iv(location, values.remaining() / 3, MemoryUtil.getAddress(values), function_pointer);
    }
    ...
    public static void glUniform4(int location, IntBuffer values) {
        ...
        BufferChecks.checkFunctionAddress(function_pointer);
        BufferChecks.checkDirect(values);
        GL20.nglUniform4iv(location, values.remaining() >> 2, MemoryUtil.getAddress(values), function_pointer);
    }
    ...
    public static void glUniformMatrix2(int location, boolean transpose, FloatBuffer matrices) {
        ...
        GL20.nglUniformMatrix2fv(location, matrices.remaining() >> 2, transpose, MemoryUtil.getAddress(matrices), function_pointer);
    }
    ...
    public static void glUniformMatrix3(int location, boolean transpose, FloatBuffer matrices) {
        ...
        BufferChecks.checkFunctionAddress(function_pointer);
        BufferChecks.checkDirect(matrices);
        GL20.nglUniformMatrix3fv(location, matrices.remaining() / 9, transpose, MemoryUtil.getAddress(matrices), function_pointer);
    }
    ...
    public static String glGetShaderInfoLog(int shader, int maxLength) {
        ...
        GL20.nglGetShaderInfoLog(shader, maxLength, MemoryUtil.getAddress0(infoLog_length), MemoryUtil.getAddress(infoLog), function_pointer);
    ...
    public static String glGetProgramInfoLog(int program, int maxLength) {
        ...
        IntBuffer infoLog_length = APIUtil.getLengths(caps);
        ByteBuffer infoLog = APIUtil.getBufferByte(caps, maxLength);
        GL20.nglGetProgramInfoLog(program, maxLength, MemoryUtil.getAddress0(infoLog_length), MemoryUtil.getAddress(infoLog), function_pointer);
        infoLog.limit(infoLog_length.get(0));
        return APIUtil.getString(caps, infoLog);
    }
    ...
    public static void glGetAttachedShaders(int program, IntBuffer count, IntBuffer shaders) {
        ...
        GL20.nglGetAttachedShaders(program, shaders.remaining(), MemoryUtil.getAddressSafe(count), MemoryUtil.getAddress(shaders), function_pointer);
    }
    ...
    public static int glGetUniformLocation(int program, ByteBuffer name) {
        ...
        int __result = GL20.nglGetUniformLocation(program, MemoryUtil.getAddress(name), function_pointer);
        return __result;
    }
    ...
    public static void glGetActiveUniform(int program, int index, IntBuffer length, IntBuffer size, IntBuffer type, ByteBuffer name) {
        ...
        GL20.nglGetActiveUniform(program, index, name.remaining(), MemoryUtil.getAddressSafe(length), MemoryUtil.getAddress(size), MemoryUtil.getAddress(type), MemoryUtil.getAddress(name), function_pointer);
    }
    ...
    public static String glGetActiveUniform(int program, int index, int maxLength) {
        ...
        IntBuffer name_length = APIUtil.getLengths(caps);
        ByteBuffer name = APIUtil.getBufferByte(caps, maxLength);
        GL20.nglGetActiveUniform(program, index, maxLength, MemoryUtil.getAddress0(name_length), MemoryUtil.getAddress0(APIUtil.getBufferInt(caps)), MemoryUtil.getAddress(APIUtil.getBufferInt(caps), 1), MemoryUtil.getAddress(name), function_pointer);
        name.limit(name_length.get(0));
        return APIUtil.getString(caps, name);
    }
    ...
    public static int glGetActiveUniformSize(int program, int index) {
        ...
        GL20.nglGetActiveUniform(program, index, 1, 0, MemoryUtil.getAddress(size), MemoryUtil.getAddress(size, 1), APIUtil.getBufferByte0(caps), function_pointer);
        return size.get(0);
    }
    ...
    public static int glGetActiveUniformType(int program, int index) {
        ...
        GL20.nglGetActiveUniform(program, index, 0, 0, MemoryUtil.getAddress(type, 1), MemoryUtil.getAddress(type), APIUtil.getBufferByte0(caps), function_pointer);
        return type.get(0);
    }
    ...
    public static void glGetUniform(int program, int location, FloatBuffer params) {
        ...
        BufferChecks.checkFunctionAddress(function_pointer);
        BufferChecks.checkDirect(params);
        GL20.nglGetUniformfv(program, location, MemoryUtil.getAddress(params), function_pointer);
    }
    ...
    public static void glGetUniform(int program, int location, IntBuffer params) {
        ...
        BufferChecks.checkFunctionAddress(function_pointer);
        BufferChecks.checkDirect(params);
        GL20.nglGetUniformiv(program, location, MemoryUtil.getAddress(params), function_pointer);
    }
    ...
    public static void glGetShaderSource(int shader, IntBuffer length, ByteBuffer source) {
        ...
        GL20.nglGetShaderSource(shader, source.remaining(), MemoryUtil.getAddressSafe(length), MemoryUtil.getAddress(source), function_pointer);
    }
    ...
    public static String glGetShaderSource(int shader, int maxLength) {
        ...
        GL20.nglGetShaderSource(shader, maxLength, MemoryUtil.getAddress0(source_length), MemoryUtil.getAddress(source), function_pointer);
    ...
    public static void glVertexAttrib1s(int index, short x) {
        ...
        BufferChecks.checkFunctionAddress(function_pointer);
        GL20.nglVertexAttrib1s(index, x, function_pointer);
    }
    ...
    public static void glVertexAttrib1f(int index, float x) {
        ...
        BufferChecks.checkFunctionAddress(function_pointer);
        GL20.nglVertexAttrib1f(index, x, function_pointer);
    }
    ...
    public static void glVertexAttrib1d(int index, double x) {
        ...
        BufferChecks.checkFunctionAddress(function_pointer);
        GL20.nglVertexAttrib1d(index, x, function_pointer);
    }
    ...
    public static void glVertexAttrib2s(int index, short x, short y) {
        ...
        BufferChecks.checkFunctionAddress(function_pointer);
        GL20.nglVertexAttrib2s(index, x, y, function_pointer);
    }
    ...
    public static void glVertexAttrib2f(int index, float x, float y) {
        ...
        BufferChecks.checkFunctionAddress(function_pointer);
        GL20.nglVertexAttrib2f(index, x, y, function_pointer);
    }
    ...
    public static void glVertexAttrib2d(int index, double x, double y) {
        ...
        BufferChecks.checkFunctionAddress(function_pointer);
        GL20.nglVertexAttrib2d(index, x, y, function_pointer);
    }
    ...
    public static void glVertexAttrib3s(int index, short x, short y, short z) {
        ...
        BufferChecks.checkFunctionAddress(function_pointer);
        GL20.nglVertexAttrib3s(index, x, y, z, function_pointer);
    }
    ...
    public static void glVertexAttrib3f(int index, float x, float y, float z) {
        ...
        BufferChecks.checkFunctionAddress(function_pointer);
        GL20.nglVertexAttrib3f(index, x, y, z, function_pointer);
    }
    ...
    public static void glVertexAttrib3d(int index, double x, double y, double z) {
        ...
        BufferChecks.checkFunctionAddress(function_pointer);
        GL20.nglVertexAttrib3d(index, x, y, z, function_pointer);
    }
    ...
    public static void glVertexAttrib4s(int index, short x, short y, short z, short w) {
        ...
        BufferChecks.checkFunctionAddress(function_pointer);
        GL20.nglVertexAttrib4s(index, x, y, z, w, function_pointer);
    }
    ...
    public static void glVertexAttrib4f(int index, float x, float y, float z, float w) {
        ...
        BufferChecks.checkFunctionAddress(function_pointer);
        GL20.nglVertexAttrib4f(index, x, y, z, w, function_pointer);
    }
    ...
    public static void glVertexAttrib4d(int index, double x, double y, double z, double w) {
        ...
        BufferChecks.checkFunctionAddress(function_pointer);
        GL20.nglVertexAttrib4d(index, x, y, z, w, function_pointer);
    }
    ...
    public static void glVertexAttrib4Nub(int index, byte x, byte y, byte z, byte w) {
        ...
        BufferChecks.checkFunctionAddress(function_pointer);
        GL20.nglVertexAttrib4Nub(index, x, y, z, w, function_pointer);
    }
    ...
    public static void glVertexAttribPointer(int index, int size, boolean normalized, int stride, DoubleBuffer buffer) {
        ...
        GL20.nglVertexAttribPointer(index, size, 5130, normalized, stride, MemoryUtil.getAddress(buffer), function_pointer);
    }
    ...
    public static void glVertexAttribPointer(int index, int size, boolean unsigned, boolean normalized, int stride, IntBuffer buffer) {
        ...
        GL20.nglVertexAttribPointer(index, size, unsigned ? 5125 : 5124, normalized, stride, MemoryUtil.getAddress(buffer), function_pointer);
    }
    ...
    public static void glGetVertexAttrib(int index, int pname, FloatBuffer params) {
        ...
        GL20.nglGetVertexAttribfv(index, pname, MemoryUtil.getAddress(params), function_pointer);
    }
    ...
    public static void glGetVertexAttrib(int index, int pname, DoubleBuffer params) {
        ...
        BufferChecks.checkFunctionAddress(function_pointer);
        BufferChecks.checkBuffer(params, 4);
        GL20.nglGetVertexAttribdv(index, pname, MemoryUtil.getAddress(params), function_pointer);
    }
    ...
    public static void glGetVertexAttrib(int index, int pname, IntBuffer params) {
        ...
        BufferChecks.checkFunctionAddress(function_pointer);
        BufferChecks.checkBuffer(params, 4);
        GL20.nglGetVertexAttribiv(index, pname, MemoryUtil.getAddress(params), function_pointer);
    }
    ...
    public static void glGetVertexAttribPointer(int index, int pname, ByteBuffer pointer) {
        ...
        GL20.nglGetVertexAttribPointerv2(index, pname, MemoryUtil.getAddress(pointer), function_pointer);
    }
    ...
    public static void glBindAttribLocation(int program, int index, ByteBuffer name) {
        ...
        BufferChecks.checkDirect(name);
        BufferChecks.checkNullTerminated(name);
        GL20.nglBindAttribLocation(program, index, MemoryUtil.getAddress(name), function_pointer);
    }
    ...
    public static void glBindAttribLocation(int program, int index, CharSequence name) {
        ...
        long function_pointer = caps.glBindAttribLocation;
        BufferChecks.checkFunctionAddress(function_pointer);
        GL20.nglBindAttribLocation(program, index, APIUtil.getBufferNT(caps, name), function_pointer);
    }
    ...
    public static void glGetActiveAttrib(int program, int index, IntBuffer length, IntBuffer size, IntBuffer type, ByteBuffer name) {
        ...
        BufferChecks.checkBuffer(type, 1);
        BufferChecks.checkDirect(name);
        GL20.nglGetActiveAttrib(program, index, name.remaining(), MemoryUtil.getAddressSafe(length), MemoryUtil.getAddress(size), MemoryUtil.getAddress(type), MemoryUtil.getAddress(name), function_pointer);
    }
    ...
    public static String glGetActiveAttrib(int program, int index, int maxLength) {
        ...
        IntBuffer name_length = APIUtil.getLengths(caps);
        ByteBuffer name = APIUtil.getBufferByte(caps, maxLength);
        GL20.nglGetActiveAttrib(program, index, maxLength, MemoryUtil.getAddress0(name_length), MemoryUtil.getAddress0(APIUtil.getBufferInt(caps)), MemoryUtil.getAddress(APIUtil.getBufferInt(caps), 1), MemoryUtil.getAddress(name), function_pointer);
        name.limit(name_length.get(0));
        return APIUtil.getString(caps, name);
    }
    ...
    public static int glGetActiveAttribSize(int program, int index) {
        ...
        BufferChecks.checkFunctionAddress(function_pointer);
        IntBuffer size = APIUtil.getBufferInt(caps);
        GL20.nglGetActiveAttrib(program, index, 0, 0, MemoryUtil.getAddress(size), MemoryUtil.getAddress(size, 1), APIUtil.getBufferByte0(caps), function_pointer);
        return size.get(0);
    }
    ...
    public static int glGetActiveAttribType(int program, int index) {
        ...
        BufferChecks.checkFunctionAddress(function_pointer);
        IntBuffer type = APIUtil.getBufferInt(caps);
        GL20.nglGetActiveAttrib(program, index, 0, 0, MemoryUtil.getAddress(type, 1), MemoryUtil.getAddress(type), APIUtil.getBufferByte0(caps), function_pointer);
        return type.get(0);
    }
    ...
    public static int glGetAttribLocation(int program, ByteBuffer name) {
        ...
        BufferChecks.checkDirect(name);
        BufferChecks.checkNullTerminated(name);
        int __result = GL20.nglGetAttribLocation(program, MemoryUtil.getAddress(name), function_pointer);
        return __result;
    }
    ...
    public static void glDrawBuffers(IntBuffer buffers) {
        ...
        GL20.nglDrawBuffers(buffers.remaining(), MemoryUtil.getAddress(buffers), function_pointer);
    }
    ...
    public static void glDrawBuffers(int buffer) {
        ...
        long function_pointer = caps.glDrawBuffers;
        BufferChecks.checkFunctionAddress(function_pointer);
        GL20.nglDrawBuffers(1, APIUtil.getInt(caps, buffer), function_pointer);
    }
