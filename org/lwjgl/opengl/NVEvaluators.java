...
public final class NVEvaluators {
    ...
    public static void glGetMapControlPointsNV(int target, int index, int type, int ustride, int vstride, boolean packed, FloatBuffer pPoints) {
        ...
        NVEvaluators.nglGetMapControlPointsNV(target, index, type, ustride, vstride, packed, MemoryUtil.getAddress(pPoints), function_pointer);
    }
    ...
    public static void glMapControlPointsNV(int target, int index, int type, int ustride, int vstride, int uorder, int vorder, boolean packed, FloatBuffer pPoints) {
        ...
        BufferChecks.checkFunctionAddress(function_pointer);
        BufferChecks.checkDirect(pPoints);
        NVEvaluators.nglMapControlPointsNV(target, index, type, ustride, vstride, uorder, vorder, packed, MemoryUtil.getAddress(pPoints), function_pointer);
    }
    ...
    public static void glMapParameterNV(int target, int pname, FloatBuffer params) {
        ...
        NVEvaluators.nglMapParameterfvNV(target, pname, MemoryUtil.getAddress(params), function_pointer);
    }
    ...
    public static void glMapParameterNV(int target, int pname, IntBuffer params) {
        ...
        BufferChecks.checkFunctionAddress(function_pointer);
        BufferChecks.checkBuffer(params, 4);
        NVEvaluators.nglMapParameterivNV(target, pname, MemoryUtil.getAddress(params), function_pointer);
    }
    ...
    public static void glGetMapParameterNV(int target, int pname, FloatBuffer params) {
        ...
        BufferChecks.checkFunctionAddress(function_pointer);
        BufferChecks.checkBuffer(params, 4);
        NVEvaluators.nglGetMapParameterfvNV(target, pname, MemoryUtil.getAddress(params), function_pointer);
    }
    ...
    public static void glGetMapParameterNV(int target, int pname, IntBuffer params) {
        ...
        BufferChecks.checkFunctionAddress(function_pointer);
        BufferChecks.checkBuffer(params, 4);
        NVEvaluators.nglGetMapParameterivNV(target, pname, MemoryUtil.getAddress(params), function_pointer);
    }
    ...
    public static void glGetMapAttribParameterNV(int target, int index, int pname, FloatBuffer params) {
        ...
        BufferChecks.checkFunctionAddress(function_pointer);
        BufferChecks.checkBuffer(params, 4);
        NVEvaluators.nglGetMapAttribParameterfvNV(target, index, pname, MemoryUtil.getAddress(params), function_pointer);
    }
    ...
    public static void glGetMapAttribParameterNV(int target, int index, int pname, IntBuffer params) {
        ...
        BufferChecks.checkFunctionAddress(function_pointer);
        BufferChecks.checkBuffer(params, 4);
        NVEvaluators.nglGetMapAttribParameterivNV(target, index, pname, MemoryUtil.getAddress(params), function_pointer);
    }
