...
public final class EXTGpuShader4 {
    ...
    public static void glVertexAttribI1iEXT(int index, int x) {
        ...
        EXTGpuShader4.nglVertexAttribI1iEXT(index, x, function_pointer);
    }
    ...
    public static void glVertexAttribI2iEXT(int index, int x, int y) {
        ...
        BufferChecks.checkFunctionAddress(function_pointer);
        EXTGpuShader4.nglVertexAttribI2iEXT(index, x, y, function_pointer);
    }
    ...
    public static void glVertexAttribI3iEXT(int index, int x, int y, int z) {
        ...
        BufferChecks.checkFunctionAddress(function_pointer);
        EXTGpuShader4.nglVertexAttribI3iEXT(index, x, y, z, function_pointer);
    }
    ...
    public static void glVertexAttribI4iEXT(int index, int x, int y, int z, int w) {
        ...
        BufferChecks.checkFunctionAddress(function_pointer);
        EXTGpuShader4.nglVertexAttribI4iEXT(index, x, y, z, w, function_pointer);
    }
    ...
    public static void glVertexAttribI1uiEXT(int index, int x) {
        ...
        BufferChecks.checkFunctionAddress(function_pointer);
        EXTGpuShader4.nglVertexAttribI1uiEXT(index, x, function_pointer);
    }
    ...
    public static void glVertexAttribI2uiEXT(int index, int x, int y) {
        ...
        BufferChecks.checkFunctionAddress(function_pointer);
        EXTGpuShader4.nglVertexAttribI2uiEXT(index, x, y, function_pointer);
    }
    ...
    public static void glVertexAttribI3uiEXT(int index, int x, int y, int z) {
        ...
        BufferChecks.checkFunctionAddress(function_pointer);
        EXTGpuShader4.nglVertexAttribI3uiEXT(index, x, y, z, function_pointer);
    }
    ...
    public static void glVertexAttribI4uiEXT(int index, int x, int y, int z, int w) {
        ...
        BufferChecks.checkFunctionAddress(function_pointer);
        EXTGpuShader4.nglVertexAttribI4uiEXT(index, x, y, z, w, function_pointer);
    }
    ...
    public static void glVertexAttribI1EXT(int index, IntBuffer v) {
        ...
        EXTGpuShader4.nglVertexAttribI1ivEXT(index, MemoryUtil.getAddress(v), function_pointer);
    }
    ...
    public static void glVertexAttribI2EXT(int index, IntBuffer v) {
        ...
        EXTGpuShader4.nglVertexAttribI2ivEXT(index, MemoryUtil.getAddress(v), function_pointer);
    }
    ...
    public static void glVertexAttribI3EXT(int index, IntBuffer v) {
        ...
        EXTGpuShader4.nglVertexAttribI3ivEXT(index, MemoryUtil.getAddress(v), function_pointer);
    }
    ...
    public static void glVertexAttribI4EXT(int index, IntBuffer v) {
        ...
        EXTGpuShader4.nglVertexAttribI4ivEXT(index, MemoryUtil.getAddress(v), function_pointer);
    }
    ...
    public static void glVertexAttribI1uEXT(int index, IntBuffer v) {
        ...
        BufferChecks.checkFunctionAddress(function_pointer);
        BufferChecks.checkBuffer(v, 1);
        EXTGpuShader4.nglVertexAttribI1uivEXT(index, MemoryUtil.getAddress(v), function_pointer);
    }
    ...
    public static void glVertexAttribI2uEXT(int index, IntBuffer v) {
        ...
        BufferChecks.checkFunctionAddress(function_pointer);
        BufferChecks.checkBuffer(v, 2);
        EXTGpuShader4.nglVertexAttribI2uivEXT(index, MemoryUtil.getAddress(v), function_pointer);
    }
    ...
    public static void glVertexAttribI3uEXT(int index, IntBuffer v) {
        ...
        BufferChecks.checkFunctionAddress(function_pointer);
        BufferChecks.checkBuffer(v, 3);
        EXTGpuShader4.nglVertexAttribI3uivEXT(index, MemoryUtil.getAddress(v), function_pointer);
    }
    ...
    public static void glVertexAttribI4uEXT(int index, IntBuffer v) {
        ...
        BufferChecks.checkFunctionAddress(function_pointer);
        BufferChecks.checkBuffer(v, 4);
        EXTGpuShader4.nglVertexAttribI4uivEXT(index, MemoryUtil.getAddress(v), function_pointer);
    }
    ...
    public static void glVertexAttribI4EXT(int index, ByteBuffer v) {
        ...
        BufferChecks.checkFunctionAddress(function_pointer);
        BufferChecks.checkBuffer(v, 4);
        EXTGpuShader4.nglVertexAttribI4bvEXT(index, MemoryUtil.getAddress(v), function_pointer);
    }
    ...
    public static void glVertexAttribI4EXT(int index, ShortBuffer v) {
        ...
        BufferChecks.checkFunctionAddress(function_pointer);
        BufferChecks.checkBuffer(v, 4);
        EXTGpuShader4.nglVertexAttribI4svEXT(index, MemoryUtil.getAddress(v), function_pointer);
    }
    ...
    public static void glVertexAttribI4uEXT(int index, ByteBuffer v) {
        ...
        BufferChecks.checkFunctionAddress(function_pointer);
        BufferChecks.checkBuffer(v, 4);
        EXTGpuShader4.nglVertexAttribI4ubvEXT(index, MemoryUtil.getAddress(v), function_pointer);
    }
    ...
    public static void glVertexAttribI4uEXT(int index, ShortBuffer v) {
        ...
        BufferChecks.checkFunctionAddress(function_pointer);
        BufferChecks.checkBuffer(v, 4);
        EXTGpuShader4.nglVertexAttribI4usvEXT(index, MemoryUtil.getAddress(v), function_pointer);
    }
    ...
    public static void glVertexAttribIPointerEXT(int index, int size, int type, int stride, ByteBuffer buffer) {
        ...
        EXTGpuShader4.nglVertexAttribIPointerEXT(index, size, type, stride, MemoryUtil.getAddress(buffer), function_pointer);
    }
    ...
    public static void glGetVertexAttribIEXT(int index, int pname, IntBuffer params) {
        ...
        EXTGpuShader4.nglGetVertexAttribIivEXT(index, pname, MemoryUtil.getAddress(params), function_pointer);
    }
    ...
    public static void glGetVertexAttribIuEXT(int index, int pname, IntBuffer params) {
        ...
        BufferChecks.checkFunctionAddress(function_pointer);
        BufferChecks.checkBuffer(params, 4);
        EXTGpuShader4.nglGetVertexAttribIuivEXT(index, pname, MemoryUtil.getAddress(params), function_pointer);
    }
    ...
    public static void glUniform1uEXT(int location, IntBuffer value) {
        ...
        EXTGpuShader4.nglUniform1uivEXT(location, value.remaining(), MemoryUtil.getAddress(value), function_pointer);
    }
    ...
    public static void glUniform2uEXT(int location, IntBuffer value) {
        ...
        BufferChecks.checkFunctionAddress(function_pointer);
        BufferChecks.checkDirect(value);
        EXTGpuShader4.nglUniform2uivEXT(location, value.remaining() >> 1, MemoryUtil.getAddress(value), function_pointer);
    }
    ...
    public static void glUniform3uEXT(int location, IntBuffer value) {
        ...
        BufferChecks.checkFunctionAddress(function_pointer);
        BufferChecks.checkDirect(value);
        EXTGpuShader4.nglUniform3uivEXT(location, value.remaining() / 3, MemoryUtil.getAddress(value), function_pointer);
    }
    ...
    public static void glUniform4uEXT(int location, IntBuffer value) {
        ...
        BufferChecks.checkFunctionAddress(function_pointer);
        BufferChecks.checkDirect(value);
        EXTGpuShader4.nglUniform4uivEXT(location, value.remaining() >> 2, MemoryUtil.getAddress(value), function_pointer);
    }
    ...
    public static void glGetUniformuEXT(int program, int location, IntBuffer params) {
        ...
        EXTGpuShader4.nglGetUniformuivEXT(program, location, MemoryUtil.getAddress(params), function_pointer);
    }
    ...
    public static void glBindFragDataLocationEXT(int program, int colorNumber, ByteBuffer name) {
        ...
        EXTGpuShader4.nglBindFragDataLocationEXT(program, colorNumber, MemoryUtil.getAddress(name), function_pointer);
    }
    ...
    public static void glBindFragDataLocationEXT(int program, int colorNumber, CharSequence name) {
        ...
        long function_pointer = caps.glBindFragDataLocationEXT;
        BufferChecks.checkFunctionAddress(function_pointer);
        EXTGpuShader4.nglBindFragDataLocationEXT(program, colorNumber, APIUtil.getBufferNT(caps, name), function_pointer);
    }
    ...
    public static int glGetFragDataLocationEXT(int program, ByteBuffer name) {
        ...
        BufferChecks.checkDirect(name);
        BufferChecks.checkNullTerminated(name);
        int __result = EXTGpuShader4.nglGetFragDataLocationEXT(program, MemoryUtil.getAddress(name), function_pointer);
        return __result;
    }
    ...
    public static int glGetFragDataLocationEXT(int program, CharSequence name) {
        ...
        long function_pointer = caps.glGetFragDataLocationEXT;
        BufferChecks.checkFunctionAddress(function_pointer);
        int __result = EXTGpuShader4.nglGetFragDataLocationEXT(program, APIUtil.getBufferNT(caps, name), function_pointer);
        return __result;
    }
}
