...
public final class APPLEFence {
    ...
    public static void glGenFencesAPPLE(IntBuffer fences) {
        ...
        APPLEFence.nglGenFencesAPPLE(fences.remaining(), MemoryUtil.getAddress(fences), function_pointer);
    }
    ...
    public static int glGenFencesAPPLE() {
        ...
        APPLEFence.nglGenFencesAPPLE(1, MemoryUtil.getAddress(fences), function_pointer);
        return fences.get(0);
    }
    ...
    public static void glDeleteFencesAPPLE(IntBuffer fences) {
        ...
        BufferChecks.checkFunctionAddress(function_pointer);
        BufferChecks.checkDirect(fences);
        APPLEFence.nglDeleteFencesAPPLE(fences.remaining(), MemoryUtil.getAddress(fences), function_pointer);
    }
    ...
    public static void glDeleteFencesAPPLE(int fence) {
        ...
        long function_pointer = caps.glDeleteFencesAPPLE;
        BufferChecks.checkFunctionAddress(function_pointer);
        APPLEFence.nglDeleteFencesAPPLE(1, APIUtil.getInt(caps, fence), function_pointer);
    }
