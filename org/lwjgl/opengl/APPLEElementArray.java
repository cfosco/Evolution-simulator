...
public final class APPLEElementArray {
    ...
    public static void glElementPointerAPPLE(ByteBuffer pointer) {
        ...
        APPLEElementArray.nglElementPointerAPPLE(5121, MemoryUtil.getAddress(pointer), function_pointer);
    }
    ...
    public static void glElementPointerAPPLE(IntBuffer pointer) {
        ...
        BufferChecks.checkFunctionAddress(function_pointer);
        BufferChecks.checkDirect(pointer);
        APPLEElementArray.nglElementPointerAPPLE(5125, MemoryUtil.getAddress(pointer), function_pointer);
    }
    ...
    public static void glElementPointerAPPLE(ShortBuffer pointer) {
        ...
        BufferChecks.checkFunctionAddress(function_pointer);
        BufferChecks.checkDirect(pointer);
        APPLEElementArray.nglElementPointerAPPLE(5123, MemoryUtil.getAddress(pointer), function_pointer);
    }
    ...
    public static void glMultiDrawElementArrayAPPLE(int mode, IntBuffer first, IntBuffer count) {
        ...
        APPLEElementArray.nglMultiDrawElementArrayAPPLE(mode, MemoryUtil.getAddress(first), MemoryUtil.getAddress(count), first.remaining(), function_pointer);
    }
    ...
    public static void glMultiDrawRangeElementArrayAPPLE(int mode, int start, int end, IntBuffer first, IntBuffer count) {
        ...
        BufferChecks.checkDirect(first);
        BufferChecks.checkBuffer(count, first.remaining());
        APPLEElementArray.nglMultiDrawRangeElementArrayAPPLE(mode, start, end, MemoryUtil.getAddress(first), MemoryUtil.getAddress(count), first.remaining(), function_pointer);
    }
