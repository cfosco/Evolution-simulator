...
extends MacOSXPeerInfo {
    ...
    private static void reSetLayerBounds(Canvas component, ByteBuffer peer_info_handle) {
        ...
        insets = MacOSXCanvasPeerInfo.getInsets(component);
        MacOSXCanvasPeerInfo.nSetLayerBounds(peer_info_handle, x -= insets != null ? insets.left : 0, y, component.getWidth(), component.getHeight());
    }
    ...
    private static Insets getInsets(Canvas component) {
        JRootPane c = SwingUtilities.getRootPane(component);
        if (c != null) {
            return c.getInsets();
        }
