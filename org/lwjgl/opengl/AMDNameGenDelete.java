...
public final class AMDNameGenDelete {
    ...
    public static void glGenNamesAMD(int identifier, IntBuffer names) {
        ...
        AMDNameGenDelete.nglGenNamesAMD(identifier, names.remaining(), MemoryUtil.getAddress(names), function_pointer);
    }
    ...
    public static int glGenNamesAMD(int identifier) {
        ...
        AMDNameGenDelete.nglGenNamesAMD(identifier, 1, MemoryUtil.getAddress(names), function_pointer);
        return names.get(0);
    }
    ...
    public static void glDeleteNamesAMD(int identifier, IntBuffer names) {
        ...
        BufferChecks.checkFunctionAddress(function_pointer);
        BufferChecks.checkDirect(names);
        AMDNameGenDelete.nglDeleteNamesAMD(identifier, names.remaining(), MemoryUtil.getAddress(names), function_pointer);
    }
    ...
    public static void glDeleteNamesAMD(int identifier, int name) {
        ...
        long function_pointer = caps.glDeleteNamesAMD;
        BufferChecks.checkFunctionAddress(function_pointer);
        AMDNameGenDelete.nglDeleteNamesAMD(identifier, 1, APIUtil.getInt(caps, name), function_pointer);
    }
