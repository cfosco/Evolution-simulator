...
public final class EXTDrawInstanced {
    ...
    public static void glDrawElementsInstancedEXT(int mode, ByteBuffer indices, int primcount) {
        ...
        EXTDrawInstanced.nglDrawElementsInstancedEXT(mode, indices.remaining(), 5121, MemoryUtil.getAddress(indices), primcount, function_pointer);
    }
    ...
    public static void glDrawElementsInstancedEXT(int mode, IntBuffer indices, int primcount) {
        ...
        GLChecks.ensureElementVBOdisabled(caps);
        BufferChecks.checkDirect(indices);
        EXTDrawInstanced.nglDrawElementsInstancedEXT(mode, indices.remaining(), 5125, MemoryUtil.getAddress(indices), primcount, function_pointer);
    }
    ...
    public static void glDrawElementsInstancedEXT(int mode, ShortBuffer indices, int primcount) {
        ...
        GLChecks.ensureElementVBOdisabled(caps);
        BufferChecks.checkDirect(indices);
        EXTDrawInstanced.nglDrawElementsInstancedEXT(mode, indices.remaining(), 5123, MemoryUtil.getAddress(indices), primcount, function_pointer);
    }
    ...
    public static void glDrawElementsInstancedEXT(int mode, int indices_count, int type, long indices_buffer_offset, int primcount) {
        ...
        EXTDrawInstanced.nglDrawElementsInstancedEXTBO(mode, indices_count, type, indices_buffer_offset, primcount, function_pointer);
    }
