...
public final class EXTFogCoord {
    ...
    public static void glFogCoordPointerEXT(int stride, DoubleBuffer data) {
        ...
        if (LWJGLUtil.CHECKS) {
            StateTracker.getReferences((ContextCapabilities)caps).EXT_fog_coord_glFogCoordPointerEXT_data = data;
        }
        EXTFogCoord.nglFogCoordPointerEXT(5130, stride, MemoryUtil.getAddress(data), function_pointer);
    }
    ...
    public static void glFogCoordPointerEXT(int stride, FloatBuffer data) {
        ...
        EXTFogCoord.nglFogCoordPointerEXT(5126, stride, MemoryUtil.getAddress(data), function_pointer);
    }
