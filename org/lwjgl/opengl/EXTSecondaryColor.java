...
public final class EXTSecondaryColor {
    ...
    public static void glSecondaryColorPointerEXT(int size, int stride, DoubleBuffer pPointer) {
        ...
        if (LWJGLUtil.CHECKS) {
            StateTracker.getReferences((ContextCapabilities)caps).EXT_secondary_color_glSecondaryColorPointerEXT_pPointer = pPointer;
        }
        EXTSecondaryColor.nglSecondaryColorPointerEXT(size, 5130, stride, MemoryUtil.getAddress(pPointer), function_pointer);
    }
    ...
    public static void glSecondaryColorPointerEXT(int size, int stride, FloatBuffer pPointer) {
        ...
        EXTSecondaryColor.nglSecondaryColorPointerEXT(size, 5126, stride, MemoryUtil.getAddress(pPointer), function_pointer);
    }
    ...
    public static void glSecondaryColorPointerEXT(int size, boolean unsigned, int stride, ByteBuffer pPointer) {
        ...
        EXTSecondaryColor.nglSecondaryColorPointerEXT(size, unsigned ? 5121 : 5120, stride, MemoryUtil.getAddress(pPointer), function_pointer);
    }
