...
MouseWheelListener {
    ...
    private void handleButton(MouseEvent e) {
        ...
        this.setButton(button, state, e.getWhen() * 1000000);
    }
    ...
    private void handleMotion(MouseEvent e) {
        if (this.grabbed) {
            this.updateDeltas(e.getWhen() * 1000000);
        } else {
            this.setCursorPos(e.getX(), e.getY(), e.getWhen() * 1000000);
        }
    }
    ...
    private void handleWheel(int amount, long nanos) {
        ...
        this.putMouseEvent(-1, 0, amount, nanos);
    }
    ...
    public synchronized void mouseWheelMoved(MouseWheelEvent e) {
        ...
        this.handleWheel(wheel_amount, e.getWhen() * 1000000);
    }
}
