...
public final class ARBVertexShader {
    ...
    public static void glVertexAttrib4NubARB(int index, byte x, byte y, byte z, byte w) {
        ...
        BufferChecks.checkFunctionAddress(function_pointer);
        ARBVertexShader.nglVertexAttrib4NubARB(index, x, y, z, w, function_pointer);
    }
    ...
    public static void glVertexAttribPointerARB(int index, int size, boolean normalized, int stride, DoubleBuffer buffer) {
        ...
        ARBVertexShader.nglVertexAttribPointerARB(index, size, 5130, normalized, stride, MemoryUtil.getAddress(buffer), function_pointer);
    }
    ...
    public static void glVertexAttribPointerARB(int index, int size, boolean normalized, int stride, FloatBuffer buffer) {
        ...
        ARBVertexShader.nglVertexAttribPointerARB(index, size, 5126, normalized, stride, MemoryUtil.getAddress(buffer), function_pointer);
    }
    ...
    public static void glVertexAttribPointerARB(int index, int size, boolean unsigned, boolean normalized, int stride, ByteBuffer buffer) {
        ...
        ARBVertexShader.nglVertexAttribPointerARB(index, size, unsigned ? 5121 : 5120, normalized, stride, MemoryUtil.getAddress(buffer), function_pointer);
    }
    ...
    public static void glVertexAttribPointerARB(int index, int size, boolean unsigned, boolean normalized, int stride, IntBuffer buffer) {
        ...
        ARBVertexShader.nglVertexAttribPointerARB(index, size, unsigned ? 5125 : 5124, normalized, stride, MemoryUtil.getAddress(buffer), function_pointer);
    }
    ...
    public static void glVertexAttribPointerARB(int index, int size, boolean unsigned, boolean normalized, int stride, ShortBuffer buffer) {
        ...
        ARBVertexShader.nglVertexAttribPointerARB(index, size, unsigned ? 5123 : 5122, normalized, stride, MemoryUtil.getAddress(buffer), function_pointer);
    }
    ...
    public static void glVertexAttribPointerARB(int index, int size, int type, boolean normalized, int stride, ByteBuffer buffer) {
        ...
        ARBVertexShader.nglVertexAttribPointerARB(index, size, type, normalized, stride, MemoryUtil.getAddress(buffer), function_pointer);
    }
    ...
    public static void glBindAttribLocationARB(int programObj, int index, ByteBuffer name) {
        ...
        ARBVertexShader.nglBindAttribLocationARB(programObj, index, MemoryUtil.getAddress(name), function_pointer);
    }
    ...
    public static void glBindAttribLocationARB(int programObj, int index, CharSequence name) {
        ...
        long function_pointer = caps.glBindAttribLocationARB;
        BufferChecks.checkFunctionAddress(function_pointer);
        ARBVertexShader.nglBindAttribLocationARB(programObj, index, APIUtil.getBufferNT(caps, name), function_pointer);
    }
    ...
    public static void glGetActiveAttribARB(int programObj, int index, IntBuffer length, IntBuffer size, IntBuffer type, ByteBuffer name) {
        ...
        BufferChecks.checkDirect(name);
        ARBVertexShader.nglGetActiveAttribARB(programObj, index, name.remaining(), MemoryUtil.getAddressSafe(length), MemoryUtil.getAddress(size), MemoryUtil.getAddress(type), MemoryUtil.getAddress(name), function_pointer);
    }
    ...
    public static String glGetActiveAttribARB(int programObj, int index, int maxLength, IntBuffer sizeType) {
        ...
        ARBVertexShader.nglGetActiveAttribARB(programObj, index, maxLength, MemoryUtil.getAddress0(name_length), MemoryUtil.getAddress(sizeType), MemoryUtil.getAddress(sizeType, sizeType.position() + 1), MemoryUtil.getAddress(name), function_pointer);
    ...
    public static String glGetActiveAttribARB(int programObj, int index, int maxLength) {
        ...
        IntBuffer name_length = APIUtil.getLengths(caps);
        ByteBuffer name = APIUtil.getBufferByte(caps, maxLength);
        ARBVertexShader.nglGetActiveAttribARB(programObj, index, maxLength, MemoryUtil.getAddress0(name_length), MemoryUtil.getAddress0(APIUtil.getBufferInt(caps)), MemoryUtil.getAddress(APIUtil.getBufferInt(caps), 1), MemoryUtil.getAddress(name), function_pointer);
        name.limit(name_length.get(0));
        return APIUtil.getString(caps, name);
    }
    ...
    public static int glGetActiveAttribSizeARB(int programObj, int index) {
        ...
        ARBVertexShader.nglGetActiveAttribARB(programObj, index, 0, 0, MemoryUtil.getAddress(size), MemoryUtil.getAddress(size, 1), APIUtil.getBufferByte0(caps), function_pointer);
        return size.get(0);
    }
    ...
    public static int glGetActiveAttribTypeARB(int programObj, int index) {
        ...
        ARBVertexShader.nglGetActiveAttribARB(programObj, index, 0, 0, MemoryUtil.getAddress(type, 1), MemoryUtil.getAddress(type), APIUtil.getBufferByte0(caps), function_pointer);
        return type.get(0);
    }
    ...
    public static int glGetAttribLocationARB(int programObj, ByteBuffer name) {
        ...
        BufferChecks.checkDirect(name);
        BufferChecks.checkNullTerminated(name);
        int __result = ARBVertexShader.nglGetAttribLocationARB(programObj, MemoryUtil.getAddress(name), function_pointer);
        return __result;
    }
    ...
    public static int glGetAttribLocationARB(int programObj, CharSequence name) {
        ...
        long function_pointer = caps.glGetAttribLocationARB;
        BufferChecks.checkFunctionAddress(function_pointer);
        int __result = ARBVertexShader.nglGetAttribLocationARB(programObj, APIUtil.getBufferNT(caps, name), function_pointer);
        return __result;
    }
    ...
    public static void glGetVertexAttribARB(int index, int pname, FloatBuffer params) {
        ...
        ARBVertexShader.nglGetVertexAttribfvARB(index, pname, MemoryUtil.getAddress(params), function_pointer);
    }
    ...
    public static void glGetVertexAttribARB(int index, int pname, DoubleBuffer params) {
        ...
        BufferChecks.checkFunctionAddress(function_pointer);
        BufferChecks.checkBuffer(params, 4);
        ARBVertexShader.nglGetVertexAttribdvARB(index, pname, MemoryUtil.getAddress(params), function_pointer);
    }
    ...
    public static void glGetVertexAttribARB(int index, int pname, IntBuffer params) {
        ...
        BufferChecks.checkFunctionAddress(function_pointer);
        BufferChecks.checkBuffer(params, 4);
        ARBVertexShader.nglGetVertexAttribivARB(index, pname, MemoryUtil.getAddress(params), function_pointer);
    }
