...
public final class ARBShaderObjects {
    ...
    public static void glShaderSourceARB(int shader, ByteBuffer string) {
        ...
        ARBShaderObjects.nglShaderSourceARB(shader, 1, MemoryUtil.getAddress(string), string.remaining(), function_pointer);
    }
    ...
    public static void glShaderSourceARB(int shader, CharSequence string) {
        ...
        long function_pointer = caps.glShaderSourceARB;
        BufferChecks.checkFunctionAddress(function_pointer);
        ARBShaderObjects.nglShaderSourceARB(shader, 1, APIUtil.getBuffer(caps, string), string.length(), function_pointer);
    }
    ...
    public static void glShaderSourceARB(int shader, CharSequence[] strings) {
        ...
        ARBShaderObjects.nglShaderSourceARB3(shader, strings.length, APIUtil.getBuffer(caps, strings), APIUtil.getLengths(caps, strings), function_pointer);
    }
    ...
    public static void glUniform1ARB(int location, FloatBuffer values) {
        ...
        ARBShaderObjects.nglUniform1fvARB(location, values.remaining(), MemoryUtil.getAddress(values), function_pointer);
    }
    ...
    public static void glUniform2ARB(int location, FloatBuffer values) {
        ...
        BufferChecks.checkFunctionAddress(function_pointer);
        BufferChecks.checkDirect(values);
        ARBShaderObjects.nglUniform2fvARB(location, values.remaining() >> 1, MemoryUtil.getAddress(values), function_pointer);
    }
    ...
    public static void glUniform3ARB(int location, FloatBuffer values) {
        ...
        BufferChecks.checkFunctionAddress(function_pointer);
        BufferChecks.checkDirect(values);
        ARBShaderObjects.nglUniform3fvARB(location, values.remaining() / 3, MemoryUtil.getAddress(values), function_pointer);
    }
    ...
    public static void glUniform4ARB(int location, FloatBuffer values) {
        ...
        BufferChecks.checkFunctionAddress(function_pointer);
        BufferChecks.checkDirect(values);
        ARBShaderObjects.nglUniform4fvARB(location, values.remaining() >> 2, MemoryUtil.getAddress(values), function_pointer);
    }
    ...
    public static void glUniform1ARB(int location, IntBuffer values) {
        ...
        BufferChecks.checkFunctionAddress(function_pointer);
        BufferChecks.checkDirect(values);
        ARBShaderObjects.nglUniform1ivARB(location, values.remaining(), MemoryUtil.getAddress(values), function_pointer);
    }
    ...
    public static void glUniform2ARB(int location, IntBuffer values) {
        ...
        BufferChecks.checkFunctionAddress(function_pointer);
        BufferChecks.checkDirect(values);
        ARBShaderObjects.nglUniform2ivARB(location, values.remaining() >> 1, MemoryUtil.getAddress(values), function_pointer);
    }
    ...
    public static void glUniform3ARB(int location, IntBuffer values) {
        ...
        BufferChecks.checkFunctionAddress(function_pointer);
        BufferChecks.checkDirect(values);
        ARBShaderObjects.nglUniform3ivARB(location, values.remaining() / 3, MemoryUtil.getAddress(values), function_pointer);
    }
    ...
    public static void glUniform4ARB(int location, IntBuffer values) {
        ...
        BufferChecks.checkFunctionAddress(function_pointer);
        BufferChecks.checkDirect(values);
        ARBShaderObjects.nglUniform4ivARB(location, values.remaining() >> 2, MemoryUtil.getAddress(values), function_pointer);
    }
    ...
    public static void glUniformMatrix2ARB(int location, boolean transpose, FloatBuffer matrices) {
        ...
        ARBShaderObjects.nglUniformMatrix2fvARB(location, matrices.remaining() >> 2, transpose, MemoryUtil.getAddress(matrices), function_pointer);
    }
    ...
    public static void glUniformMatrix3ARB(int location, boolean transpose, FloatBuffer matrices) {
        ...
        BufferChecks.checkFunctionAddress(function_pointer);
        BufferChecks.checkDirect(matrices);
        ARBShaderObjects.nglUniformMatrix3fvARB(location, matrices.remaining() / 9, transpose, MemoryUtil.getAddress(matrices), function_pointer);
    }
    ...
    public static void glUniformMatrix4ARB(int location, boolean transpose, FloatBuffer matrices) {
        ...
        BufferChecks.checkFunctionAddress(function_pointer);
        BufferChecks.checkDirect(matrices);
        ARBShaderObjects.nglUniformMatrix4fvARB(location, matrices.remaining() >> 4, transpose, MemoryUtil.getAddress(matrices), function_pointer);
    }
    ...
    public static void glGetObjectParameterARB(int obj, int pname, FloatBuffer params) {
        ...
        ARBShaderObjects.nglGetObjectParameterfvARB(obj, pname, MemoryUtil.getAddress(params), function_pointer);
    }
    ...
    public static void glGetObjectParameterARB(int obj, int pname, IntBuffer params) {
        ...
        BufferChecks.checkFunctionAddress(function_pointer);
        BufferChecks.checkDirect(params);
        ARBShaderObjects.nglGetObjectParameterivARB(obj, pname, MemoryUtil.getAddress(params), function_pointer);
    }
    ...
    public static void glGetInfoLogARB(int obj, IntBuffer length, ByteBuffer infoLog) {
        ...
        ARBShaderObjects.nglGetInfoLogARB(obj, infoLog.remaining(), MemoryUtil.getAddressSafe(length), MemoryUtil.getAddress(infoLog), function_pointer);
    }
    ...
    public static String glGetInfoLogARB(int obj, int maxLength) {
        ...
        ARBShaderObjects.nglGetInfoLogARB(obj, maxLength, MemoryUtil.getAddress0(infoLog_length), MemoryUtil.getAddress(infoLog), function_pointer);
    ...
    public static void glGetAttachedObjectsARB(int containerObj, IntBuffer count, IntBuffer obj) {
        ...
        ARBShaderObjects.nglGetAttachedObjectsARB(containerObj, obj.remaining(), MemoryUtil.getAddressSafe(count), MemoryUtil.getAddress(obj), function_pointer);
    }
    ...
    public static int glGetUniformLocationARB(int programObj, ByteBuffer name) {
        ...
        int __result = ARBShaderObjects.nglGetUniformLocationARB(programObj, MemoryUtil.getAddress(name), function_pointer);
        return __result;
    }
    ...
    public static int glGetUniformLocationARB(int programObj, CharSequence name) {
        ...
        long function_pointer = caps.glGetUniformLocationARB;
        BufferChecks.checkFunctionAddress(function_pointer);
        int __result = ARBShaderObjects.nglGetUniformLocationARB(programObj, APIUtil.getBufferNT(caps, name), function_pointer);
        return __result;
    }
    ...
    public static void glGetActiveUniformARB(int programObj, int index, IntBuffer length, IntBuffer size, IntBuffer type, ByteBuffer name) {
        ...
        BufferChecks.checkDirect(name);
        ARBShaderObjects.nglGetActiveUniformARB(programObj, index, name.remaining(), MemoryUtil.getAddressSafe(length), MemoryUtil.getAddress(size), MemoryUtil.getAddress(type), MemoryUtil.getAddress(name), function_pointer);
    }
    ...
    public static String glGetActiveUniformARB(int programObj, int index, int maxLength, IntBuffer sizeType) {
        ...
        ARBShaderObjects.nglGetActiveUniformARB(programObj, index, maxLength, MemoryUtil.getAddress0(name_length), MemoryUtil.getAddress(sizeType), MemoryUtil.getAddress(sizeType, sizeType.position() + 1), MemoryUtil.getAddress(name), function_pointer);
    ...
    public static String glGetActiveUniformARB(int programObj, int index, int maxLength) {
        ...
        IntBuffer name_length = APIUtil.getLengths(caps);
        ByteBuffer name = APIUtil.getBufferByte(caps, maxLength);
        ARBShaderObjects.nglGetActiveUniformARB(programObj, index, maxLength, MemoryUtil.getAddress0(name_length), MemoryUtil.getAddress0(APIUtil.getBufferInt(caps)), MemoryUtil.getAddress(APIUtil.getBufferInt(caps), 1), MemoryUtil.getAddress(name), function_pointer);
        name.limit(name_length.get(0));
        return APIUtil.getString(caps, name);
    }
    ...
    public static int glGetActiveUniformSizeARB(int programObj, int index) {
        ...
        ARBShaderObjects.nglGetActiveUniformARB(programObj, index, 0, 0, MemoryUtil.getAddress(size), MemoryUtil.getAddress(size, 1), APIUtil.getBufferByte0(caps), function_pointer);
        return size.get(0);
    }
    ...
    public static int glGetActiveUniformTypeARB(int programObj, int index) {
        ...
        ARBShaderObjects.nglGetActiveUniformARB(programObj, index, 0, 0, MemoryUtil.getAddress(type, 1), MemoryUtil.getAddress(type), APIUtil.getBufferByte0(caps), function_pointer);
        return type.get(0);
    }
    ...
    public static void glGetUniformARB(int programObj, int location, FloatBuffer params) {
        ...
        BufferChecks.checkFunctionAddress(function_pointer);
        BufferChecks.checkDirect(params);
        ARBShaderObjects.nglGetUniformfvARB(programObj, location, MemoryUtil.getAddress(params), function_pointer);
    }
    ...
    public static void glGetUniformARB(int programObj, int location, IntBuffer params) {
        ...
        BufferChecks.checkFunctionAddress(function_pointer);
        BufferChecks.checkDirect(params);
        ARBShaderObjects.nglGetUniformivARB(programObj, location, MemoryUtil.getAddress(params), function_pointer);
    }
    ...
    public static void glGetShaderSourceARB(int obj, IntBuffer length, ByteBuffer source) {
        ...
        ARBShaderObjects.nglGetShaderSourceARB(obj, source.remaining(), MemoryUtil.getAddressSafe(length), MemoryUtil.getAddress(source), function_pointer);
    }
    ...
    public static String glGetShaderSourceARB(int obj, int maxLength) {
        ...
        ARBShaderObjects.nglGetShaderSourceARB(obj, maxLength, MemoryUtil.getAddress0(source_length), MemoryUtil.getAddress(source), function_pointer);
