...
public final class ARBFramebufferNoAttachments {
    ...
    public static void glNamedFramebufferParameteriEXT(int framebuffer, int pname, int param) {
        ...
        ARBFramebufferNoAttachments.nglNamedFramebufferParameteriEXT(framebuffer, pname, param, function_pointer);
    }
    ...
    public static void glGetNamedFramebufferParameterEXT(int framebuffer, int pname, IntBuffer params) {
        ...
        ARBFramebufferNoAttachments.nglGetNamedFramebufferParameterivEXT(framebuffer, pname, MemoryUtil.getAddress(params), function_pointer);
    }
