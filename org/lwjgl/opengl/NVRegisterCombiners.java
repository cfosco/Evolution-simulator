...
public final class NVRegisterCombiners {
    ...
    public static void glCombinerParameterfNV(int pname, float param) {
        ...
        NVRegisterCombiners.nglCombinerParameterfNV(pname, param, function_pointer);
    }
    ...
    public static void glCombinerParameterNV(int pname, FloatBuffer params) {
        ...
        NVRegisterCombiners.nglCombinerParameterfvNV(pname, MemoryUtil.getAddress(params), function_pointer);
    }
    ...
    public static void glCombinerParameteriNV(int pname, int param) {
        ...
        BufferChecks.checkFunctionAddress(function_pointer);
        NVRegisterCombiners.nglCombinerParameteriNV(pname, param, function_pointer);
    }
    ...
    public static void glCombinerParameterNV(int pname, IntBuffer params) {
        ...
        BufferChecks.checkFunctionAddress(function_pointer);
        BufferChecks.checkBuffer(params, 4);
        NVRegisterCombiners.nglCombinerParameterivNV(pname, MemoryUtil.getAddress(params), function_pointer);
    }
    ...
    public static void glCombinerInputNV(int stage, int portion, int variable, int input, int mapping, int componentUsage) {
        ...
        BufferChecks.checkFunctionAddress(function_pointer);
        NVRegisterCombiners.nglCombinerInputNV(stage, portion, variable, input, mapping, componentUsage, function_pointer);
    }
    ...
    public static void glCombinerOutputNV(int stage, int portion, int abOutput, int cdOutput, int sumOutput, int scale, int bias, boolean abDotProduct, boolean cdDotProduct, boolean muxSum) {
        ...
        BufferChecks.checkFunctionAddress(function_pointer);
        NVRegisterCombiners.nglCombinerOutputNV(stage, portion, abOutput, cdOutput, sumOutput, scale, bias, abDotProduct, cdDotProduct, muxSum, function_pointer);
    }
    ...
    public static void glFinalCombinerInputNV(int variable, int input, int mapping, int componentUsage) {
        ...
        BufferChecks.checkFunctionAddress(function_pointer);
        NVRegisterCombiners.nglFinalCombinerInputNV(variable, input, mapping, componentUsage, function_pointer);
    }
    ...
    public static void glGetCombinerInputParameterNV(int stage, int portion, int variable, int pname, FloatBuffer params) {
        ...
        BufferChecks.checkFunctionAddress(function_pointer);
        BufferChecks.checkBuffer(params, 4);
        NVRegisterCombiners.nglGetCombinerInputParameterfvNV(stage, portion, variable, pname, MemoryUtil.getAddress(params), function_pointer);
    }
    ...
    public static void glGetCombinerInputParameterNV(int stage, int portion, int variable, int pname, IntBuffer params) {
        ...
        BufferChecks.checkFunctionAddress(function_pointer);
        BufferChecks.checkBuffer(params, 4);
        NVRegisterCombiners.nglGetCombinerInputParameterivNV(stage, portion, variable, pname, MemoryUtil.getAddress(params), function_pointer);
    }
    ...
    public static void glGetCombinerOutputParameterNV(int stage, int portion, int pname, FloatBuffer params) {
        ...
        BufferChecks.checkFunctionAddress(function_pointer);
        BufferChecks.checkBuffer(params, 4);
        NVRegisterCombiners.nglGetCombinerOutputParameterfvNV(stage, portion, pname, MemoryUtil.getAddress(params), function_pointer);
    }
    ...
    public static void glGetCombinerOutputParameterNV(int stage, int portion, int pname, IntBuffer params) {
        ...
        BufferChecks.checkFunctionAddress(function_pointer);
        BufferChecks.checkBuffer(params, 4);
        NVRegisterCombiners.nglGetCombinerOutputParameterivNV(stage, portion, pname, MemoryUtil.getAddress(params), function_pointer);
    }
    ...
    public static void glGetFinalCombinerInputParameterNV(int variable, int pname, FloatBuffer params) {
        ...
        BufferChecks.checkFunctionAddress(function_pointer);
        BufferChecks.checkBuffer(params, 4);
        NVRegisterCombiners.nglGetFinalCombinerInputParameterfvNV(variable, pname, MemoryUtil.getAddress(params), function_pointer);
    }
    ...
    public static void glGetFinalCombinerInputParameterNV(int variable, int pname, IntBuffer params) {
        ...
        BufferChecks.checkFunctionAddress(function_pointer);
        BufferChecks.checkBuffer(params, 4);
        NVRegisterCombiners.nglGetFinalCombinerInputParameterivNV(variable, pname, MemoryUtil.getAddress(params), function_pointer);
    }
