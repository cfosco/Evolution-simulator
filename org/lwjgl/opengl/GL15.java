...
public final class GL15 {
    ...
    public static void glDeleteBuffers(IntBuffer buffers) {
        ...
        GL15.nglDeleteBuffers(buffers.remaining(), MemoryUtil.getAddress(buffers), function_pointer);
    }
    ...
    public static void glGenBuffers(IntBuffer buffers) {
        ...
        BufferChecks.checkFunctionAddress(function_pointer);
        BufferChecks.checkDirect(buffers);
        GL15.nglGenBuffers(buffers.remaining(), MemoryUtil.getAddress(buffers), function_pointer);
    }
    ...
    public static void glBufferData(int target, long data_size, int usage) {
        ...
        BufferChecks.checkFunctionAddress(function_pointer);
        GL15.nglBufferData(target, data_size, 0, usage, function_pointer);
    }
    ...
    public static void glGetBufferSubData(int target, long offset, ByteBuffer data) {
        ...
        BufferChecks.checkFunctionAddress(function_pointer);
        BufferChecks.checkDirect(data);
        GL15.nglGetBufferSubData(target, offset, data.remaining(), MemoryUtil.getAddress(data), function_pointer);
    }
    ...
    public static void glGetBufferSubData(int target, long offset, DoubleBuffer data) {
        ...
        BufferChecks.checkFunctionAddress(function_pointer);
        BufferChecks.checkDirect(data);
        GL15.nglGetBufferSubData(target, offset, data.remaining() << 3, MemoryUtil.getAddress(data), function_pointer);
    }
    ...
    public static void glGetBufferSubData(int target, long offset, FloatBuffer data) {
        ...
        BufferChecks.checkFunctionAddress(function_pointer);
        BufferChecks.checkDirect(data);
        GL15.nglGetBufferSubData(target, offset, data.remaining() << 2, MemoryUtil.getAddress(data), function_pointer);
    }
    ...
    public static void glGetBufferSubData(int target, long offset, ShortBuffer data) {
        ...
        BufferChecks.checkFunctionAddress(function_pointer);
        BufferChecks.checkDirect(data);
        GL15.nglGetBufferSubData(target, offset, data.remaining() << 1, MemoryUtil.getAddress(data), function_pointer);
    }
    ...
    public static ByteBuffer glMapBuffer(int target, int access, ByteBuffer old_buffer) {
        ...
        ByteBuffer __result = GL15.nglMapBuffer(target, access, GL15.glGetBufferParameteri(target, 34660), old_buffer, function_pointer);
    ...
    public static void glGetBufferParameter(int target, int pname, IntBuffer params) {
        ...
        GL15.nglGetBufferParameteriv(target, pname, MemoryUtil.getAddress(params), function_pointer);
    }
    ...
    public static ByteBuffer glGetBufferPointer(int target, int pname) {
        ...
        BufferChecks.checkFunctionAddress(function_pointer);
        ByteBuffer __result = GL15.nglGetBufferPointerv(target, pname, GL15.glGetBufferParameteri(target, 34660), function_pointer);
        return LWJGLUtil.CHECKS && __result == null ? null : __result.order(ByteOrder.nativeOrder());
    }
    ...
    public static void glGenQueries(IntBuffer ids) {
        ...
        GL15.nglGenQueries(ids.remaining(), MemoryUtil.getAddress(ids), function_pointer);
    }
    ...
    public static int glGenQueries() {
        ...
        GL15.nglGenQueries(1, MemoryUtil.getAddress(ids), function_pointer);
        return ids.get(0);
    }
    ...
    public static void glDeleteQueries(IntBuffer ids) {
        ...
        BufferChecks.checkFunctionAddress(function_pointer);
        BufferChecks.checkDirect(ids);
        GL15.nglDeleteQueries(ids.remaining(), MemoryUtil.getAddress(ids), function_pointer);
    }
    ...
    public static void glDeleteQueries(int id) {
        ...
        long function_pointer = caps.glDeleteQueries;
        BufferChecks.checkFunctionAddress(function_pointer);
        GL15.nglDeleteQueries(1, APIUtil.getInt(caps, id), function_pointer);
    }
    ...
    public static boolean glIsQuery(int id) {
        ...
        BufferChecks.checkFunctionAddress(function_pointer);
        boolean __result = GL15.nglIsQuery(id, function_pointer);
        return __result;
    }
    ...
    public static void glBeginQuery(int target, int id) {
        ...
        BufferChecks.checkFunctionAddress(function_pointer);
        GL15.nglBeginQuery(target, id, function_pointer);
    }
    ...
    public static void glGetQuery(int target, int pname, IntBuffer params) {
        ...
        GL15.nglGetQueryiv(target, pname, MemoryUtil.getAddress(params), function_pointer);
    }
    ...
    public static void glGetQueryObject(int id, int pname, IntBuffer params) {
        ...
        BufferChecks.checkFunctionAddress(function_pointer);
        BufferChecks.checkBuffer(params, 1);
        GL15.nglGetQueryObjectiv(id, pname, MemoryUtil.getAddress(params), function_pointer);
    }
    ...
    public static void glGetQueryObjectu(int id, int pname, IntBuffer params) {
        ...
        BufferChecks.checkFunctionAddress(function_pointer);
        BufferChecks.checkBuffer(params, 1);
        GL15.nglGetQueryObjectuiv(id, pname, MemoryUtil.getAddress(params), function_pointer);
    }
