...
public final class EXTTextureInteger {
    ...
    public static void glClearColorIiEXT(int r, int g, int b, int a) {
        ...
        EXTTextureInteger.nglClearColorIiEXT(r, g, b, a, function_pointer);
    }
    ...
    public static void glClearColorIuiEXT(int r, int g, int b, int a) {
        ...
        BufferChecks.checkFunctionAddress(function_pointer);
        EXTTextureInteger.nglClearColorIuiEXT(r, g, b, a, function_pointer);
    }
    ...
    public static void glTexParameterIEXT(int target, int pname, IntBuffer params) {
        ...
        EXTTextureInteger.nglTexParameterIivEXT(target, pname, MemoryUtil.getAddress(params), function_pointer);
    }
    ...
    public static void glTexParameterIiEXT(int target, int pname, int param) {
        ...
        long function_pointer = caps.glTexParameterIivEXT;
        BufferChecks.checkFunctionAddress(function_pointer);
        EXTTextureInteger.nglTexParameterIivEXT(target, pname, APIUtil.getInt(caps, param), function_pointer);
    }
    ...
    public static void glTexParameterIuEXT(int target, int pname, IntBuffer params) {
        ...
        BufferChecks.checkFunctionAddress(function_pointer);
        BufferChecks.checkBuffer(params, 4);
        EXTTextureInteger.nglTexParameterIuivEXT(target, pname, MemoryUtil.getAddress(params), function_pointer);
    }
    ...
    public static void glTexParameterIuiEXT(int target, int pname, int param) {
        ...
        long function_pointer = caps.glTexParameterIuivEXT;
        BufferChecks.checkFunctionAddress(function_pointer);
        EXTTextureInteger.nglTexParameterIuivEXT(target, pname, APIUtil.getInt(caps, param), function_pointer);
    }
    ...
    public static void glGetTexParameterIEXT(int target, int pname, IntBuffer params) {
        ...
        BufferChecks.checkFunctionAddress(function_pointer);
        BufferChecks.checkBuffer(params, 4);
        EXTTextureInteger.nglGetTexParameterIivEXT(target, pname, MemoryUtil.getAddress(params), function_pointer);
    }
    ...
    public static void glGetTexParameterIuEXT(int target, int pname, IntBuffer params) {
        ...
        BufferChecks.checkFunctionAddress(function_pointer);
        BufferChecks.checkBuffer(params, 4);
        EXTTextureInteger.nglGetTexParameterIuivEXT(target, pname, MemoryUtil.getAddress(params), function_pointer);
    }
