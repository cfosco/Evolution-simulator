...
implements DrawableLWJGL {
    ...
    public void initialize(long window, long display_id, int eglSurfaceType, PixelFormat pf) throws LWJGLException {
        ...
        synchronized (object) {
            ...
            if ((configs = (eglDisplay = EGL.eglGetDisplay((long)((int)display_id))).chooseConfig(pf.getAttribBuffer(eglDisplay, eglSurfaceType, attribs = new int[]{12329, 0, 12352, 4, 12333, 0}), null, BufferUtils.createIntBuffer(1))).length == 0) {
