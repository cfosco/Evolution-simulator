...
public final class GL43 {
    ...
    public static void glClearBufferData(int target, int internalformat, int format, int type, ByteBuffer data) {
        ...
        GL43.nglClearBufferData(target, internalformat, format, type, MemoryUtil.getAddress(data), function_pointer);
    }
    ...
    public static void glClearBufferSubData(int target, int internalformat, long offset, long size, int format, int type, ByteBuffer data) {
        ...
        BufferChecks.checkFunctionAddress(function_pointer);
        BufferChecks.checkBuffer(data, 1);
        GL43.nglClearBufferSubData(target, internalformat, offset, size, format, type, MemoryUtil.getAddress(data), function_pointer);
    }
    ...
    public static void glDispatchCompute(int num_groups_x, int num_groups_y, int num_groups_z) {
        ...
        BufferChecks.checkFunctionAddress(function_pointer);
        GL43.nglDispatchCompute(num_groups_x, num_groups_y, num_groups_z, function_pointer);
    }
    ...
    public static void glDispatchComputeIndirect(long indirect) {
        ...
        BufferChecks.checkFunctionAddress(function_pointer);
        GL43.nglDispatchComputeIndirect(indirect, function_pointer);
    }
    ...
    public static void glCopyImageSubData(int srcName, int srcTarget, int srcLevel, int srcX, int srcY, int srcZ, int dstName, int dstTarget, int dstLevel, int dstX, int dstY, int dstZ, int srcWidth, int srcHeight, int srcDepth) {
        ...
        BufferChecks.checkFunctionAddress(function_pointer);
        GL43.nglCopyImageSubData(srcName, srcTarget, srcLevel, srcX, srcY, srcZ, dstName, dstTarget, dstLevel, dstX, dstY, dstZ, srcWidth, srcHeight, srcDepth, function_pointer);
    }
    ...
    public static void glDebugMessageControl(int source, int type, int severity, IntBuffer ids, boolean enabled) {
        ...
        GL43.nglDebugMessageControl(source, type, severity, ids == null ? 0 : ids.remaining(), MemoryUtil.getAddressSafe(ids), enabled, function_pointer);
    }
    ...
    public static void glDebugMessageInsert(int source, int type, int id, int severity, ByteBuffer buf) {
        ...
        GL43.nglDebugMessageInsert(source, type, id, severity, buf.remaining(), MemoryUtil.getAddress(buf), function_pointer);
    }
    ...
    public static void glDebugMessageInsert(int source, int type, int id, int severity, CharSequence buf) {
        ...
        long function_pointer = caps.glDebugMessageInsert;
        BufferChecks.checkFunctionAddress(function_pointer);
        GL43.nglDebugMessageInsert(source, type, id, severity, buf.length(), APIUtil.getBuffer(caps, buf), function_pointer);
    }
    ...
    public static void glDebugMessageCallback(KHRDebugCallback callback) {
        ...
        GL43.nglDebugMessageCallback(callback == null ? 0 : callback.getPointer(), userParam, function_pointer);
    }
    ...
    public static int glGetDebugMessageLog(int count, IntBuffer sources, IntBuffer types, IntBuffer ids, IntBuffer severities, IntBuffer lengths, ByteBuffer messageLog) {
        ...
        int __result = GL43.nglGetDebugMessageLog(count, messageLog == null ? 0 : messageLog.remaining(), MemoryUtil.getAddressSafe(sources), MemoryUtil.getAddressSafe(types), MemoryUtil.getAddressSafe(ids), MemoryUtil.getAddressSafe(severities), MemoryUtil.getAddressSafe(lengths), MemoryUtil.getAddressSafe(messageLog), function_pointer);
        return __result;
    }
    ...
    public static void glPushDebugGroup(int source, int id, ByteBuffer message) {
        ...
        GL43.nglPushDebugGroup(source, id, message.remaining(), MemoryUtil.getAddress(message), function_pointer);
    }
    ...
    public static void glPushDebugGroup(int source, int id, CharSequence message) {
        ...
        long function_pointer = caps.glPushDebugGroup;
        BufferChecks.checkFunctionAddress(function_pointer);
        GL43.nglPushDebugGroup(source, id, message.length(), APIUtil.getBuffer(caps, message), function_pointer);
    }
    ...
    public static void glPopDebugGroup() {
        ...
        BufferChecks.checkFunctionAddress(function_pointer);
        GL43.nglPopDebugGroup(function_pointer);
    }
    ...
    public static void glObjectLabel(int identifier, int name, ByteBuffer label) {
        ...
        GL43.nglObjectLabel(identifier, name, label == null ? 0 : label.remaining(), MemoryUtil.getAddressSafe(label), function_pointer);
    }
    ...
    public static void glObjectLabel(int identifier, int name, CharSequence label) {
        ...
        long function_pointer = caps.glObjectLabel;
        BufferChecks.checkFunctionAddress(function_pointer);
        GL43.nglObjectLabel(identifier, name, label.length(), APIUtil.getBuffer(caps, label), function_pointer);
    }
    ...
    public static void glGetObjectLabel(int identifier, int name, IntBuffer length, ByteBuffer label) {
        ...
        BufferChecks.checkDirect(label);
        GL43.nglGetObjectLabel(identifier, name, label.remaining(), MemoryUtil.getAddressSafe(length), MemoryUtil.getAddress(label), function_pointer);
    }
    ...
    public static String glGetObjectLabel(int identifier, int name, int bufSize) {
        ...
        GL43.nglGetObjectLabel(identifier, name, bufSize, MemoryUtil.getAddress0(label_length), MemoryUtil.getAddress(label), function_pointer);
    ...
    public static void glObjectPtrLabel(PointerWrapper ptr, ByteBuffer label) {
        ...
        GL43.nglObjectPtrLabel(ptr.getPointer(), label == null ? 0 : label.remaining(), MemoryUtil.getAddressSafe(label), function_pointer);
    }
    ...
    public static void glObjectPtrLabel(PointerWrapper ptr, CharSequence label) {
        ...
        long function_pointer = caps.glObjectPtrLabel;
        BufferChecks.checkFunctionAddress(function_pointer);
        GL43.nglObjectPtrLabel(ptr.getPointer(), label.length(), APIUtil.getBuffer(caps, label), function_pointer);
    }
    ...
    public static void glGetObjectPtrLabel(PointerWrapper ptr, IntBuffer length, ByteBuffer label) {
        ...
        BufferChecks.checkDirect(label);
        GL43.nglGetObjectPtrLabel(ptr.getPointer(), label.remaining(), MemoryUtil.getAddressSafe(length), MemoryUtil.getAddress(label), function_pointer);
    }
    ...
    public static String glGetObjectPtrLabel(PointerWrapper ptr, int bufSize) {
        ...
        IntBuffer label_length = APIUtil.getLengths(caps);
        ByteBuffer label = APIUtil.getBufferByte(caps, bufSize);
        GL43.nglGetObjectPtrLabel(ptr.getPointer(), bufSize, MemoryUtil.getAddress0(label_length), MemoryUtil.getAddress(label), function_pointer);
        label.limit(label_length.get(0));
        return APIUtil.getString(caps, label);
    }
    ...
    public static void glFramebufferParameteri(int target, int pname, int param) {
        ...
        BufferChecks.checkFunctionAddress(function_pointer);
        GL43.nglFramebufferParameteri(target, pname, param, function_pointer);
    }
    ...
    public static void glGetFramebufferParameter(int target, int pname, IntBuffer params) {
        ...
        GL43.nglGetFramebufferParameteriv(target, pname, MemoryUtil.getAddress(params), function_pointer);
    }
    ...
    public static void glGetInternalformat(int target, int internalformat, int pname, LongBuffer params) {
        ...
        GL43.nglGetInternalformati64v(target, internalformat, pname, params.remaining(), MemoryUtil.getAddress(params), function_pointer);
    }
    ...
    public static long glGetInternalformati64(int target, int internalformat, int pname) {
        ...
        GL43.nglGetInternalformati64v(target, internalformat, pname, 1, MemoryUtil.getAddress(params), function_pointer);
        return params.get(0);
    }
    ...
    public static void glInvalidateTexSubImage(int texture, int level, int xoffset, int yoffset, int zoffset, int width, int height, int depth) {
        ...
        BufferChecks.checkFunctionAddress(function_pointer);
        GL43.nglInvalidateTexSubImage(texture, level, xoffset, yoffset, zoffset, width, height, depth, function_pointer);
    }
    ...
    public static void glInvalidateTexImage(int texture, int level) {
        ...
        BufferChecks.checkFunctionAddress(function_pointer);
        GL43.nglInvalidateTexImage(texture, level, function_pointer);
    }
    ...
    public static void glInvalidateBufferSubData(int buffer, long offset, long length) {
        ...
        BufferChecks.checkFunctionAddress(function_pointer);
        GL43.nglInvalidateBufferSubData(buffer, offset, length, function_pointer);
    }
    ...
    public static void glInvalidateBufferData(int buffer) {
        ...
        BufferChecks.checkFunctionAddress(function_pointer);
        GL43.nglInvalidateBufferData(buffer, function_pointer);
    }
    ...
    public static void glInvalidateFramebuffer(int target, IntBuffer attachments) {
        ...
        GL43.nglInvalidateFramebuffer(target, attachments.remaining(), MemoryUtil.getAddress(attachments), function_pointer);
    }
    ...
    public static void glInvalidateSubFramebuffer(int target, IntBuffer attachments, int x, int y, int width, int height) {
        ...
        BufferChecks.checkFunctionAddress(function_pointer);
        BufferChecks.checkDirect(attachments);
        GL43.nglInvalidateSubFramebuffer(target, attachments.remaining(), MemoryUtil.getAddress(attachments), x, y, width, height, function_pointer);
    }
    ...
    public static void glMultiDrawArraysIndirect(int mode, ByteBuffer indirect, int primcount, int stride) {
        ...
        GL43.nglMultiDrawArraysIndirect(mode, MemoryUtil.getAddress(indirect), primcount, stride, function_pointer);
    }
    ...
    public static void glMultiDrawArraysIndirect(int mode, long indirect_buffer_offset, int primcount, int stride) {
        ...
        GL43.nglMultiDrawArraysIndirectBO(mode, indirect_buffer_offset, primcount, stride, function_pointer);
    }
    ...
    public static void glMultiDrawElementsIndirect(int mode, int type, ByteBuffer indirect, int primcount, int stride) {
        ...
        GL43.nglMultiDrawElementsIndirect(mode, type, MemoryUtil.getAddress(indirect), primcount, stride, function_pointer);
    }
    ...
    public static void glMultiDrawElementsIndirect(int mode, int type, long indirect_buffer_offset, int primcount, int stride) {
        ...
        BufferChecks.checkFunctionAddress(function_pointer);
        GLChecks.ensureIndirectBOenabled(caps);
        GL43.nglMultiDrawElementsIndirectBO(mode, type, indirect_buffer_offset, primcount, stride, function_pointer);
    }
    ...
    public static void glGetProgramInterface(int program, int programInterface, int pname, IntBuffer params) {
        ...
        BufferChecks.checkFunctionAddress(function_pointer);
        BufferChecks.checkBuffer(params, 1);
        GL43.nglGetProgramInterfaceiv(program, programInterface, pname, MemoryUtil.getAddress(params), function_pointer);
    }
    ...
    public static int glGetProgramResourceIndex(int program, int programInterface, ByteBuffer name) {
        ...
        int __result = GL43.nglGetProgramResourceIndex(program, programInterface, MemoryUtil.getAddress(name), function_pointer);
        return __result;
    }
    ...
    public static int glGetProgramResourceIndex(int program, int programInterface, CharSequence name) {
        ...
        long function_pointer = caps.glGetProgramResourceIndex;
        BufferChecks.checkFunctionAddress(function_pointer);
        int __result = GL43.nglGetProgramResourceIndex(program, programInterface, APIUtil.getBufferNT(caps, name), function_pointer);
        return __result;
    }
    ...
    public static void glGetProgramResourceName(int program, int programInterface, int index, IntBuffer length, ByteBuffer name) {
        ...
        GL43.nglGetProgramResourceName(program, programInterface, index, name == null ? 0 : name.remaining(), MemoryUtil.getAddressSafe(length), MemoryUtil.getAddressSafe(name), function_pointer);
    }
    ...
    public static String glGetProgramResourceName(int program, int programInterface, int index, int bufSize) {
        ...
        GL43.nglGetProgramResourceName(program, programInterface, index, bufSize, MemoryUtil.getAddress0(name_length), MemoryUtil.getAddress(name), function_pointer);
    ...
    public static void glGetProgramResource(int program, int programInterface, int index, IntBuffer props, IntBuffer length, IntBuffer params) {
        ...
        BufferChecks.checkDirect(params);
        GL43.nglGetProgramResourceiv(program, programInterface, index, props.remaining(), MemoryUtil.getAddress(props), params.remaining(), MemoryUtil.getAddressSafe(length), MemoryUtil.getAddress(params), function_pointer);
    }
    ...
    public static int glGetProgramResourceLocation(int program, int programInterface, ByteBuffer name) {
        ...
        BufferChecks.checkDirect(name);
        BufferChecks.checkNullTerminated(name);
        int __result = GL43.nglGetProgramResourceLocation(program, programInterface, MemoryUtil.getAddress(name), function_pointer);
        return __result;
    }
    ...
    public static int glGetProgramResourceLocation(int program, int programInterface, CharSequence name) {
        ...
        long function_pointer = caps.glGetProgramResourceLocation;
        BufferChecks.checkFunctionAddress(function_pointer);
        int __result = GL43.nglGetProgramResourceLocation(program, programInterface, APIUtil.getBufferNT(caps, name), function_pointer);
        return __result;
    }
    ...
    public static int glGetProgramResourceLocationIndex(int program, int programInterface, ByteBuffer name) {
        ...
        BufferChecks.checkDirect(name);
        BufferChecks.checkNullTerminated(name);
        int __result = GL43.nglGetProgramResourceLocationIndex(program, programInterface, MemoryUtil.getAddress(name), function_pointer);
        return __result;
    }
    ...
    public static int glGetProgramResourceLocationIndex(int program, int programInterface, CharSequence name) {
        ...
        long function_pointer = caps.glGetProgramResourceLocationIndex;
        BufferChecks.checkFunctionAddress(function_pointer);
        int __result = GL43.nglGetProgramResourceLocationIndex(program, programInterface, APIUtil.getBufferNT(caps, name), function_pointer);
        return __result;
    }
    ...
    public static void glShaderStorageBlockBinding(int program, int storageBlockIndex, int storageBlockBinding) {
        ...
        BufferChecks.checkFunctionAddress(function_pointer);
        GL43.nglShaderStorageBlockBinding(program, storageBlockIndex, storageBlockBinding, function_pointer);
    }
    ...
    public static void glTexBufferRange(int target, int internalformat, int buffer, long offset, long size) {
        ...
        BufferChecks.checkFunctionAddress(function_pointer);
        GL43.nglTexBufferRange(target, internalformat, buffer, offset, size, function_pointer);
    }
    ...
    public static void glTexStorage2DMultisample(int target, int samples, int internalformat, int width, int height, boolean fixedsamplelocations) {
        ...
        BufferChecks.checkFunctionAddress(function_pointer);
        GL43.nglTexStorage2DMultisample(target, samples, internalformat, width, height, fixedsamplelocations, function_pointer);
    }
    ...
    public static void glTexStorage3DMultisample(int target, int samples, int internalformat, int width, int height, int depth, boolean fixedsamplelocations) {
        ...
        BufferChecks.checkFunctionAddress(function_pointer);
        GL43.nglTexStorage3DMultisample(target, samples, internalformat, width, height, depth, fixedsamplelocations, function_pointer);
    }
    ...
    public static void glTextureView(int texture, int target, int origtexture, int internalformat, int minlevel, int numlevels, int minlayer, int numlayers) {
        ...
        BufferChecks.checkFunctionAddress(function_pointer);
        GL43.nglTextureView(texture, target, origtexture, internalformat, minlevel, numlevels, minlayer, numlayers, function_pointer);
    }
    ...
    public static void glBindVertexBuffer(int bindingindex, int buffer, long offset, int stride) {
        ...
        BufferChecks.checkFunctionAddress(function_pointer);
        GL43.nglBindVertexBuffer(bindingindex, buffer, offset, stride, function_pointer);
    }
    ...
    public static void glVertexAttribFormat(int attribindex, int size, int type, boolean normalized, int relativeoffset) {
        ...
        BufferChecks.checkFunctionAddress(function_pointer);
        GL43.nglVertexAttribFormat(attribindex, size, type, normalized, relativeoffset, function_pointer);
    }
    ...
    public static void glVertexAttribIFormat(int attribindex, int size, int type, int relativeoffset) {
        ...
        BufferChecks.checkFunctionAddress(function_pointer);
        GL43.nglVertexAttribIFormat(attribindex, size, type, relativeoffset, function_pointer);
    }
    ...
    public static void glVertexAttribLFormat(int attribindex, int size, int type, int relativeoffset) {
        ...
        BufferChecks.checkFunctionAddress(function_pointer);
        GL43.nglVertexAttribLFormat(attribindex, size, type, relativeoffset, function_pointer);
    }
    ...
    public static void glVertexAttribBinding(int attribindex, int bindingindex) {
        ...
        BufferChecks.checkFunctionAddress(function_pointer);
        GL43.nglVertexAttribBinding(attribindex, bindingindex, function_pointer);
    }
    ...
    public static void glVertexBindingDivisor(int bindingindex, int divisor) {
        ...
        BufferChecks.checkFunctionAddress(function_pointer);
        GL43.nglVertexBindingDivisor(bindingindex, divisor, function_pointer);
    }
