...
public final class NVVertexArrayRange {
    ...
    public static void glVertexArrayRangeNV(ByteBuffer pPointer) {
        ...
        NVVertexArrayRange.nglVertexArrayRangeNV(pPointer.remaining(), MemoryUtil.getAddress(pPointer), function_pointer);
    }
    ...
    public static void glVertexArrayRangeNV(DoubleBuffer pPointer) {
        ...
        BufferChecks.checkFunctionAddress(function_pointer);
        BufferChecks.checkDirect(pPointer);
        NVVertexArrayRange.nglVertexArrayRangeNV(pPointer.remaining() << 3, MemoryUtil.getAddress(pPointer), function_pointer);
    }
    ...
    public static void glVertexArrayRangeNV(FloatBuffer pPointer) {
        ...
        BufferChecks.checkFunctionAddress(function_pointer);
        BufferChecks.checkDirect(pPointer);
        NVVertexArrayRange.nglVertexArrayRangeNV(pPointer.remaining() << 2, MemoryUtil.getAddress(pPointer), function_pointer);
    }
    ...
    public static void glVertexArrayRangeNV(ShortBuffer pPointer) {
        ...
        BufferChecks.checkFunctionAddress(function_pointer);
        BufferChecks.checkDirect(pPointer);
        NVVertexArrayRange.nglVertexArrayRangeNV(pPointer.remaining() << 1, MemoryUtil.getAddress(pPointer), function_pointer);
    }
    ...
    public static void glFreeMemoryNV(ByteBuffer pointer) {
        ...
        NVVertexArrayRange.nglFreeMemoryNV(MemoryUtil.getAddress(pointer), function_pointer);
    }
