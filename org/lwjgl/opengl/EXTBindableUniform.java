...
public final class EXTBindableUniform {
    ...
    public static void glUniformBufferEXT(int program, int location, int buffer) {
        ...
        EXTBindableUniform.nglUniformBufferEXT(program, location, buffer, function_pointer);
    }
    ...
    public static int glGetUniformBufferSizeEXT(int program, int location) {
        ...
        BufferChecks.checkFunctionAddress(function_pointer);
        int __result = EXTBindableUniform.nglGetUniformBufferSizeEXT(program, location, function_pointer);
        return __result;
    }
    ...
    public static long glGetUniformOffsetEXT(int program, int location) {
        ...
        BufferChecks.checkFunctionAddress(function_pointer);
        long __result = EXTBindableUniform.nglGetUniformOffsetEXT(program, location, function_pointer);
        return __result;
    }
