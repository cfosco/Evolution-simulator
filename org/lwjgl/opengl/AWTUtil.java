...
final class AWTUtil {
    ...
    public static int getNativeCursorCapabilities() {
        if (LWJGLUtil.getPlatform() != 2 || LWJGLUtil.isMacOSXEqualsOrBetterThan(10, 4)) {
            ...
            boolean supported = cursor_colors >= 32767 && AWTUtil.getMaxCursorSize() > 0;
    ...
    public static Robot createRobot(final Component component) {
        try {
            return (Robot)AccessController.doPrivileged(new PrivilegedExceptionAction<Robot>(){
    ...
    private static Point getPointerLocation(Component component) {
        try {
            ...
            if (config != null) {
                PointerInfo pointer_info = (PointerInfo)AccessController.doPrivileged(new PrivilegedExceptionAction<PointerInfo>(){
