...
public final class NVParameterBufferObject {
    ...
    public static void glProgramBufferParametersNV(int target, int buffer, int index, FloatBuffer params) {
        ...
        NVParameterBufferObject.nglProgramBufferParametersfvNV(target, buffer, index, params.remaining() >> 2, MemoryUtil.getAddress(params), function_pointer);
    }
    ...
    public static void glProgramBufferParametersINV(int target, int buffer, int index, IntBuffer params) {
        ...
        BufferChecks.checkFunctionAddress(function_pointer);
        BufferChecks.checkDirect(params);
        NVParameterBufferObject.nglProgramBufferParametersIivNV(target, buffer, index, params.remaining() >> 2, MemoryUtil.getAddress(params), function_pointer);
    }
    ...
    public static void glProgramBufferParametersIuNV(int target, int buffer, int index, IntBuffer params) {
        ...
        BufferChecks.checkFunctionAddress(function_pointer);
        BufferChecks.checkDirect(params);
        NVParameterBufferObject.nglProgramBufferParametersIuivNV(target, buffer, index, params.remaining() >> 2, MemoryUtil.getAddress(params), function_pointer);
    }
