...
implements KeyListener {
    ...
    public void keyPressed(KeyEvent e) {
        this.handleKey(e.getKeyCode(), e.getKeyLocation(), 1, e.getKeyChar(), e.getWhen() * 1000000);
    }

    public void keyReleased(KeyEvent e) {
        this.handleKey(e.getKeyCode(), e.getKeyLocation(), 0, 0, e.getWhen() * 1000000);
    }
    ...
    static {
        KeyboardEventQueue.KEY_MAP[48] = 11;
