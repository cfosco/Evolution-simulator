...
public final class ATIEnvmapBumpmap {
    ...
    public static void glTexBumpParameterATI(int pname, FloatBuffer param) {
        ...
        ATIEnvmapBumpmap.nglTexBumpParameterfvATI(pname, MemoryUtil.getAddress(param), function_pointer);
    }
    ...
    public static void glTexBumpParameterATI(int pname, IntBuffer param) {
        ...
        BufferChecks.checkFunctionAddress(function_pointer);
        BufferChecks.checkBuffer(param, 4);
        ATIEnvmapBumpmap.nglTexBumpParameterivATI(pname, MemoryUtil.getAddress(param), function_pointer);
    }
    ...
    public static void glGetTexBumpParameterATI(int pname, FloatBuffer param) {
        ...
        BufferChecks.checkFunctionAddress(function_pointer);
        BufferChecks.checkBuffer(param, 4);
        ATIEnvmapBumpmap.nglGetTexBumpParameterfvATI(pname, MemoryUtil.getAddress(param), function_pointer);
    }
    ...
    public static void glGetTexBumpParameterATI(int pname, IntBuffer param) {
        ...
        BufferChecks.checkFunctionAddress(function_pointer);
        BufferChecks.checkBuffer(param, 4);
        ATIEnvmapBumpmap.nglGetTexBumpParameterivATI(pname, MemoryUtil.getAddress(param), function_pointer);
    }
