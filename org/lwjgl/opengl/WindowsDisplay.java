...
implements DisplayImplementation {
    ...
    public void createWindow(DrawableLWJGL drawable, DisplayMode mode, Canvas parent, int x, int y) throws LWJGLException {
        ...
        this.parent_hwnd = parent != null ? WindowsDisplay.getHwnd(parent) : 0;
        ...
        try {
            if (drawable instanceof DrawableGL) {
                int format = WindowsPeerInfo.choosePixelFormat(this.getHdc(), 0, 0, (org.lwjgl.opengl.PixelFormat)drawable.getPixelFormat(), null, true, true, false, true);
    ...
    private native int nGetPbufferCapabilities(org.lwjgl.opengl.PixelFormat var1) throws LWJGLException;
    ...
    public int setIcon(ByteBuffer[] icons) {
        ...
        block0 : for (ByteBuffer icon : icons) {
            ...
            if ((int)Math.sqrt(size) == small_icon_size && !done_small) {
                ...
                WindowsDisplay.sendMessage(this.hwnd, 128, 0, small_new_icon);
                this.freeSmallIcon();
            ...
            WindowsDisplay.sendMessage(this.hwnd, 128, 1, large_new_icon);
            this.freeLargeIcon();
    ...
    private void handleChar(long wParam, long lParam, long millis) {
        boolean repeat;
        byte state = (byte)(1 - (lParam >>> 31 & 1));
        byte previous_state = (byte)(lParam >>> 30 & 1);
    ...
    private void handleKeyButton(long wParam, long lParam, long millis) {
        ...
        byte extended = (byte)(lParam >>> 24 & 1);
    ...
    private long doHandleMessage(long hwnd, int msg, long wParam, long lParam, long millis) {
        ...
        block3 : switch (msg) {
            ...
            case 512: {
                short xPos = (short)(lParam & 65535);
                int yPos = WindowsDisplay.transformY(this.getHwnd(), (short)(lParam >> 16 & 65535));
            ...
            case 522: {
                short dwheel = (short)(wParam >> 16 & 65535);
            ...
            case 257: {
                if (wParam == 44 && this.keyboard != null && !this.keyboard.isKeyDown(183)) {
                    long fake_lparam = lParam & Integer.MAX_VALUE;
                    this.handleKeyButton(wParam, fake_lparam &= -1073741825, millis);
                }
            }
            case 256: 
            case 260: {
    ...
    public void setResizable(boolean resizable) {
        ...
        style = resizable && !Display.isFullscreen() ? style | 327680 : style & -327681;
        ...
        rect.copyFromBuffer(rect_buffer);
        WindowsDisplay.setWindowPos(this.hwnd, 0, WindowsDisplay.rect.left, WindowsDisplay.rect.top, WindowsDisplay.rect.right - WindowsDisplay.rect.left, WindowsDisplay.rect.bottom - WindowsDisplay.rect.top, 36);
        this.updateWidthAndHeight();
    }
