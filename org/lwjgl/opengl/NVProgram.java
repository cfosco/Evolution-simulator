...
public class NVProgram {
    ...
    public static void glLoadProgramNV(int target, int programID, ByteBuffer string) {
        ...
        NVProgram.nglLoadProgramNV(target, programID, string.remaining(), MemoryUtil.getAddress(string), function_pointer);
    }
    ...
    public static void glLoadProgramNV(int target, int programID, CharSequence string) {
        ...
        long function_pointer = caps.glLoadProgramNV;
        BufferChecks.checkFunctionAddress(function_pointer);
        NVProgram.nglLoadProgramNV(target, programID, string.length(), APIUtil.getBuffer(caps, string), function_pointer);
    }
    ...
    public static void glDeleteProgramsNV(IntBuffer programs) {
        ...
        NVProgram.nglDeleteProgramsNV(programs.remaining(), MemoryUtil.getAddress(programs), function_pointer);
    }
    ...
    public static void glDeleteProgramsNV(int program) {
        ...
        long function_pointer = caps.glDeleteProgramsNV;
        BufferChecks.checkFunctionAddress(function_pointer);
        NVProgram.nglDeleteProgramsNV(1, APIUtil.getInt(caps, program), function_pointer);
    }
    ...
    public static void glGenProgramsNV(IntBuffer programs) {
        ...
        BufferChecks.checkFunctionAddress(function_pointer);
        BufferChecks.checkDirect(programs);
        NVProgram.nglGenProgramsNV(programs.remaining(), MemoryUtil.getAddress(programs), function_pointer);
    }
    ...
    public static int glGenProgramsNV() {
        ...
        NVProgram.nglGenProgramsNV(1, MemoryUtil.getAddress(programs), function_pointer);
    ...
    public static void glGetProgramNV(int programID, int parameterName, IntBuffer params) {
        ...
        NVProgram.nglGetProgramivNV(programID, parameterName, MemoryUtil.getAddress(params), function_pointer);
    }
    ...
    public static void glGetProgramStringNV(int programID, int parameterName, ByteBuffer paramString) {
        ...
        NVProgram.nglGetProgramStringNV(programID, parameterName, MemoryUtil.getAddress(paramString), function_pointer);
    }
    ...
    public static String glGetProgramStringNV(int programID, int parameterName) {
        ...
        long function_pointer = caps.glGetProgramStringNV;
        BufferChecks.checkFunctionAddress(function_pointer);
        int programLength = NVProgram.glGetProgramiNV(programID, 34343);
    ...
    public static boolean glAreProgramsResidentNV(IntBuffer programIDs, ByteBuffer programResidences) {
        ...
        boolean __result = NVProgram.nglAreProgramsResidentNV(programIDs.remaining(), MemoryUtil.getAddress(programIDs), MemoryUtil.getAddress(programResidences), function_pointer);
        return __result;
    }
    ...
    public static void glRequestResidentProgramsNV(IntBuffer programIDs) {
        ...
        BufferChecks.checkFunctionAddress(function_pointer);
        BufferChecks.checkDirect(programIDs);
        NVProgram.nglRequestResidentProgramsNV(programIDs.remaining(), MemoryUtil.getAddress(programIDs), function_pointer);
    }
    ...
    public static void glRequestResidentProgramsNV(int programID) {
        ...
        long function_pointer = caps.glRequestResidentProgramsNV;
        BufferChecks.checkFunctionAddress(function_pointer);
        NVProgram.nglRequestResidentProgramsNV(1, APIUtil.getInt(caps, programID), function_pointer);
    }
}
