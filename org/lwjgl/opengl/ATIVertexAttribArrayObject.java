...
public final class ATIVertexAttribArrayObject {
    ...
    public static void glGetVertexAttribArrayObjectATI(int index, int pname, FloatBuffer params) {
        ...
        ATIVertexAttribArrayObject.nglGetVertexAttribArrayObjectfvATI(index, pname, MemoryUtil.getAddress(params), function_pointer);
    }
    ...
    public static void glGetVertexAttribArrayObjectATI(int index, int pname, IntBuffer params) {
        ...
        BufferChecks.checkFunctionAddress(function_pointer);
        BufferChecks.checkBuffer(params, 4);
        ATIVertexAttribArrayObject.nglGetVertexAttribArrayObjectivATI(index, pname, MemoryUtil.getAddress(params), function_pointer);
    }
