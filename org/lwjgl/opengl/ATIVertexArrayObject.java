...
public final class ATIVertexArrayObject {
    ...
    public static int glNewObjectBufferATI(int pPointer_size, int usage) {
        ...
        int __result = ATIVertexArrayObject.nglNewObjectBufferATI(pPointer_size, 0, usage, function_pointer);
        return __result;
    }
    ...
    public static int glNewObjectBufferATI(ByteBuffer pPointer, int usage) {
        ...
        int __result = ATIVertexArrayObject.nglNewObjectBufferATI(pPointer.remaining(), MemoryUtil.getAddress(pPointer), usage, function_pointer);
        return __result;
    }
    ...
    public static int glNewObjectBufferATI(DoubleBuffer pPointer, int usage) {
        ...
        BufferChecks.checkFunctionAddress(function_pointer);
        BufferChecks.checkDirect(pPointer);
        int __result = ATIVertexArrayObject.nglNewObjectBufferATI(pPointer.remaining() << 3, MemoryUtil.getAddress(pPointer), usage, function_pointer);
        return __result;
    }
    ...
    public static int glNewObjectBufferATI(FloatBuffer pPointer, int usage) {
        ...
        BufferChecks.checkFunctionAddress(function_pointer);
        BufferChecks.checkDirect(pPointer);
        int __result = ATIVertexArrayObject.nglNewObjectBufferATI(pPointer.remaining() << 2, MemoryUtil.getAddress(pPointer), usage, function_pointer);
        return __result;
    }
    ...
    public static int glNewObjectBufferATI(ShortBuffer pPointer, int usage) {
        ...
        BufferChecks.checkFunctionAddress(function_pointer);
        BufferChecks.checkDirect(pPointer);
        int __result = ATIVertexArrayObject.nglNewObjectBufferATI(pPointer.remaining() << 1, MemoryUtil.getAddress(pPointer), usage, function_pointer);
        return __result;
    }
    ...
    public static void glUpdateObjectBufferATI(int buffer, int offset, ByteBuffer pPointer, int preserve) {
        ...
        BufferChecks.checkFunctionAddress(function_pointer);
        BufferChecks.checkDirect(pPointer);
        ATIVertexArrayObject.nglUpdateObjectBufferATI(buffer, offset, pPointer.remaining(), MemoryUtil.getAddress(pPointer), preserve, function_pointer);
    }
    ...
    public static void glUpdateObjectBufferATI(int buffer, int offset, DoubleBuffer pPointer, int preserve) {
        ...
        BufferChecks.checkFunctionAddress(function_pointer);
        BufferChecks.checkDirect(pPointer);
        ATIVertexArrayObject.nglUpdateObjectBufferATI(buffer, offset, pPointer.remaining() << 3, MemoryUtil.getAddress(pPointer), preserve, function_pointer);
    }
    ...
    public static void glUpdateObjectBufferATI(int buffer, int offset, FloatBuffer pPointer, int preserve) {
        ...
        BufferChecks.checkFunctionAddress(function_pointer);
        BufferChecks.checkDirect(pPointer);
        ATIVertexArrayObject.nglUpdateObjectBufferATI(buffer, offset, pPointer.remaining() << 2, MemoryUtil.getAddress(pPointer), preserve, function_pointer);
    }
    ...
    public static void glUpdateObjectBufferATI(int buffer, int offset, ShortBuffer pPointer, int preserve) {
        ...
        BufferChecks.checkFunctionAddress(function_pointer);
        BufferChecks.checkDirect(pPointer);
        ATIVertexArrayObject.nglUpdateObjectBufferATI(buffer, offset, pPointer.remaining() << 1, MemoryUtil.getAddress(pPointer), preserve, function_pointer);
    }
    ...
    public static void glGetObjectBufferATI(int buffer, int pname, FloatBuffer params) {
        ...
        ATIVertexArrayObject.nglGetObjectBufferfvATI(buffer, pname, MemoryUtil.getAddress(params), function_pointer);
    }
    ...
    public static void glGetObjectBufferATI(int buffer, int pname, IntBuffer params) {
        ...
        BufferChecks.checkFunctionAddress(function_pointer);
        BufferChecks.checkDirect(params);
        ATIVertexArrayObject.nglGetObjectBufferivATI(buffer, pname, MemoryUtil.getAddress(params), function_pointer);
    }
    ...
    public static void glGetArrayObjectATI(int array, int pname, FloatBuffer params) {
        ...
        ATIVertexArrayObject.nglGetArrayObjectfvATI(array, pname, MemoryUtil.getAddress(params), function_pointer);
    }
    ...
    public static void glGetArrayObjectATI(int array, int pname, IntBuffer params) {
        ...
        BufferChecks.checkFunctionAddress(function_pointer);
        BufferChecks.checkBuffer(params, 4);
        ATIVertexArrayObject.nglGetArrayObjectivATI(array, pname, MemoryUtil.getAddress(params), function_pointer);
    }
    ...
    public static void glVariantArrayObjectATI(int id, int type, int stride, int buffer, int offset) {
        ...
        BufferChecks.checkFunctionAddress(function_pointer);
        ATIVertexArrayObject.nglVariantArrayObjectATI(id, type, stride, buffer, offset, function_pointer);
    }
    ...
    public static void glGetVariantArrayObjectATI(int id, int pname, FloatBuffer params) {
        ...
        BufferChecks.checkFunctionAddress(function_pointer);
        BufferChecks.checkBuffer(params, 4);
        ATIVertexArrayObject.nglGetVariantArrayObjectfvATI(id, pname, MemoryUtil.getAddress(params), function_pointer);
    }
    ...
    public static void glGetVariantArrayObjectATI(int id, int pname, IntBuffer params) {
        ...
        BufferChecks.checkFunctionAddress(function_pointer);
        BufferChecks.checkBuffer(params, 4);
        ATIVertexArrayObject.nglGetVariantArrayObjectivATI(id, pname, MemoryUtil.getAddress(params), function_pointer);
    }
