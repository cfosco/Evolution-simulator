...
public final class ARBShadingLanguageInclude {
    ...
    public static void glNamedStringARB(int type, ByteBuffer name, ByteBuffer string) {
        ...
        ARBShadingLanguageInclude.nglNamedStringARB(type, name.remaining(), MemoryUtil.getAddress(name), string.remaining(), MemoryUtil.getAddress(string), function_pointer);
    }
    ...
    public static void glNamedStringARB(int type, CharSequence name, CharSequence string) {
        ...
        long function_pointer = caps.glNamedStringARB;
        BufferChecks.checkFunctionAddress(function_pointer);
        ARBShadingLanguageInclude.nglNamedStringARB(type, name.length(), APIUtil.getBuffer(caps, name), string.length(), APIUtil.getBuffer(caps, string, name.length()), function_pointer);
    }
    ...
    public static void glDeleteNamedStringARB(ByteBuffer name) {
        ...
        BufferChecks.checkFunctionAddress(function_pointer);
        BufferChecks.checkDirect(name);
        ARBShadingLanguageInclude.nglDeleteNamedStringARB(name.remaining(), MemoryUtil.getAddress(name), function_pointer);
    }
    ...
    public static void glDeleteNamedStringARB(CharSequence name) {
        ...
        long function_pointer = caps.glDeleteNamedStringARB;
        BufferChecks.checkFunctionAddress(function_pointer);
        ARBShadingLanguageInclude.nglDeleteNamedStringARB(name.length(), APIUtil.getBuffer(caps, name), function_pointer);
    }
    ...
    public static void glCompileShaderIncludeARB(int shader, int count, ByteBuffer path) {
        ...
        ARBShadingLanguageInclude.nglCompileShaderIncludeARB(shader, count, MemoryUtil.getAddress(path), 0, function_pointer);
    }
    ...
    public static boolean glIsNamedStringARB(ByteBuffer name) {
        ...
        BufferChecks.checkFunctionAddress(function_pointer);
        BufferChecks.checkDirect(name);
        boolean __result = ARBShadingLanguageInclude.nglIsNamedStringARB(name.remaining(), MemoryUtil.getAddress(name), function_pointer);
        return __result;
    }
    ...
    public static boolean glIsNamedStringARB(CharSequence name) {
        ...
        long function_pointer = caps.glIsNamedStringARB;
        BufferChecks.checkFunctionAddress(function_pointer);
        boolean __result = ARBShadingLanguageInclude.nglIsNamedStringARB(name.length(), APIUtil.getBuffer(caps, name), function_pointer);
        return __result;
    }
    ...
    public static void glGetNamedStringARB(ByteBuffer name, IntBuffer stringlen, ByteBuffer string) {
        ...
        BufferChecks.checkDirect(string);
        ARBShadingLanguageInclude.nglGetNamedStringARB(name.remaining(), MemoryUtil.getAddress(name), string.remaining(), MemoryUtil.getAddressSafe(stringlen), MemoryUtil.getAddress(string), function_pointer);
    }
    ...
    public static void glGetNamedStringARB(CharSequence name, IntBuffer stringlen, ByteBuffer string) {
        ...
        BufferChecks.checkDirect(string);
        ARBShadingLanguageInclude.nglGetNamedStringARB(name.length(), APIUtil.getBuffer(caps, name), string.remaining(), MemoryUtil.getAddressSafe(stringlen), MemoryUtil.getAddress(string), function_pointer);
    }
    ...
    public static String glGetNamedStringARB(CharSequence name, int bufSize) {
        ...
        ARBShadingLanguageInclude.nglGetNamedStringARB(name.length(), APIUtil.getBuffer(caps, name), bufSize, MemoryUtil.getAddress0(string_length), MemoryUtil.getAddress(string), function_pointer);
    ...
    public static void glGetNamedStringARB(ByteBuffer name, int pname, IntBuffer params) {
        ...
        ARBShadingLanguageInclude.nglGetNamedStringivARB(name.remaining(), MemoryUtil.getAddress(name), pname, MemoryUtil.getAddress(params), function_pointer);
    }
    ...
    public static void glGetNamedStringiARB(CharSequence name, int pname, IntBuffer params) {
        ...
        BufferChecks.checkFunctionAddress(function_pointer);
        BufferChecks.checkBuffer(params, 1);
        ARBShadingLanguageInclude.nglGetNamedStringivARB(name.length(), APIUtil.getBuffer(caps, name), pname, MemoryUtil.getAddress(params), function_pointer);
    }
