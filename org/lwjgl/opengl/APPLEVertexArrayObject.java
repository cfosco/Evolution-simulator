...
public final class APPLEVertexArrayObject {
    ...
    public static void glDeleteVertexArraysAPPLE(IntBuffer arrays) {
        ...
        APPLEVertexArrayObject.nglDeleteVertexArraysAPPLE(arrays.remaining(), MemoryUtil.getAddress(arrays), function_pointer);
    }
    ...
    public static void glDeleteVertexArraysAPPLE(int array) {
        ...
        long function_pointer = caps.glDeleteVertexArraysAPPLE;
        BufferChecks.checkFunctionAddress(function_pointer);
        APPLEVertexArrayObject.nglDeleteVertexArraysAPPLE(1, APIUtil.getInt(caps, array), function_pointer);
    }
    ...
    public static void glGenVertexArraysAPPLE(IntBuffer arrays) {
        ...
        BufferChecks.checkFunctionAddress(function_pointer);
        BufferChecks.checkDirect(arrays);
        APPLEVertexArrayObject.nglGenVertexArraysAPPLE(arrays.remaining(), MemoryUtil.getAddress(arrays), function_pointer);
    }
    ...
    public static int glGenVertexArraysAPPLE() {
        ...
        APPLEVertexArrayObject.nglGenVertexArraysAPPLE(1, MemoryUtil.getAddress(arrays), function_pointer);
        return arrays.get(0);
    }
