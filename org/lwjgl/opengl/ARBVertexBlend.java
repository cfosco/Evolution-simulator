...
public final class ARBVertexBlend {
    ...
    public static void glWeightARB(ByteBuffer pWeights) {
        ...
        ARBVertexBlend.nglWeightbvARB(pWeights.remaining(), MemoryUtil.getAddress(pWeights), function_pointer);
    }
    ...
    public static void glWeightARB(ShortBuffer pWeights) {
        ...
        BufferChecks.checkFunctionAddress(function_pointer);
        BufferChecks.checkDirect(pWeights);
        ARBVertexBlend.nglWeightsvARB(pWeights.remaining(), MemoryUtil.getAddress(pWeights), function_pointer);
    }
    ...
    public static void glWeightARB(IntBuffer pWeights) {
        ...
        BufferChecks.checkFunctionAddress(function_pointer);
        BufferChecks.checkDirect(pWeights);
        ARBVertexBlend.nglWeightivARB(pWeights.remaining(), MemoryUtil.getAddress(pWeights), function_pointer);
    }
    ...
    public static void glWeightARB(FloatBuffer pWeights) {
        ...
        BufferChecks.checkFunctionAddress(function_pointer);
        BufferChecks.checkDirect(pWeights);
        ARBVertexBlend.nglWeightfvARB(pWeights.remaining(), MemoryUtil.getAddress(pWeights), function_pointer);
    }
    ...
    public static void glWeightARB(DoubleBuffer pWeights) {
        ...
        BufferChecks.checkFunctionAddress(function_pointer);
        BufferChecks.checkDirect(pWeights);
        ARBVertexBlend.nglWeightdvARB(pWeights.remaining(), MemoryUtil.getAddress(pWeights), function_pointer);
    }
    ...
    public static void glWeightuARB(ByteBuffer pWeights) {
        ...
        BufferChecks.checkFunctionAddress(function_pointer);
        BufferChecks.checkDirect(pWeights);
        ARBVertexBlend.nglWeightubvARB(pWeights.remaining(), MemoryUtil.getAddress(pWeights), function_pointer);
    }
    ...
    public static void glWeightuARB(ShortBuffer pWeights) {
        ...
        BufferChecks.checkFunctionAddress(function_pointer);
        BufferChecks.checkDirect(pWeights);
        ARBVertexBlend.nglWeightusvARB(pWeights.remaining(), MemoryUtil.getAddress(pWeights), function_pointer);
    }
    ...
    public static void glWeightuARB(IntBuffer pWeights) {
        ...
        BufferChecks.checkFunctionAddress(function_pointer);
        BufferChecks.checkDirect(pWeights);
        ARBVertexBlend.nglWeightuivARB(pWeights.remaining(), MemoryUtil.getAddress(pWeights), function_pointer);
    }
    ...
    public static void glWeightPointerARB(int size, int stride, DoubleBuffer pPointer) {
        ...
        if (LWJGLUtil.CHECKS) {
            StateTracker.getReferences((ContextCapabilities)caps).ARB_vertex_blend_glWeightPointerARB_pPointer = pPointer;
        }
        ARBVertexBlend.nglWeightPointerARB(size, 5130, stride, MemoryUtil.getAddress(pPointer), function_pointer);
    }
    ...
    public static void glWeightPointerARB(int size, int stride, FloatBuffer pPointer) {
        ...
        ARBVertexBlend.nglWeightPointerARB(size, 5126, stride, MemoryUtil.getAddress(pPointer), function_pointer);
    }
    ...
    public static void glWeightPointerARB(int size, boolean unsigned, int stride, ByteBuffer pPointer) {
        ...
        ARBVertexBlend.nglWeightPointerARB(size, unsigned ? 5121 : 5120, stride, MemoryUtil.getAddress(pPointer), function_pointer);
    }
    ...
    public static void glWeightPointerARB(int size, boolean unsigned, int stride, IntBuffer pPointer) {
        ...
        ARBVertexBlend.nglWeightPointerARB(size, unsigned ? 5125 : 5124, stride, MemoryUtil.getAddress(pPointer), function_pointer);
    }
    ...
    public static void glWeightPointerARB(int size, boolean unsigned, int stride, ShortBuffer pPointer) {
        ...
        ARBVertexBlend.nglWeightPointerARB(size, unsigned ? 5123 : 5122, stride, MemoryUtil.getAddress(pPointer), function_pointer);
    }
    ...
    public static void glWeightPointerARB(int size, int type, int stride, long pPointer_buffer_offset) {
        ...
        ARBVertexBlend.nglWeightPointerARBBO(size, type, stride, pPointer_buffer_offset, function_pointer);
    }
    ...
    public static void glVertexBlendARB(int count) {
        ...
        BufferChecks.checkFunctionAddress(function_pointer);
        ARBVertexBlend.nglVertexBlendARB(count, function_pointer);
    }
