...
public final class NVTransformFeedback2 {
    ...
    public static void glBindTransformFeedbackNV(int target, int id) {
        ...
        NVTransformFeedback2.nglBindTransformFeedbackNV(target, id, function_pointer);
    }
    ...
    public static void glDeleteTransformFeedbacksNV(IntBuffer ids) {
        ...
        NVTransformFeedback2.nglDeleteTransformFeedbacksNV(ids.remaining(), MemoryUtil.getAddress(ids), function_pointer);
    }
    ...
    public static void glDeleteTransformFeedbacksNV(int id) {
        ...
        long function_pointer = caps.glDeleteTransformFeedbacksNV;
        BufferChecks.checkFunctionAddress(function_pointer);
        NVTransformFeedback2.nglDeleteTransformFeedbacksNV(1, APIUtil.getInt(caps, id), function_pointer);
    }
    ...
    public static void glGenTransformFeedbacksNV(IntBuffer ids) {
        ...
        BufferChecks.checkFunctionAddress(function_pointer);
        BufferChecks.checkDirect(ids);
        NVTransformFeedback2.nglGenTransformFeedbacksNV(ids.remaining(), MemoryUtil.getAddress(ids), function_pointer);
    }
    ...
    public static int glGenTransformFeedbacksNV() {
        ...
        NVTransformFeedback2.nglGenTransformFeedbacksNV(1, MemoryUtil.getAddress(ids), function_pointer);
        return ids.get(0);
    }
    ...
    public static boolean glIsTransformFeedbackNV(int id) {
        ...
        BufferChecks.checkFunctionAddress(function_pointer);
        boolean __result = NVTransformFeedback2.nglIsTransformFeedbackNV(id, function_pointer);
        return __result;
    }
    ...
    public static void glDrawTransformFeedbackNV(int mode, int id) {
        ...
        BufferChecks.checkFunctionAddress(function_pointer);
        NVTransformFeedback2.nglDrawTransformFeedbackNV(mode, id, function_pointer);
    }
