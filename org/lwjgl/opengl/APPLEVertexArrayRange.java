...
public final class APPLEVertexArrayRange {
    ...
    public static void glVertexArrayRangeAPPLE(ByteBuffer pointer) {
        ...
        APPLEVertexArrayRange.nglVertexArrayRangeAPPLE(pointer.remaining(), MemoryUtil.getAddress(pointer), function_pointer);
    }
    ...
    public static void glFlushVertexArrayRangeAPPLE(ByteBuffer pointer) {
        ...
        BufferChecks.checkFunctionAddress(function_pointer);
        BufferChecks.checkDirect(pointer);
        APPLEVertexArrayRange.nglFlushVertexArrayRangeAPPLE(pointer.remaining(), MemoryUtil.getAddress(pointer), function_pointer);
    }
    ...
    public static void glVertexArrayParameteriAPPLE(int pname, int param) {
        ...
        BufferChecks.checkFunctionAddress(function_pointer);
        APPLEVertexArrayRange.nglVertexArrayParameteriAPPLE(pname, param, function_pointer);
    }
