...
public final class NVPathRendering {
    ...
    public static void glPathCommandsNV(int path, ByteBuffer commands, int coordType, ByteBuffer coords) {
        ...
        NVPathRendering.nglPathCommandsNV(path, commands.remaining(), MemoryUtil.getAddress(commands), coords.remaining(), coordType, MemoryUtil.getAddress(coords), function_pointer);
    }
    ...
    public static void glPathCoordsNV(int path, int coordType, ByteBuffer coords) {
        ...
        BufferChecks.checkFunctionAddress(function_pointer);
        BufferChecks.checkDirect(coords);
        NVPathRendering.nglPathCoordsNV(path, coords.remaining(), coordType, MemoryUtil.getAddress(coords), function_pointer);
    }
    ...
    public static void glPathSubCommandsNV(int path, int commandStart, int commandsToDelete, ByteBuffer commands, int coordType, ByteBuffer coords) {
        ...
        BufferChecks.checkDirect(commands);
        BufferChecks.checkDirect(coords);
        NVPathRendering.nglPathSubCommandsNV(path, commandStart, commandsToDelete, commands.remaining(), MemoryUtil.getAddress(commands), coords.remaining(), coordType, MemoryUtil.getAddress(coords), function_pointer);
    }
    ...
    public static void glPathSubCoordsNV(int path, int coordStart, int coordType, ByteBuffer coords) {
        ...
        BufferChecks.checkFunctionAddress(function_pointer);
        BufferChecks.checkDirect(coords);
        NVPathRendering.nglPathSubCoordsNV(path, coordStart, coords.remaining(), coordType, MemoryUtil.getAddress(coords), function_pointer);
    }
    ...
    public static void glPathStringNV(int path, int format, ByteBuffer pathString) {
        ...
        NVPathRendering.nglPathStringNV(path, format, pathString.remaining(), MemoryUtil.getAddress(pathString), function_pointer);
    }
    ...
    public static void glPathGlyphsNV(int firstPathName, int fontTarget, ByteBuffer fontName, int fontStyle, int type, ByteBuffer charcodes, int handleMissingGlyphs, int pathParameterTemplate, float emScale) {
        ...
        NVPathRendering.nglPathGlyphsNV(firstPathName, fontTarget, MemoryUtil.getAddress(fontName), fontStyle, charcodes.remaining() / GLChecks.calculateBytesPerCharCode(type), type, MemoryUtil.getAddress(charcodes), handleMissingGlyphs, pathParameterTemplate, emScale, function_pointer);
    }
    ...
    public static void glPathGlyphRangeNV(int firstPathName, int fontTarget, ByteBuffer fontName, int fontStyle, int firstGlyph, int numGlyphs, int handleMissingGlyphs, int pathParameterTemplate, float emScale) {
        ...
        BufferChecks.checkDirect(fontName);
        BufferChecks.checkNullTerminated(fontName);
        NVPathRendering.nglPathGlyphRangeNV(firstPathName, fontTarget, MemoryUtil.getAddress(fontName), fontStyle, firstGlyph, numGlyphs, handleMissingGlyphs, pathParameterTemplate, emScale, function_pointer);
    }
    ...
    public static void glWeightPathsNV(int resultPath, IntBuffer paths, FloatBuffer weights) {
        ...
        NVPathRendering.nglWeightPathsNV(resultPath, paths.remaining(), MemoryUtil.getAddress(paths), MemoryUtil.getAddress(weights), function_pointer);
    }
    ...
    public static void glCopyPathNV(int resultPath, int srcPath) {
        ...
        BufferChecks.checkFunctionAddress(function_pointer);
        NVPathRendering.nglCopyPathNV(resultPath, srcPath, function_pointer);
    }
    ...
    public static void glInterpolatePathsNV(int resultPath, int pathA, int pathB, float weight) {
        ...
        BufferChecks.checkFunctionAddress(function_pointer);
        NVPathRendering.nglInterpolatePathsNV(resultPath, pathA, pathB, weight, function_pointer);
    }
    ...
    public static void glTransformPathNV(int resultPath, int srcPath, int transformType, FloatBuffer transformValues) {
        ...
        NVPathRendering.nglTransformPathNV(resultPath, srcPath, transformType, MemoryUtil.getAddressSafe(transformValues), function_pointer);
    }
    ...
    public static void glPathParameterNV(int path, int pname, IntBuffer value) {
        ...
        NVPathRendering.nglPathParameterivNV(path, pname, MemoryUtil.getAddress(value), function_pointer);
    }
    ...
    public static void glPathParameteriNV(int path, int pname, int value) {
        ...
        BufferChecks.checkFunctionAddress(function_pointer);
        NVPathRendering.nglPathParameteriNV(path, pname, value, function_pointer);
    }
    ...
    public static void glPathParameterNV(int path, int pname, FloatBuffer value) {
        ...
        BufferChecks.checkFunctionAddress(function_pointer);
        BufferChecks.checkBuffer(value, 4);
        NVPathRendering.nglPathParameterfvNV(path, pname, MemoryUtil.getAddress(value), function_pointer);
    }
    ...
    public static void glPathParameterfNV(int path, int pname, float value) {
        ...
        BufferChecks.checkFunctionAddress(function_pointer);
        NVPathRendering.nglPathParameterfNV(path, pname, value, function_pointer);
    }
    ...
    public static void glPathDashArrayNV(int path, FloatBuffer dashArray) {
        ...
        NVPathRendering.nglPathDashArrayNV(path, dashArray.remaining(), MemoryUtil.getAddress(dashArray), function_pointer);
    }
    ...
    public static int glGenPathsNV(int range) {
        ...
        BufferChecks.checkFunctionAddress(function_pointer);
        int __result = NVPathRendering.nglGenPathsNV(range, function_pointer);
        return __result;
    }
    ...
    public static void glDeletePathsNV(int path, int range) {
        ...
        BufferChecks.checkFunctionAddress(function_pointer);
        NVPathRendering.nglDeletePathsNV(path, range, function_pointer);
    }
    ...
    public static boolean glIsPathNV(int path) {
        ...
        BufferChecks.checkFunctionAddress(function_pointer);
        boolean __result = NVPathRendering.nglIsPathNV(path, function_pointer);
        return __result;
    }
    ...
    public static void glPathStencilFuncNV(int func, int ref, int mask) {
        ...
        BufferChecks.checkFunctionAddress(function_pointer);
        NVPathRendering.nglPathStencilFuncNV(func, ref, mask, function_pointer);
    }
    ...
    public static void glPathStencilDepthOffsetNV(float factor, int units) {
        ...
        BufferChecks.checkFunctionAddress(function_pointer);
        NVPathRendering.nglPathStencilDepthOffsetNV(factor, units, function_pointer);
    }
    ...
    public static void glStencilFillPathNV(int path, int fillMode, int mask) {
        ...
        BufferChecks.checkFunctionAddress(function_pointer);
        NVPathRendering.nglStencilFillPathNV(path, fillMode, mask, function_pointer);
    }
    ...
    public static void glStencilStrokePathNV(int path, int reference, int mask) {
        ...
        BufferChecks.checkFunctionAddress(function_pointer);
        NVPathRendering.nglStencilStrokePathNV(path, reference, mask, function_pointer);
    }
    ...
    public static void glStencilFillPathInstancedNV(int pathNameType, ByteBuffer paths, int pathBase, int fillMode, int mask, int transformType, FloatBuffer transformValues) {
        ...
        NVPathRendering.nglStencilFillPathInstancedNV(paths.remaining() / GLChecks.calculateBytesPerPathName(pathNameType), pathNameType, MemoryUtil.getAddress(paths), pathBase, fillMode, mask, transformType, MemoryUtil.getAddressSafe(transformValues), function_pointer);
    }
    ...
    public static void glStencilStrokePathInstancedNV(int pathNameType, ByteBuffer paths, int pathBase, int reference, int mask, int transformType, FloatBuffer transformValues) {
        ...
        NVPathRendering.nglStencilStrokePathInstancedNV(paths.remaining() / GLChecks.calculateBytesPerPathName(pathNameType), pathNameType, MemoryUtil.getAddress(paths), pathBase, reference, mask, transformType, MemoryUtil.getAddressSafe(transformValues), function_pointer);
    }
    ...
    public static void glPathCoverDepthFuncNV(int zfunc) {
        ...
        BufferChecks.checkFunctionAddress(function_pointer);
        NVPathRendering.nglPathCoverDepthFuncNV(zfunc, function_pointer);
    }
    ...
    public static void glPathColorGenNV(int color, int genMode, int colorFormat, FloatBuffer coeffs) {
        ...
        NVPathRendering.nglPathColorGenNV(color, genMode, colorFormat, MemoryUtil.getAddressSafe(coeffs), function_pointer);
    }
    ...
    public static void glPathTexGenNV(int texCoordSet, int genMode, FloatBuffer coeffs) {
        ...
        NVPathRendering.nglPathTexGenNV(texCoordSet, genMode, GLChecks.calculatePathTextGenCoeffsPerComponent(coeffs, genMode), MemoryUtil.getAddressSafe(coeffs), function_pointer);
    }
    ...
    public static void glPathFogGenNV(int genMode) {
        ...
        BufferChecks.checkFunctionAddress(function_pointer);
        NVPathRendering.nglPathFogGenNV(genMode, function_pointer);
    }
    ...
    public static void glCoverFillPathNV(int path, int coverMode) {
        ...
        BufferChecks.checkFunctionAddress(function_pointer);
        NVPathRendering.nglCoverFillPathNV(path, coverMode, function_pointer);
    }
    ...
    public static void glCoverStrokePathNV(int name, int coverMode) {
        ...
        BufferChecks.checkFunctionAddress(function_pointer);
        NVPathRendering.nglCoverStrokePathNV(name, coverMode, function_pointer);
    }
    ...
    public static void glCoverFillPathInstancedNV(int pathNameType, ByteBuffer paths, int pathBase, int coverMode, int transformType, FloatBuffer transformValues) {
        ...
        NVPathRendering.nglCoverFillPathInstancedNV(paths.remaining() / GLChecks.calculateBytesPerPathName(pathNameType), pathNameType, MemoryUtil.getAddress(paths), pathBase, coverMode, transformType, MemoryUtil.getAddressSafe(transformValues), function_pointer);
    }
    ...
    public static void glCoverStrokePathInstancedNV(int pathNameType, ByteBuffer paths, int pathBase, int coverMode, int transformType, FloatBuffer transformValues) {
        ...
        NVPathRendering.nglCoverStrokePathInstancedNV(paths.remaining() / GLChecks.calculateBytesPerPathName(pathNameType), pathNameType, MemoryUtil.getAddress(paths), pathBase, coverMode, transformType, MemoryUtil.getAddressSafe(transformValues), function_pointer);
    }
    ...
    public static void glGetPathParameterNV(int name, int param, IntBuffer value) {
        ...
        BufferChecks.checkFunctionAddress(function_pointer);
        BufferChecks.checkBuffer(value, 4);
        NVPathRendering.nglGetPathParameterivNV(name, param, MemoryUtil.getAddress(value), function_pointer);
    }
    ...
    public static void glGetPathParameterfvNV(int name, int param, FloatBuffer value) {
        ...
        BufferChecks.checkFunctionAddress(function_pointer);
        BufferChecks.checkBuffer(value, 4);
        NVPathRendering.nglGetPathParameterfvNV(name, param, MemoryUtil.getAddress(value), function_pointer);
    }
    ...
    public static void glGetPathCommandsNV(int name, ByteBuffer commands) {
        ...
        BufferChecks.checkFunctionAddress(function_pointer);
        BufferChecks.checkDirect(commands);
        NVPathRendering.nglGetPathCommandsNV(name, MemoryUtil.getAddress(commands), function_pointer);
    }
    ...
    public static void glGetPathCoordsNV(int name, FloatBuffer coords) {
        ...
        BufferChecks.checkFunctionAddress(function_pointer);
        BufferChecks.checkDirect(coords);
        NVPathRendering.nglGetPathCoordsNV(name, MemoryUtil.getAddress(coords), function_pointer);
    }
    ...
    public static void glGetPathDashArrayNV(int name, FloatBuffer dashArray) {
        ...
        BufferChecks.checkFunctionAddress(function_pointer);
        BufferChecks.checkDirect(dashArray);
        NVPathRendering.nglGetPathDashArrayNV(name, MemoryUtil.getAddress(dashArray), function_pointer);
    }
    ...
    public static void glGetPathMetricsNV(int metricQueryMask, int pathNameType, ByteBuffer paths, int pathBase, int stride, FloatBuffer metrics) {
        ...
        NVPathRendering.nglGetPathMetricsNV(metricQueryMask, paths.remaining() / GLChecks.calculateBytesPerPathName(pathNameType), pathNameType, MemoryUtil.getAddress(paths), pathBase, stride, MemoryUtil.getAddress(metrics), function_pointer);
    }
    ...
    public static void glGetPathMetricRangeNV(int metricQueryMask, int fistPathName, int numPaths, int stride, FloatBuffer metrics) {
        ...
        BufferChecks.checkFunctionAddress(function_pointer);
        BufferChecks.checkBuffer(metrics, GLChecks.calculateMetricsSize(metricQueryMask, stride));
        NVPathRendering.nglGetPathMetricRangeNV(metricQueryMask, fistPathName, numPaths, stride, MemoryUtil.getAddress(metrics), function_pointer);
    }
    ...
    public static void glGetPathSpacingNV(int pathListMode, int pathNameType, ByteBuffer paths, int pathBase, float advanceScale, float kerningScale, int transformType, FloatBuffer returnedSpacing) {
        ...
        NVPathRendering.nglGetPathSpacingNV(pathListMode, numPaths, pathNameType, MemoryUtil.getAddress(paths), pathBase, advanceScale, kerningScale, transformType, MemoryUtil.getAddress(returnedSpacing), function_pointer);
    }
    ...
    public static void glGetPathColorGenNV(int color, int pname, IntBuffer value) {
        ...
        NVPathRendering.nglGetPathColorGenivNV(color, pname, MemoryUtil.getAddress(value), function_pointer);
    }
    ...
    public static void glGetPathColorGenNV(int color, int pname, FloatBuffer value) {
        ...
        BufferChecks.checkFunctionAddress(function_pointer);
        BufferChecks.checkBuffer(value, 16);
        NVPathRendering.nglGetPathColorGenfvNV(color, pname, MemoryUtil.getAddress(value), function_pointer);
    }
    ...
    public static void glGetPathTexGenNV(int texCoordSet, int pname, IntBuffer value) {
        ...
        BufferChecks.checkFunctionAddress(function_pointer);
        BufferChecks.checkBuffer(value, 16);
        NVPathRendering.nglGetPathTexGenivNV(texCoordSet, pname, MemoryUtil.getAddress(value), function_pointer);
    }
    ...
    public static void glGetPathTexGenNV(int texCoordSet, int pname, FloatBuffer value) {
        ...
        BufferChecks.checkFunctionAddress(function_pointer);
        BufferChecks.checkBuffer(value, 16);
        NVPathRendering.nglGetPathTexGenfvNV(texCoordSet, pname, MemoryUtil.getAddress(value), function_pointer);
    }
    ...
    public static boolean glIsPointInFillPathNV(int path, int mask, float x, float y) {
        ...
        BufferChecks.checkFunctionAddress(function_pointer);
        boolean __result = NVPathRendering.nglIsPointInFillPathNV(path, mask, x, y, function_pointer);
        return __result;
    }
    ...
    public static boolean glIsPointInStrokePathNV(int path, float x, float y) {
        ...
        BufferChecks.checkFunctionAddress(function_pointer);
        boolean __result = NVPathRendering.nglIsPointInStrokePathNV(path, x, y, function_pointer);
        return __result;
    }
    ...
    public static float glGetPathLengthNV(int path, int startSegment, int numSegments) {
        ...
        BufferChecks.checkFunctionAddress(function_pointer);
        float __result = NVPathRendering.nglGetPathLengthNV(path, startSegment, numSegments, function_pointer);
        return __result;
    }
    ...
    public static boolean glPointAlongPathNV(int path, int startSegment, int numSegments, float distance, FloatBuffer x, FloatBuffer y, FloatBuffer tangentX, FloatBuffer tangentY) {
        ...
        boolean __result = NVPathRendering.nglPointAlongPathNV(path, startSegment, numSegments, distance, MemoryUtil.getAddressSafe(x), MemoryUtil.getAddressSafe(y), MemoryUtil.getAddressSafe(tangentX), MemoryUtil.getAddressSafe(tangentY), function_pointer);
        return __result;
    }
