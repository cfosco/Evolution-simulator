...
public final class EXTPalettedTexture {
    ...
    public static void glColorTableEXT(int target, int internalFormat, int width, int format, int type, ByteBuffer data) {
        ...
        EXTPalettedTexture.nglColorTableEXT(target, internalFormat, width, format, type, MemoryUtil.getAddress(data), function_pointer);
    }
    ...
    public static void glColorSubTableEXT(int target, int start, int count, int format, int type, ByteBuffer data) {
        ...
        EXTPalettedTexture.nglColorSubTableEXT(target, start, count, format, type, MemoryUtil.getAddress(data), function_pointer);
    }
    ...
    public static void glGetColorTableEXT(int target, int format, int type, ByteBuffer data) {
        ...
        EXTPalettedTexture.nglGetColorTableEXT(target, format, type, MemoryUtil.getAddress(data), function_pointer);
    }
    ...
    public static void glGetColorTableParameterEXT(int target, int pname, IntBuffer params) {
        ...
        EXTPalettedTexture.nglGetColorTableParameterivEXT(target, pname, MemoryUtil.getAddress(params), function_pointer);
    }
    ...
    public static void glGetColorTableParameterEXT(int target, int pname, FloatBuffer params) {
        ...
        BufferChecks.checkFunctionAddress(function_pointer);
        BufferChecks.checkBuffer(params, 4);
        EXTPalettedTexture.nglGetColorTableParameterfvEXT(target, pname, MemoryUtil.getAddress(params), function_pointer);
    }
