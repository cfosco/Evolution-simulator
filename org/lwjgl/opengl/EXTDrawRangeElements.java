...
public final class EXTDrawRangeElements {
    ...
    public static void glDrawRangeElementsEXT(int mode, int start, int end, ByteBuffer pIndices) {
        ...
        EXTDrawRangeElements.nglDrawRangeElementsEXT(mode, start, end, pIndices.remaining(), 5121, MemoryUtil.getAddress(pIndices), function_pointer);
    }
    ...
    public static void glDrawRangeElementsEXT(int mode, int start, int end, IntBuffer pIndices) {
        ...
        GLChecks.ensureElementVBOdisabled(caps);
        BufferChecks.checkDirect(pIndices);
        EXTDrawRangeElements.nglDrawRangeElementsEXT(mode, start, end, pIndices.remaining(), 5125, MemoryUtil.getAddress(pIndices), function_pointer);
    }
    ...
    public static void glDrawRangeElementsEXT(int mode, int start, int end, ShortBuffer pIndices) {
        ...
        GLChecks.ensureElementVBOdisabled(caps);
        BufferChecks.checkDirect(pIndices);
        EXTDrawRangeElements.nglDrawRangeElementsEXT(mode, start, end, pIndices.remaining(), 5123, MemoryUtil.getAddress(pIndices), function_pointer);
    }
    ...
    public static void glDrawRangeElementsEXT(int mode, int start, int end, int pIndices_count, int type, long pIndices_buffer_offset) {
        ...
        EXTDrawRangeElements.nglDrawRangeElementsEXTBO(mode, start, end, pIndices_count, type, pIndices_buffer_offset, function_pointer);
    }
