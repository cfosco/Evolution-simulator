        ...
        try {
            switch (LWJGLUtil.getPlatform()) {
                case 3: {
                    ...
                    properties.put(8200).put(implWindows.getHGLRC(this.handle));
                    properties.put(8203).put(implWindows.getHDC(peer_handle));
                    return;
                }
                case 1: {
                    LinuxContextImplementation implLinux = (LinuxContextImplementation)implementation;
                    properties.put(8200).put(implLinux.getGLXContext(this.handle));
                    properties.put(8202).put(implLinux.getDisplay(peer_handle));
                    return;
                }
                case 2: {
                    ...
                    properties.put(0x10000000).put(CGLShareGroup);
                    return;
                }
                default: {
