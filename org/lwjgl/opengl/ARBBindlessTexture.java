...
public final class ARBBindlessTexture {
    ...
    public static long glGetImageHandleARB(int texture, int level, boolean layered, int layer, int format) {
        ...
        BufferChecks.checkFunctionAddress(function_pointer);
        long __result = ARBBindlessTexture.nglGetImageHandleARB(texture, level, layered, layer, format, function_pointer);
        return __result;
    }
    ...
    public static void glMakeImageHandleResidentARB(long handle, int access) {
        ...
        BufferChecks.checkFunctionAddress(function_pointer);
        ARBBindlessTexture.nglMakeImageHandleResidentARB(handle, access, function_pointer);
    }
    ...
    public static void glUniformHandleui64ARB(int location, long value) {
        ...
        BufferChecks.checkFunctionAddress(function_pointer);
        ARBBindlessTexture.nglUniformHandleui64ARB(location, value, function_pointer);
    }
    ...
    public static void glUniformHandleuARB(int location, LongBuffer value) {
        ...
        ARBBindlessTexture.nglUniformHandleui64vARB(location, value.remaining(), MemoryUtil.getAddress(value), function_pointer);
    }
    ...
    public static void glProgramUniformHandleui64ARB(int program, int location, long value) {
        ...
        BufferChecks.checkFunctionAddress(function_pointer);
        ARBBindlessTexture.nglProgramUniformHandleui64ARB(program, location, value, function_pointer);
    }
    ...
    public static void glProgramUniformHandleuARB(int program, int location, LongBuffer values) {
        ...
        ARBBindlessTexture.nglProgramUniformHandleui64vARB(program, location, values.remaining(), MemoryUtil.getAddress(values), function_pointer);
    }
    ...
    public static void glVertexAttribL1ui64ARB(int index, long x) {
        ...
        BufferChecks.checkFunctionAddress(function_pointer);
        ARBBindlessTexture.nglVertexAttribL1ui64ARB(index, x, function_pointer);
    }
    ...
    public static void glVertexAttribL1uARB(int index, LongBuffer v) {
        ...
        ARBBindlessTexture.nglVertexAttribL1ui64vARB(index, MemoryUtil.getAddress(v), function_pointer);
    }
    ...
    public static void glGetVertexAttribLuARB(int index, int pname, LongBuffer params) {
        ...
        ARBBindlessTexture.nglGetVertexAttribLui64vARB(index, pname, MemoryUtil.getAddress(params), function_pointer);
    }
