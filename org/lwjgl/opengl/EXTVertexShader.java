...
public final class EXTVertexShader {
    ...
    public static void glBeginVertexShaderEXT() {
        ...
        EXTVertexShader.nglBeginVertexShaderEXT(function_pointer);
    }
    ...
    public static void glEndVertexShaderEXT() {
        ...
        BufferChecks.checkFunctionAddress(function_pointer);
        EXTVertexShader.nglEndVertexShaderEXT(function_pointer);
    }
    ...
    public static void glBindVertexShaderEXT(int id) {
        ...
        BufferChecks.checkFunctionAddress(function_pointer);
        EXTVertexShader.nglBindVertexShaderEXT(id, function_pointer);
    }
    ...
    public static int glGenVertexShadersEXT(int range) {
        ...
        BufferChecks.checkFunctionAddress(function_pointer);
        int __result = EXTVertexShader.nglGenVertexShadersEXT(range, function_pointer);
        return __result;
    }
    ...
    public static void glDeleteVertexShaderEXT(int id) {
        ...
        BufferChecks.checkFunctionAddress(function_pointer);
        EXTVertexShader.nglDeleteVertexShaderEXT(id, function_pointer);
    }
    ...
    public static void glShaderOp1EXT(int op, int res, int arg1) {
        ...
        BufferChecks.checkFunctionAddress(function_pointer);
        EXTVertexShader.nglShaderOp1EXT(op, res, arg1, function_pointer);
    }
    ...
    public static void glShaderOp2EXT(int op, int res, int arg1, int arg2) {
        ...
        BufferChecks.checkFunctionAddress(function_pointer);
        EXTVertexShader.nglShaderOp2EXT(op, res, arg1, arg2, function_pointer);
    }
    ...
    public static void glShaderOp3EXT(int op, int res, int arg1, int arg2, int arg3) {
        ...
        BufferChecks.checkFunctionAddress(function_pointer);
        EXTVertexShader.nglShaderOp3EXT(op, res, arg1, arg2, arg3, function_pointer);
    }
    ...
    public static void glSwizzleEXT(int res, int in, int outX, int outY, int outZ, int outW) {
        ...
        BufferChecks.checkFunctionAddress(function_pointer);
        EXTVertexShader.nglSwizzleEXT(res, in, outX, outY, outZ, outW, function_pointer);
    }
    ...
    public static void glWriteMaskEXT(int res, int in, int outX, int outY, int outZ, int outW) {
        ...
        BufferChecks.checkFunctionAddress(function_pointer);
        EXTVertexShader.nglWriteMaskEXT(res, in, outX, outY, outZ, outW, function_pointer);
    }
    ...
    public static void glInsertComponentEXT(int res, int src, int num) {
        ...
        BufferChecks.checkFunctionAddress(function_pointer);
        EXTVertexShader.nglInsertComponentEXT(res, src, num, function_pointer);
    }
    ...
    public static void glExtractComponentEXT(int res, int src, int num) {
        ...
        BufferChecks.checkFunctionAddress(function_pointer);
        EXTVertexShader.nglExtractComponentEXT(res, src, num, function_pointer);
    }
    ...
    public static int glGenSymbolsEXT(int dataType, int storageType, int range, int components) {
        ...
        BufferChecks.checkFunctionAddress(function_pointer);
        int __result = EXTVertexShader.nglGenSymbolsEXT(dataType, storageType, range, components, function_pointer);
        return __result;
    }
    ...
    public static void glSetInvariantEXT(int id, DoubleBuffer pAddr) {
        ...
        EXTVertexShader.nglSetInvariantEXT(id, 5130, MemoryUtil.getAddress(pAddr), function_pointer);
    }
    ...
    public static void glSetInvariantEXT(int id, FloatBuffer pAddr) {
        ...
        BufferChecks.checkFunctionAddress(function_pointer);
        BufferChecks.checkBuffer(pAddr, 4);
        EXTVertexShader.nglSetInvariantEXT(id, 5126, MemoryUtil.getAddress(pAddr), function_pointer);
    }
    ...
    public static void glSetInvariantEXT(int id, boolean unsigned, ByteBuffer pAddr) {
        ...
        BufferChecks.checkFunctionAddress(function_pointer);
        BufferChecks.checkBuffer(pAddr, 4);
        EXTVertexShader.nglSetInvariantEXT(id, unsigned ? 5121 : 5120, MemoryUtil.getAddress(pAddr), function_pointer);
    }
    ...
    public static void glSetInvariantEXT(int id, boolean unsigned, IntBuffer pAddr) {
        ...
        BufferChecks.checkFunctionAddress(function_pointer);
        BufferChecks.checkBuffer(pAddr, 4);
        EXTVertexShader.nglSetInvariantEXT(id, unsigned ? 5125 : 5124, MemoryUtil.getAddress(pAddr), function_pointer);
    }
    ...
    public static void glSetInvariantEXT(int id, boolean unsigned, ShortBuffer pAddr) {
        ...
        BufferChecks.checkFunctionAddress(function_pointer);
        BufferChecks.checkBuffer(pAddr, 4);
        EXTVertexShader.nglSetInvariantEXT(id, unsigned ? 5123 : 5122, MemoryUtil.getAddress(pAddr), function_pointer);
    }
    ...
    public static void glSetLocalConstantEXT(int id, DoubleBuffer pAddr) {
        ...
        BufferChecks.checkFunctionAddress(function_pointer);
        BufferChecks.checkBuffer(pAddr, 4);
        EXTVertexShader.nglSetLocalConstantEXT(id, 5130, MemoryUtil.getAddress(pAddr), function_pointer);
    }
    ...
    public static void glSetLocalConstantEXT(int id, FloatBuffer pAddr) {
        ...
        BufferChecks.checkFunctionAddress(function_pointer);
        BufferChecks.checkBuffer(pAddr, 4);
        EXTVertexShader.nglSetLocalConstantEXT(id, 5126, MemoryUtil.getAddress(pAddr), function_pointer);
    }
    ...
    public static void glSetLocalConstantEXT(int id, boolean unsigned, ByteBuffer pAddr) {
        ...
        BufferChecks.checkFunctionAddress(function_pointer);
        BufferChecks.checkBuffer(pAddr, 4);
        EXTVertexShader.nglSetLocalConstantEXT(id, unsigned ? 5121 : 5120, MemoryUtil.getAddress(pAddr), function_pointer);
    }
    ...
    public static void glSetLocalConstantEXT(int id, boolean unsigned, IntBuffer pAddr) {
        ...
        BufferChecks.checkFunctionAddress(function_pointer);
        BufferChecks.checkBuffer(pAddr, 4);
        EXTVertexShader.nglSetLocalConstantEXT(id, unsigned ? 5125 : 5124, MemoryUtil.getAddress(pAddr), function_pointer);
    }
    ...
    public static void glSetLocalConstantEXT(int id, boolean unsigned, ShortBuffer pAddr) {
        ...
        BufferChecks.checkFunctionAddress(function_pointer);
        BufferChecks.checkBuffer(pAddr, 4);
        EXTVertexShader.nglSetLocalConstantEXT(id, unsigned ? 5123 : 5122, MemoryUtil.getAddress(pAddr), function_pointer);
    }
    ...
    public static void glVariantEXT(int id, ByteBuffer pAddr) {
        ...
        BufferChecks.checkFunctionAddress(function_pointer);
        BufferChecks.checkBuffer(pAddr, 4);
        EXTVertexShader.nglVariantbvEXT(id, MemoryUtil.getAddress(pAddr), function_pointer);
    }
    ...
    public static void glVariantEXT(int id, ShortBuffer pAddr) {
        ...
        BufferChecks.checkFunctionAddress(function_pointer);
        BufferChecks.checkBuffer(pAddr, 4);
        EXTVertexShader.nglVariantsvEXT(id, MemoryUtil.getAddress(pAddr), function_pointer);
    }
    ...
    public static void glVariantEXT(int id, IntBuffer pAddr) {
        ...
        BufferChecks.checkFunctionAddress(function_pointer);
        BufferChecks.checkBuffer(pAddr, 4);
        EXTVertexShader.nglVariantivEXT(id, MemoryUtil.getAddress(pAddr), function_pointer);
    }
    ...
    public static void glVariantEXT(int id, FloatBuffer pAddr) {
        ...
        BufferChecks.checkFunctionAddress(function_pointer);
        BufferChecks.checkBuffer(pAddr, 4);
        EXTVertexShader.nglVariantfvEXT(id, MemoryUtil.getAddress(pAddr), function_pointer);
    }
    ...
    public static void glVariantEXT(int id, DoubleBuffer pAddr) {
        ...
        BufferChecks.checkFunctionAddress(function_pointer);
        BufferChecks.checkBuffer(pAddr, 4);
        EXTVertexShader.nglVariantdvEXT(id, MemoryUtil.getAddress(pAddr), function_pointer);
    }
    ...
    public static void glVariantuEXT(int id, ByteBuffer pAddr) {
        ...
        BufferChecks.checkFunctionAddress(function_pointer);
        BufferChecks.checkBuffer(pAddr, 4);
        EXTVertexShader.nglVariantubvEXT(id, MemoryUtil.getAddress(pAddr), function_pointer);
    }
    ...
    public static void glVariantuEXT(int id, ShortBuffer pAddr) {
        ...
        BufferChecks.checkFunctionAddress(function_pointer);
        BufferChecks.checkBuffer(pAddr, 4);
        EXTVertexShader.nglVariantusvEXT(id, MemoryUtil.getAddress(pAddr), function_pointer);
    }
    ...
    public static void glVariantuEXT(int id, IntBuffer pAddr) {
        ...
        BufferChecks.checkFunctionAddress(function_pointer);
        BufferChecks.checkBuffer(pAddr, 4);
        EXTVertexShader.nglVariantuivEXT(id, MemoryUtil.getAddress(pAddr), function_pointer);
    }
    ...
    public static void glVariantPointerEXT(int id, int stride, DoubleBuffer pAddr) {
        ...
        if (LWJGLUtil.CHECKS) {
            StateTracker.getReferences((ContextCapabilities)caps).EXT_vertex_shader_glVariantPointerEXT_pAddr = pAddr;
        }
        EXTVertexShader.nglVariantPointerEXT(id, 5130, stride, MemoryUtil.getAddress(pAddr), function_pointer);
    }
    ...
    public static void glVariantPointerEXT(int id, int stride, FloatBuffer pAddr) {
        ...
        EXTVertexShader.nglVariantPointerEXT(id, 5126, stride, MemoryUtil.getAddress(pAddr), function_pointer);
    }
    ...
    public static void glVariantPointerEXT(int id, boolean unsigned, int stride, ByteBuffer pAddr) {
        ...
        EXTVertexShader.nglVariantPointerEXT(id, unsigned ? 5121 : 5120, stride, MemoryUtil.getAddress(pAddr), function_pointer);
    }
    ...
    public static void glVariantPointerEXT(int id, boolean unsigned, int stride, IntBuffer pAddr) {
        ...
        EXTVertexShader.nglVariantPointerEXT(id, unsigned ? 5125 : 5124, stride, MemoryUtil.getAddress(pAddr), function_pointer);
    }
    ...
    public static void glVariantPointerEXT(int id, boolean unsigned, int stride, ShortBuffer pAddr) {
        ...
        EXTVertexShader.nglVariantPointerEXT(id, unsigned ? 5123 : 5122, stride, MemoryUtil.getAddress(pAddr), function_pointer);
    }
    ...
    public static void glVariantPointerEXT(int id, int type, int stride, long pAddr_buffer_offset) {
        ...
        EXTVertexShader.nglVariantPointerEXTBO(id, type, stride, pAddr_buffer_offset, function_pointer);
    }
    ...
    public static void glEnableVariantClientStateEXT(int id) {
        ...
        BufferChecks.checkFunctionAddress(function_pointer);
        EXTVertexShader.nglEnableVariantClientStateEXT(id, function_pointer);
    }
    ...
    public static void glDisableVariantClientStateEXT(int id) {
        ...
        BufferChecks.checkFunctionAddress(function_pointer);
        EXTVertexShader.nglDisableVariantClientStateEXT(id, function_pointer);
    }
    ...
    public static int glBindLightParameterEXT(int light, int value) {
        ...
        BufferChecks.checkFunctionAddress(function_pointer);
        int __result = EXTVertexShader.nglBindLightParameterEXT(light, value, function_pointer);
        return __result;
    }
    ...
    public static int glBindMaterialParameterEXT(int face, int value) {
        ...
        BufferChecks.checkFunctionAddress(function_pointer);
        int __result = EXTVertexShader.nglBindMaterialParameterEXT(face, value, function_pointer);
        return __result;
    }
    ...
    public static int glBindTexGenParameterEXT(int unit, int coord, int value) {
        ...
        BufferChecks.checkFunctionAddress(function_pointer);
        int __result = EXTVertexShader.nglBindTexGenParameterEXT(unit, coord, value, function_pointer);
        return __result;
    }
    ...
    public static int glBindTextureUnitParameterEXT(int unit, int value) {
        ...
        BufferChecks.checkFunctionAddress(function_pointer);
        int __result = EXTVertexShader.nglBindTextureUnitParameterEXT(unit, value, function_pointer);
        return __result;
    }
    ...
    public static int glBindParameterEXT(int value) {
        ...
        BufferChecks.checkFunctionAddress(function_pointer);
        int __result = EXTVertexShader.nglBindParameterEXT(value, function_pointer);
        return __result;
    }
    ...
    public static boolean glIsVariantEnabledEXT(int id, int cap) {
        ...
        BufferChecks.checkFunctionAddress(function_pointer);
        boolean __result = EXTVertexShader.nglIsVariantEnabledEXT(id, cap, function_pointer);
        return __result;
    }
    ...
    public static void glGetVariantBooleanEXT(int id, int value, ByteBuffer pbData) {
        ...
        EXTVertexShader.nglGetVariantBooleanvEXT(id, value, MemoryUtil.getAddress(pbData), function_pointer);
    }
    ...
    public static void glGetVariantIntegerEXT(int id, int value, IntBuffer pbData) {
        ...
        BufferChecks.checkFunctionAddress(function_pointer);
        BufferChecks.checkBuffer(pbData, 4);
        EXTVertexShader.nglGetVariantIntegervEXT(id, value, MemoryUtil.getAddress(pbData), function_pointer);
    }
    ...
    public static void glGetVariantFloatEXT(int id, int value, FloatBuffer pbData) {
        ...
        BufferChecks.checkFunctionAddress(function_pointer);
        BufferChecks.checkBuffer(pbData, 4);
        EXTVertexShader.nglGetVariantFloatvEXT(id, value, MemoryUtil.getAddress(pbData), function_pointer);
    }
    ...
    public static ByteBuffer glGetVariantPointerEXT(int id, int value, long result_size) {
        ...
        BufferChecks.checkFunctionAddress(function_pointer);
        ByteBuffer __result = EXTVertexShader.nglGetVariantPointervEXT(id, value, result_size, function_pointer);
    ...
    public static void glGetInvariantBooleanEXT(int id, int value, ByteBuffer pbData) {
        ...
        BufferChecks.checkFunctionAddress(function_pointer);
        BufferChecks.checkBuffer(pbData, 4);
        EXTVertexShader.nglGetInvariantBooleanvEXT(id, value, MemoryUtil.getAddress(pbData), function_pointer);
    }
    ...
    public static void glGetInvariantIntegerEXT(int id, int value, IntBuffer pbData) {
        ...
        BufferChecks.checkFunctionAddress(function_pointer);
        BufferChecks.checkBuffer(pbData, 4);
        EXTVertexShader.nglGetInvariantIntegervEXT(id, value, MemoryUtil.getAddress(pbData), function_pointer);
    }
    ...
    public static void glGetInvariantFloatEXT(int id, int value, FloatBuffer pbData) {
        ...
        BufferChecks.checkFunctionAddress(function_pointer);
        BufferChecks.checkBuffer(pbData, 4);
        EXTVertexShader.nglGetInvariantFloatvEXT(id, value, MemoryUtil.getAddress(pbData), function_pointer);
    }
    ...
    public static void glGetLocalConstantBooleanEXT(int id, int value, ByteBuffer pbData) {
        ...
        BufferChecks.checkFunctionAddress(function_pointer);
        BufferChecks.checkBuffer(pbData, 4);
        EXTVertexShader.nglGetLocalConstantBooleanvEXT(id, value, MemoryUtil.getAddress(pbData), function_pointer);
    }
    ...
    public static void glGetLocalConstantIntegerEXT(int id, int value, IntBuffer pbData) {
        ...
        BufferChecks.checkFunctionAddress(function_pointer);
        BufferChecks.checkBuffer(pbData, 4);
        EXTVertexShader.nglGetLocalConstantIntegervEXT(id, value, MemoryUtil.getAddress(pbData), function_pointer);
    }
    ...
    public static void glGetLocalConstantFloatEXT(int id, int value, FloatBuffer pbData) {
        ...
        BufferChecks.checkFunctionAddress(function_pointer);
        BufferChecks.checkBuffer(pbData, 4);
        EXTVertexShader.nglGetLocalConstantFloatvEXT(id, value, MemoryUtil.getAddress(pbData), function_pointer);
    }
