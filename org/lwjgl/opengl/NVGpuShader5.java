...
public final class NVGpuShader5 {
    ...
    public static void glUniform1i64NV(int location, long x) {
        ...
        NVGpuShader5.nglUniform1i64NV(location, x, function_pointer);
    }
    ...
    public static void glUniform2i64NV(int location, long x, long y) {
        ...
        BufferChecks.checkFunctionAddress(function_pointer);
        NVGpuShader5.nglUniform2i64NV(location, x, y, function_pointer);
    }
    ...
    public static void glUniform3i64NV(int location, long x, long y, long z) {
        ...
        BufferChecks.checkFunctionAddress(function_pointer);
        NVGpuShader5.nglUniform3i64NV(location, x, y, z, function_pointer);
    }
    ...
    public static void glUniform4i64NV(int location, long x, long y, long z, long w) {
        ...
        BufferChecks.checkFunctionAddress(function_pointer);
        NVGpuShader5.nglUniform4i64NV(location, x, y, z, w, function_pointer);
    }
    ...
    public static void glUniform1NV(int location, LongBuffer value) {
        ...
        NVGpuShader5.nglUniform1i64vNV(location, value.remaining(), MemoryUtil.getAddress(value), function_pointer);
    }
    ...
    public static void glUniform2NV(int location, LongBuffer value) {
        ...
        BufferChecks.checkFunctionAddress(function_pointer);
        BufferChecks.checkDirect(value);
        NVGpuShader5.nglUniform2i64vNV(location, value.remaining() >> 1, MemoryUtil.getAddress(value), function_pointer);
    }
    ...
    public static void glUniform3NV(int location, LongBuffer value) {
        ...
        BufferChecks.checkFunctionAddress(function_pointer);
        BufferChecks.checkDirect(value);
        NVGpuShader5.nglUniform3i64vNV(location, value.remaining() / 3, MemoryUtil.getAddress(value), function_pointer);
    }
    ...
    public static void glUniform4NV(int location, LongBuffer value) {
        ...
        BufferChecks.checkFunctionAddress(function_pointer);
        BufferChecks.checkDirect(value);
        NVGpuShader5.nglUniform4i64vNV(location, value.remaining() >> 2, MemoryUtil.getAddress(value), function_pointer);
    }
    ...
    public static void glUniform1ui64NV(int location, long x) {
        ...
        BufferChecks.checkFunctionAddress(function_pointer);
        NVGpuShader5.nglUniform1ui64NV(location, x, function_pointer);
    }
    ...
    public static void glUniform2ui64NV(int location, long x, long y) {
        ...
        BufferChecks.checkFunctionAddress(function_pointer);
        NVGpuShader5.nglUniform2ui64NV(location, x, y, function_pointer);
    }
    ...
    public static void glUniform3ui64NV(int location, long x, long y, long z) {
        ...
        BufferChecks.checkFunctionAddress(function_pointer);
        NVGpuShader5.nglUniform3ui64NV(location, x, y, z, function_pointer);
    }
    ...
    public static void glUniform4ui64NV(int location, long x, long y, long z, long w) {
        ...
        BufferChecks.checkFunctionAddress(function_pointer);
        NVGpuShader5.nglUniform4ui64NV(location, x, y, z, w, function_pointer);
    }
    ...
    public static void glUniform1uNV(int location, LongBuffer value) {
        ...
        BufferChecks.checkFunctionAddress(function_pointer);
        BufferChecks.checkDirect(value);
        NVGpuShader5.nglUniform1ui64vNV(location, value.remaining(), MemoryUtil.getAddress(value), function_pointer);
    }
    ...
    public static void glUniform2uNV(int location, LongBuffer value) {
        ...
        BufferChecks.checkFunctionAddress(function_pointer);
        BufferChecks.checkDirect(value);
        NVGpuShader5.nglUniform2ui64vNV(location, value.remaining() >> 1, MemoryUtil.getAddress(value), function_pointer);
    }
    ...
    public static void glUniform3uNV(int location, LongBuffer value) {
        ...
        BufferChecks.checkFunctionAddress(function_pointer);
        BufferChecks.checkDirect(value);
        NVGpuShader5.nglUniform3ui64vNV(location, value.remaining() / 3, MemoryUtil.getAddress(value), function_pointer);
    }
    ...
    public static void glUniform4uNV(int location, LongBuffer value) {
        ...
        BufferChecks.checkFunctionAddress(function_pointer);
        BufferChecks.checkDirect(value);
        NVGpuShader5.nglUniform4ui64vNV(location, value.remaining() >> 2, MemoryUtil.getAddress(value), function_pointer);
    }
    ...
    public static void glGetUniformNV(int program, int location, LongBuffer params) {
        ...
        NVGpuShader5.nglGetUniformi64vNV(program, location, MemoryUtil.getAddress(params), function_pointer);
    }
    ...
    public static void glGetUniformuNV(int program, int location, LongBuffer params) {
        ...
        BufferChecks.checkFunctionAddress(function_pointer);
        BufferChecks.checkBuffer(params, 1);
        NVGpuShader5.nglGetUniformui64vNV(program, location, MemoryUtil.getAddress(params), function_pointer);
    }
    ...
    public static void glProgramUniform1i64NV(int program, int location, long x) {
        ...
        BufferChecks.checkFunctionAddress(function_pointer);
        NVGpuShader5.nglProgramUniform1i64NV(program, location, x, function_pointer);
    }
    ...
    public static void glProgramUniform2i64NV(int program, int location, long x, long y) {
        ...
        BufferChecks.checkFunctionAddress(function_pointer);
        NVGpuShader5.nglProgramUniform2i64NV(program, location, x, y, function_pointer);
    }
    ...
    public static void glProgramUniform3i64NV(int program, int location, long x, long y, long z) {
        ...
        BufferChecks.checkFunctionAddress(function_pointer);
        NVGpuShader5.nglProgramUniform3i64NV(program, location, x, y, z, function_pointer);
    }
    ...
    public static void glProgramUniform4i64NV(int program, int location, long x, long y, long z, long w) {
        ...
        BufferChecks.checkFunctionAddress(function_pointer);
        NVGpuShader5.nglProgramUniform4i64NV(program, location, x, y, z, w, function_pointer);
    }
    ...
    public static void glProgramUniform1NV(int program, int location, LongBuffer value) {
        ...
        BufferChecks.checkFunctionAddress(function_pointer);
        BufferChecks.checkDirect(value);
        NVGpuShader5.nglProgramUniform1i64vNV(program, location, value.remaining(), MemoryUtil.getAddress(value), function_pointer);
    }
    ...
    public static void glProgramUniform2NV(int program, int location, LongBuffer value) {
        ...
        BufferChecks.checkFunctionAddress(function_pointer);
        BufferChecks.checkDirect(value);
        NVGpuShader5.nglProgramUniform2i64vNV(program, location, value.remaining() >> 1, MemoryUtil.getAddress(value), function_pointer);
    }
    ...
    public static void glProgramUniform3NV(int program, int location, LongBuffer value) {
        ...
        BufferChecks.checkFunctionAddress(function_pointer);
        BufferChecks.checkDirect(value);
        NVGpuShader5.nglProgramUniform3i64vNV(program, location, value.remaining() / 3, MemoryUtil.getAddress(value), function_pointer);
    }
    ...
    public static void glProgramUniform4NV(int program, int location, LongBuffer value) {
        ...
        BufferChecks.checkFunctionAddress(function_pointer);
        BufferChecks.checkDirect(value);
        NVGpuShader5.nglProgramUniform4i64vNV(program, location, value.remaining() >> 2, MemoryUtil.getAddress(value), function_pointer);
    }
    ...
    public static void glProgramUniform1ui64NV(int program, int location, long x) {
        ...
        BufferChecks.checkFunctionAddress(function_pointer);
        NVGpuShader5.nglProgramUniform1ui64NV(program, location, x, function_pointer);
    }
    ...
    public static void glProgramUniform2ui64NV(int program, int location, long x, long y) {
        ...
        BufferChecks.checkFunctionAddress(function_pointer);
        NVGpuShader5.nglProgramUniform2ui64NV(program, location, x, y, function_pointer);
    }
    ...
    public static void glProgramUniform3ui64NV(int program, int location, long x, long y, long z) {
        ...
        BufferChecks.checkFunctionAddress(function_pointer);
        NVGpuShader5.nglProgramUniform3ui64NV(program, location, x, y, z, function_pointer);
    }
    ...
    public static void glProgramUniform4ui64NV(int program, int location, long x, long y, long z, long w) {
        ...
        BufferChecks.checkFunctionAddress(function_pointer);
        NVGpuShader5.nglProgramUniform4ui64NV(program, location, x, y, z, w, function_pointer);
    }
    ...
    public static void glProgramUniform1uNV(int program, int location, LongBuffer value) {
        ...
        BufferChecks.checkFunctionAddress(function_pointer);
        BufferChecks.checkDirect(value);
        NVGpuShader5.nglProgramUniform1ui64vNV(program, location, value.remaining(), MemoryUtil.getAddress(value), function_pointer);
    }
    ...
    public static void glProgramUniform2uNV(int program, int location, LongBuffer value) {
        ...
        BufferChecks.checkFunctionAddress(function_pointer);
        BufferChecks.checkDirect(value);
        NVGpuShader5.nglProgramUniform2ui64vNV(program, location, value.remaining() >> 1, MemoryUtil.getAddress(value), function_pointer);
    }
    ...
    public static void glProgramUniform3uNV(int program, int location, LongBuffer value) {
        ...
        BufferChecks.checkFunctionAddress(function_pointer);
        BufferChecks.checkDirect(value);
        NVGpuShader5.nglProgramUniform3ui64vNV(program, location, value.remaining() / 3, MemoryUtil.getAddress(value), function_pointer);
    }
    ...
    public static void glProgramUniform4uNV(int program, int location, LongBuffer value) {
        ...
        BufferChecks.checkFunctionAddress(function_pointer);
        BufferChecks.checkDirect(value);
        NVGpuShader5.nglProgramUniform4ui64vNV(program, location, value.remaining() >> 2, MemoryUtil.getAddress(value), function_pointer);
    }
