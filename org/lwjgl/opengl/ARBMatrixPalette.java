...
public final class ARBMatrixPalette {
    ...
    public static void glMatrixIndexPointerARB(int size, int stride, ByteBuffer pPointer) {
        ...
        if (LWJGLUtil.CHECKS) {
            StateTracker.getReferences((ContextCapabilities)caps).ARB_matrix_palette_glMatrixIndexPointerARB_pPointer = pPointer;
        }
        ARBMatrixPalette.nglMatrixIndexPointerARB(size, 5121, stride, MemoryUtil.getAddress(pPointer), function_pointer);
    }
    ...
    public static void glMatrixIndexPointerARB(int size, int stride, IntBuffer pPointer) {
        ...
        ARBMatrixPalette.nglMatrixIndexPointerARB(size, 5125, stride, MemoryUtil.getAddress(pPointer), function_pointer);
    }
    ...
    public static void glMatrixIndexPointerARB(int size, int stride, ShortBuffer pPointer) {
        ...
        ARBMatrixPalette.nglMatrixIndexPointerARB(size, 5123, stride, MemoryUtil.getAddress(pPointer), function_pointer);
    }
    ...
    public static void glMatrixIndexuARB(ByteBuffer pIndices) {
        ...
        ARBMatrixPalette.nglMatrixIndexubvARB(pIndices.remaining(), MemoryUtil.getAddress(pIndices), function_pointer);
    }
    ...
    public static void glMatrixIndexuARB(ShortBuffer pIndices) {
        ...
        BufferChecks.checkFunctionAddress(function_pointer);
        BufferChecks.checkDirect(pIndices);
        ARBMatrixPalette.nglMatrixIndexusvARB(pIndices.remaining(), MemoryUtil.getAddress(pIndices), function_pointer);
    }
    ...
    public static void glMatrixIndexuARB(IntBuffer pIndices) {
        ...
        BufferChecks.checkFunctionAddress(function_pointer);
        BufferChecks.checkDirect(pIndices);
        ARBMatrixPalette.nglMatrixIndexuivARB(pIndices.remaining(), MemoryUtil.getAddress(pIndices), function_pointer);
    }
