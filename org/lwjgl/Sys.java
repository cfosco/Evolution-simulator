...
public final class Sys {
    ...
    public static boolean openURL(String url) {
        try {
            ...
            Method lookupMethod = (Method)AccessController.doPrivileged(new PrivilegedExceptionAction<Method>(){
            ...
            Method showDocumentMethod = (Method)AccessController.doPrivileged(new PrivilegedExceptionAction<Method>(){
