...
public class Mouse {
    ...
    public static void setCursorPosition(int new_x, int new_y) {
        ...
        synchronized (object) {
            ...
            x = Mouse.event_x = new_x;
            y = Mouse.event_y = new_y;
    ...
    public static void poll() {
        ...
        synchronized (object) {
            ...
            if (Mouse.isGrabbed()) {
                ...
                absolute_x = Mouse.x = poll_coord1;
                absolute_y = Mouse.y = poll_coord2;
            }
    ...
    public static boolean next() {
        ...
        synchronized (object) {
            ...
            if (readBuffer.hasRemaining()) {
                ...
                boolean bl = Mouse.eventState = readBuffer.get() != 0;
                if (Mouse.isGrabbed()) {
    ...
    static boolean getPrivilegedBoolean(final String property_name) {
        Boolean value = (Boolean)AccessController.doPrivileged(new PrivilegedAction<Boolean>(){
