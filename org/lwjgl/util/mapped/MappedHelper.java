...
public class MappedHelper {
    public static void setup(MappedObject mo, ByteBuffer buffer, int align, int sizeof) {
        if (LWJGLUtil.CHECKS && mo.baseAddress != 0) {
        ...
        if (LWJGLUtil.CHECKS && addr % (long)align != 0) {
    ...
    public static void bvput(MappedObject mapped, byte value, int fieldOffset) {
        MappedObjectUnsafe.INSTANCE.putByteVolatile(null, mapped.viewAddress + (long)fieldOffset, value);
    }
    ...
    public static byte bvget(MappedObject mapped, int fieldOffset) {
        return MappedObjectUnsafe.INSTANCE.getByteVolatile(null, mapped.viewAddress + (long)fieldOffset);
    }
    ...
    public static void svput(MappedObject mapped, short value, int fieldOffset) {
        MappedObjectUnsafe.INSTANCE.putShortVolatile(null, mapped.viewAddress + (long)fieldOffset, value);
    }
    ...
    public static short svget(MappedObject mapped, int fieldOffset) {
        return MappedObjectUnsafe.INSTANCE.getShortVolatile(null, mapped.viewAddress + (long)fieldOffset);
    }
    ...
    public static void cvput(MappedObject mapped, char value, int fieldOffset) {
        MappedObjectUnsafe.INSTANCE.putCharVolatile(null, mapped.viewAddress + (long)fieldOffset, value);
    }
    ...
    public static char cvget(MappedObject mapped, int fieldOffset) {
        return MappedObjectUnsafe.INSTANCE.getCharVolatile(null, mapped.viewAddress + (long)fieldOffset);
    }
    ...
    public static void ivput(MappedObject mapped, int value, int fieldOffset) {
        MappedObjectUnsafe.INSTANCE.putIntVolatile(null, mapped.viewAddress + (long)fieldOffset, value);
    }
    ...
    public static int ivget(MappedObject mapped, int fieldOffset) {
        return MappedObjectUnsafe.INSTANCE.getIntVolatile(null, mapped.viewAddress + (long)fieldOffset);
    }
    ...
    public static void fvput(MappedObject mapped, float value, int fieldOffset) {
        MappedObjectUnsafe.INSTANCE.putFloatVolatile(null, mapped.viewAddress + (long)fieldOffset, value);
    }
    ...
    public static float fvget(MappedObject mapped, int fieldOffset) {
        return MappedObjectUnsafe.INSTANCE.getFloatVolatile(null, mapped.viewAddress + (long)fieldOffset);
    }
    ...
    public static void jvput(MappedObject mapped, long value, int fieldOffset) {
        MappedObjectUnsafe.INSTANCE.putLongVolatile(null, mapped.viewAddress + (long)fieldOffset, value);
    }
    ...
    public static long jvget(MappedObject mapped, int fieldOffset) {
        return MappedObjectUnsafe.INSTANCE.getLongVolatile(null, mapped.viewAddress + (long)fieldOffset);
    }
    ...
    public static void dvput(MappedObject mapped, double value, int fieldOffset) {
        MappedObjectUnsafe.INSTANCE.putDoubleVolatile(null, mapped.viewAddress + (long)fieldOffset, value);
    }
    ...
    public static double dvget(MappedObject mapped, int fieldOffset) {
        return MappedObjectUnsafe.INSTANCE.getDoubleVolatile(null, mapped.viewAddress + (long)fieldOffset);
    }
}
