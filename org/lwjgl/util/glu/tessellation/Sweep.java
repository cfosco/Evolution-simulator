...
class Sweep {
    ...
    static void VertexWeights(GLUvertex isect, GLUvertex org, GLUvertex dst, float[] weights) {
        ...
        double[] arrd = isect.coords;
        arrd[0] = arrd[0] + ((double)weights[0] * org.coords[0] + (double)weights[1] * dst.coords[0]);
        double[] arrd2 = isect.coords;
        arrd2[1] = arrd2[1] + ((double)weights[0] * org.coords[1] + (double)weights[1] * dst.coords[1]);
        double[] arrd3 = isect.coords;
        arrd3[2] = arrd3[2] + ((double)weights[0] * org.coords[2] + (double)weights[1] * dst.coords[2]);
    }
